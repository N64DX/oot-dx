...
#define EXTENDED_DRAW_DISTANCE      ((gFileOptions[gSaveContext.fileNum][0] >> 2)  & 1)  // Bits: 2
#define NO_LETTERBOXING             ((gFileOptions[gSaveContext.fileNum][0] >> 3)  & 1)  // Bits: 3
#define RESUME_LAST_AREA            ((gFileOptions[gSaveContext.fileNum][0] >> 4)  & 1)  // Bits: 4
#define DISABLE_TOKEN_FREEZE        ((gFileOptions[gSaveContext.fileNum][0] >> 5)  & 1)  // Bits: 5
#define CENSOR_FIRE_TEMPLE          ((gFileOptions[gSaveContext.fileNum][0] >> 6)  & 1)  // Bits: 6
#define SKIP_INTROS                 ((gFileOptions[gSaveContext.fileNum][0] >> 7)  & 1)  // Bits: 7
#define NO_OWL                      ((gFileOptions[gSaveContext.fileNum][0] >> 8)  & 1)  // Bits: 8
#define INSTANT_PUTAWAY             ((gFileOptions[gSaveContext.fileNum][0] >> 9)  & 1)  // Bits: 9
#define PULL_SWORD                  ((gFileOptions[gSaveContext.fileNum][0] >> 10) & 1)  // Bits: 10
#define NO_DISRUPTIVE_TEXT          ((gFileOptions[gSaveContext.fileNum][0] >> 11) & 1)  // Bits: 11
#define BOW_AIMING_RETICLE          ((gFileOptions[gSaveContext.fileNum][0] >> 12) & 1)  // Bits: 12
#define NO_LOW_HEALTH_BEEP          ((gFileOptions[gSaveContext.fileNum][0] >> 13) & 1)  // Bits: 13
#define UNINVERTED_AIMING           ((gFileOptions[gSaveContext.fileNum][0] >> 14) & 1)  // Bits: 14
#define FIX_POWER_CROUCH_STAB       ((gFileOptions[gSaveContext.fileNum][0] >> 15) & 1)  // Bits: 15
#define REFLECT_CHEST_CONTENTS      ((gFileOptions[gSaveContext.fileNum][0] >> 16) & 1)  // Bits: 16
#define EASIER_FISHING              ((gFileOptions[gSaveContext.fileNum][0] >> 17) & 1)  // Bits: 17
#define USE_YOUNG_LINK              ((gFileOptions[gSaveContext.fileNum][0] >> 18) & 1)  // Bits: 18
