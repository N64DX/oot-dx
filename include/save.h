...
#define NO_OWL                      ((gFileOptions[gSaveContext.fileNum][0] >> 7)  & 1)  // Bits: 7
#define INSTANT_PUTAWAY             ((gFileOptions[gSaveContext.fileNum][0] >> 8)  & 1)  // Bits: 8
#define PULL_SWORD                  ((gFileOptions[gSaveContext.fileNum][0] >> 9)  & 1)  // Bits: 9
#define NO_DISRUPTIVE_TEXT          ((gFileOptions[gSaveContext.fileNum][0] >> 10) & 1)  // Bits: 10
#define BOW_AIMING_RETICLE          ((gFileOptions[gSaveContext.fileNum][0] >> 11) & 1)  // Bits: 11
#define NO_LOW_HEALTH_BEEP          ((gFileOptions[gSaveContext.fileNum][0] >> 12) & 1)  // Bits: 12
#define UNINVERTED_AIMING           ((gFileOptions[gSaveContext.fileNum][0] >> 13) & 1)  // Bits: 13
#define FIX_POWER_CROUCH_STAB       ((gFileOptions[gSaveContext.fileNum][0] >> 14) & 1)  // Bits: 14
#define REFLECT_CHEST_CONTENTS      ((gFileOptions[gSaveContext.fileNum][0] >> 15) & 1)  // Bits: 15
#define EASIER_FISHING              ((gFileOptions[gSaveContext.fileNum][0] >> 16) & 1)  // Bits: 16
#define USE_YOUNG_LINK              ((gFileOptions[gSaveContext.fileNum][0] >> 17) & 1)  // Bits: 17
#define AUTOSAVE                    ((gFileOptions[gSaveContext.fileNum][0] >> 18) & 1)  // Bits: 18
