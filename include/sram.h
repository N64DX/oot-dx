...
typedef enum SramHeaderField {
    ...
    /* 0x03 */ SRAM_HEADER_SCREEN_MODE,
    /* 0x04 */ SRAM_HEADER_SKIP_LOGO,
    /* 0x05 */ SRAM_HEADER_DEBUG_MODE,
    /* 0x06 */ SRAM_HEADER_MAGIC // must be the value in `sSramDefaultHeader` for save to be considered valid
} SramHeaderField;
