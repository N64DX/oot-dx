...
/* 0x65 */ DEFINE_SCENE(road_to_swamp_scene, none, SCENE_PATH_TO_WOODFALL, SDC_FORBIDDEN_WOODS, 0, 0)
/* 0x66 */ DEFINE_SCENE(roadtofortress_scene, none, SCENE_PATH_TO_FORTRESS, SDC_GERUDO_VALLEY, 0, 0)
...
/* 0x6B */ DEFINE_SCENE(grotto_shortcuts_scene, none, SCENE_GROTTO_SHORTCUTS, SDC_GROTTOS, 0, 0)
/* 0x6C */ DEFINE_SCENE(old_lost_woods_scene, none, SCENE_FORBIDDEN_WOODS, SDC_FORBIDDEN_WOODS, 0, 0)
/* 0x6D */ DEFINE_SCENE(swamp_spider_house_scene, none, SCENE_WEBBED_SHRINE, SDC_DEFAULT, 0, 0)
/* 0x6E */ DEFINE_SCENE(fairy_deku_tree_scene, none, SCENE_ANCIENT_HOLLOW, SDC_ANCIENT_HOLLOW, 0, 0)
/* 0x6F */ DEFINE_SCENE(woodfall_temple_scene, none, SCENE_WOODFALL_TEMPLE, SDC_WOODFALL_TEMPLE, 0, 0)
/* 0x70 */ DEFINE_SCENE(woodfall_temple_boss_scene, none, SCENE_WOODFALL_TEMPLE_BOSS, SDC_WOODFALL_TEMPLE, 0, 0)
/* 0x71 */ DEFINE_SCENE(mountain_smithy_scene, none, SCENE_SPRING_LAKE_SMITHY, SDC_SPRING_LAKE_SMITHY, 0, 0)
/* 0x72 */ DEFINE_SCENE(besitu_scene, none, SCENE_BESITU, SDC_BESITU, 0, 0)

// 0x7B (124th scene) = gSaveContext.save.info.sceneFlags MAX

#if DEBUG_ASSETS
/* 0x73 */ DEFINE_SCENE(test01_scene, none, SCENE_TEST01, SDC_CALM_WATER, 0, 0)
/* 0x74 */ DEFINE_SCENE(depth_test_scene, none, SCENE_DEPTH_TEST, SDC_DEFAULT, 0, 0)
/* 0x75 */ DEFINE_SCENE(syotes_scene, none, SCENE_SYOTES, SDC_DEFAULT, 0, 0)
/* 0x76 */ DEFINE_SCENE(syotes2_scene, none, SCENE_SYOTES2, SDC_DEFAULT, 0, 0)
/* 0x77 */ DEFINE_SCENE(sutaru_scene, none, SCENE_SUTARU, SDC_DEFAULT, 0, 0)
/* 0x78 */ DEFINE_SCENE(hairal_niwa2_scene, g_pn_12, SCENE_HAIRAL_NIWA2, SDC_CASTLE_COURTYARD_GUARDS, 0, 0)
/* 0x79 */ DEFINE_SCENE(sasatest_scene, none, SCENE_SASATEST, SDC_DEFAULT, 0, 0)
/* 0x7A */ DEFINE_SCENE(testroom_scene, none, SCENE_TESTROOM, SDC_DEFAULT, 0, 0)
#endif
