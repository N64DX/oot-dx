...
/* 0x65 */ DEFINE_SCENE(roadtolake_scene, none, SCENE_ROAD_TO_LAKE_HYLIA, SDC_HYRULE_FIELD, 0, 0)
...
/* 0x6B */ DEFINE_SCENE(fairy_deku_tree_scene, none, SCENE_WOODFALL_TEMPLE, SDC_WOODFALL_TEMPLE, 0, 0)
/* 0x6C */ DEFINE_SCENE(fairy_deku_tree_scene, none, SCENE_WOODFALL_TEMPLE_BOSS, SDC_WOODFALL_TEMPLE, 0, 0)
/* 0x6D */ DEFINE_SCENE(fairy_deku_tree_scene, none, SCENE_WOODFALL, SDC_WOODFALL, 0, 0)
/* 0x6E */ DEFINE_SCENE(besitu_scene, none, SCENE_BESITU, SDC_BESITU, 0, 0)

// 0x7B (124th scene) = gSaveContext.save.info.sceneFlags MAX

#if DEBUG_ASSETS
/* 0x6F */ DEFINE_SCENE(test01_scene, none, SCENE_TEST01, SDC_CALM_WATER, 0, 0)
/* 0x70 */ DEFINE_SCENE(depth_test_scene, none, SCENE_DEPTH_TEST, SDC_DEFAULT, 0, 0)
/* 0x71 */ DEFINE_SCENE(syotes_scene, none, SCENE_SYOTES, SDC_DEFAULT, 0, 0)
/* 0x72 */ DEFINE_SCENE(syotes2_scene, none, SCENE_SYOTES2, SDC_DEFAULT, 0, 0)
/* 0x73 */ DEFINE_SCENE(sutaru_scene, none, SCENE_SUTARU, SDC_DEFAULT, 0, 0)
/* 0x74 */ DEFINE_SCENE(hairal_niwa2_scene, g_pn_12, SCENE_HAIRAL_NIWA2, SDC_CASTLE_COURTYARD_GUARDS, 0, 0)
/* 0x75 */ DEFINE_SCENE(sasatest_scene, none, SCENE_SASATEST, SDC_DEFAULT, 0, 0)
/* 0x76 */ DEFINE_SCENE(testroom_scene, none, SCENE_TESTROOM, SDC_DEFAULT, 0, 0)
#endif
