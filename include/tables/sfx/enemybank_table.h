...
/* 0x39F3*/  DEFINE_SFX(CHAN_EN_KUROSUKE_MOVE,      NA_SE_EN_KUROSUKE_MOVE,      0x14, 0, 0, 0)
/* 0x39F4 */ DEFINE_SFX(CHAN_EN_KUROSUKE_ATTACK,    NA_SE_EN_KUROSUKE_ATTACK,    0x34, 0, 0, 0)
/* 0x39F5 */ DEFINE_SFX(CHAN_EN_BATTA_FLY,          NA_SE_EN_BATTA_FLY,          0x28, 5, 0, 0)
/* 0x39F6 */ DEFINE_SFX(CHAN_EN_BATTA_ATTACK,       NA_SE_EN_BATTA_ATTACK,       0x36, 5, 0, 0)
/* 0x39F7 */ DEFINE_SFX(CHAN_EN_BATTA_DAMAGE,       NA_SE_EN_BATTA_DAMAGE,       0x38, 5, 0, 0)
/* 0x39F8 */ DEFINE_SFX(CHAN_EN_BATTA_DEAD,         NA_SE_EN_BATTA_DEAD,         0x48, 5, 0, 0)
/* 0x39F9 */ DEFINE_SFX(CHAN_EN_SUISEN_DEAD,        NA_SE_EN_SUISEN_DEAD,        0x40, 0, 0, 0)
/* 0x39EA */ DEFINE_SFX(CHAN_EN_SUISEN_EAT,         NA_SE_EN_SUISEN_EAT,         0x30, 0, 0, 0)
/* 0x39FB */ DEFINE_SFX(CHAN_EN_PAMET_CUTTER_OFF,   NA_SE_EN_PAMET_CUTTER_OFF,   0x34, 3, 0, 0)
/* 0x39FC */ DEFINE_SFX(CHAN_EN_PAMET_CUTTER_ON,    NA_SE_EN_PAMET_CUTTER_ON,    0x34, 3, 0, 0)
/* 0x39FD */ DEFINE_SFX(CHAN_EN_PAMET_DAMAGE,       NA_SE_EN_PAMET_DAMAGE,       0x40, 3, 0, 0)
/* 0x39FE */ DEFINE_SFX(CHAN_EN_PAMET_VOICE,        NA_SE_EN_PAMET_VOICE,        0x34, 3, 0, 0)
/* 0x39FF */ DEFINE_SFX(CHAN_EN_PAMET_WALK,         NA_SE_EN_PAMET_WALK,         0x24, 0, 1, 0)
/* 0x3A00 */ DEFINE_SFX(CHAN_EN_PAMET_ROLL,         NA_SE_EN_PAMET_ROLL,         0x30, 3, 0, 0)
/* 0x3A01 */ DEFINE_SFX(CHAN_EN_PAMET_REVERSE,      NA_SE_EN_PAMET_REVERSE,      0x40, 3, 0, 0)
/* 0x3A02 */ DEFINE_SFX(CHAN_EN_PAMET_ROAR,         NA_SE_EN_PAMET_ROAR,         0x30, 3, 0, 0)
/* 0x3A03 */ DEFINE_SFX(CHAN_EN_PAMET_WAKEUP,       NA_SE_EN_PAMET_WAKEUP,       0x28, 2, 2, 0)
/* 0x3A04 */ DEFINE_SFX(CHAN_EN_PAMET_DEAD,         NA_SE_EN_PAMET_DEAD,         0x30, 3, 0, 0)
/* 0x3A05 */ DEFINE_SFX(CHAN_EN_SUISEN_DRINK,       NA_SE_EN_SUISEN_DRINK,       0x34, 2, 0, 0)
/* 0x3A06 */ DEFINE_SFX(CHAN_EN_EYEGOLE_ATTACK,     NA_SE_EN_HIPLOOP_LAND,       0x30, 1, 0, 0)
/* 0x3A07 */ DEFINE_SFX(CHAN_EN_TWINROBA_CUTBODY,   NA_SE_EN_CUTBODY,            0x38, 3, 0, 0)
/* 0x3A08 */ DEFINE_SFX(CHAN_EN_BEE_FLY,            NA_SE_EN_BEE_FLY,            0x40, 7, 0, SFX_FLAG_14)
/* 0x3A09 */ DEFINE_SFX(CHAN_EN_BEAST_CRY1,         NA_SE_EN_BEAST_CRY1,         0x32, 0, 0, 0)
/* 0x3A0A */ DEFINE_SFX(CHAN_EN_BEAST_CRY2,         NA_SE_EN_BEAST_CRY2,         0x32, 0, 0, 0)
/* 0x3A0B */ DEFINE_SFX(CHAN_EN_BEAST_HOWL,         NA_SE_EN_BEAST_HOWL,         0x32, 0, 0, 0)
/* 0x3A0C */ DEFINE_SFX(CHAN_EN_BLACKBEAST_SCREAM1, NA_SE_EN_BLACKBEAST_SCREAM1, 0x32, 0, 0, 0)
/* 0x3A0D */ DEFINE_SFX(CHAN_EN_BLACKBEAST_SCREAM2, NA_SE_EN_BLACKBEAST_SCREAM2, 0x32, 0, 0, 0)
/* 0x3A0E */ DEFINE_SFX(CHAN_EN_BLACKBEAST_SCREAM3, NA_SE_EN_BLACKBEAST_SCREAM3, 0x32, 0, 0, 0)
/* 0x3A0F */ DEFINE_SFX(CHAN_EN_STAL_DMGED,         NA_SE_EN_STAL_DMGED,         0x32, 0, 0, 0)
/* 0x3A10 */ DEFINE_SFX(CHAN_EN_STAL_GATHER,        NA_SE_EN_STAL_GATHER,        0x33, 0, 0, 0)
/* 0x3A11 */ DEFINE_SFX(CHAN_EN_STAL_DIE,           NA_SE_EN_STAL_DIE,           0x34, 0, 0, 0)
/* 0x3A12 */ DEFINE_SFX(CHAN_EN_STAL_PICK,          NA_SE_EN_STAL_PICK,          0x31, 0, 0, 0)
/* 0x3A13 */ DEFINE_SFX(CHAN_EN_STAL_REPLACE,       NA_SE_EN_STAL_REPLACE,       0x31, 0, 0, 0)
/* 0x3A14 */ DEFINE_SFX(CHAN_EN_STAL_SCREECH,       NA_SE_EN_STAL_SCREECH,       0x34, 0, 0, 0)
/* 0x3A15 */ DEFINE_SFX(CHAN_EN_STAL_STEP,          NA_SE_EN_STAL_STEP,          0x30, 0, 0, 0)
/* 0x3A16 */ DEFINE_SFX(CHAN_EN_STAL_SWING,         NA_SE_EN_STAL_SWING,         0x31, 0, 0, 0)
/* 0x3A17 */ DEFINE_SFX(CHAN_EN_STAL_TELEGRAPH,     NA_SE_EN_STAL_TELEGRAPH,     0x30, 0, 0, 0)
/* 0x3A17 */ DEFINE_SFX(CHAN_EN_ANSATSUSYA_ENTRY,   NA_SE_EN_ANSATSUSYA_ENTRY,   0x30, 3, 0, 0)
/* 0x3A18 */ DEFINE_SFX(CHAN_EN_ANSATSUSYA_MOVING,  NA_SE_EN_ANSATSUSYA_MOVING,  0x30, 3, 0, 0)
/* 0x3A19 */ DEFINE_SFX(CHAN_EN_ANSATSUSYA_DASH_2,  NA_SE_EN_ANSATSUSYA_DASH_2,  0x28, 3, 0, 0)
/* 0x3A1A */ DEFINE_SFX(CHAN_EN_ANSATSUSYA_SKIP,    NA_SE_EN_ANSATSUSYA_SKIP,    0x30, 3, 0, 0)
/* 0x3A1B */ DEFINE_SFX(CHAN_EN_ANSATSUSYA_DAMAGE,  NA_SE_EN_ANSATSUSYA_DAMAGE,  0x38, 3, 0, 0)
/* 0x3A1C */ DEFINE_SFX(CHAN_EN_ANSATSUSYA_DEAD,    NA_SE_EN_ANSATSUSYA_DEAD,    0x48, 3, 0, 0)
/* 0x3A1D */ DEFINE_SFX(CHAN_EN_ANSATSUSYA_SWORD,   NA_SE_EN_ANSATSUSYA_SWORD,   0x20, 3, 0, 0)
/* 0x3A1E */ DEFINE_SFX(CHAN_EN_ANSATSUSYA_JUMP,    NA_SE_EN_ANSATSUSYA_JUMP,    0x30, 3, 0, 0)
/* 0x3A1F */ DEFINE_SFX(CHAN_EN_ANSATSUSYA_FALL,    NA_SE_EN_ANSATSUSYA_FALL,    0x30, 3, 0, 0)
