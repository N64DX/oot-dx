...
/* 0x385B */ DEFINE_SFX(CHAN_EN_PAMET_CUTTER_OFF, NA_SE_EN_PAMET_CUTTER_OFF, 0x34, 3, 0, 0)
...
/* 0x3889 */ DEFINE_SFX(CHAN_EN_PAMET_CUTTER_ON, NA_SE_EN_PAMET_CUTTER_ON, 0x34, 3, 0, 0)
...
/* 0x38CD */ DEFINE_SFX(CHAN_EN_PAMET_DAMAGE, NA_SE_EN_PAMET_DAMAGE, 0x40, 3, 0, 0)
...
/* 0x38D9 */ DEFINE_SFX(CHAN_EN_SUISEN_DRINK, NA_SE_EN_SUISEN_DRINK, 0x34, 2, 0, 0)
/* 0x38DA */ DEFINE_SFX(CHAN_3E00, NA_SE_EN_VALVAISA_BURN, 0x30, 3, 0, 0)
/* 0x38DB */ DEFINE_SFX(CHAN_EN_EYEGOLE_ATTACK, NA_SE_EN_HIPLOOP_LAND, 0x30, 1, 0, 0)
...
/* 0x3903 */ DEFINE_SFX(CHAN_EN_BEE_FLY, NA_SE_EN_BEE_FLY, 0x40, 7, 0, SFX_FLAG_14)
...
/* 0x3958 */ DEFINE_SFX(CHAN_EN_TWINROBA_CUTBODY, NA_SE_EN_CUTBODY, 0x38, 3, 0, 0)
...
/* 0x3995 */ DEFINE_SFX(CHAN_EN_SUISEN_DEAD, NA_SE_EN_SUISEN_DEAD, 0x40, 0, 0, 0)
...
/* 0x399C */ DEFINE_SFX(CHAN_EN_PAMET_DEAD, NA_SE_EN_PAMET_DEAD, 0x30, 3, 0, 0)
...
/* 0x39B2 */ DEFINE_SFX(CHAN_EN_BATTA_DAMAGE, NA_SE_EN_BATTA_DAMAGE, 0x38, 5, 0, 0)
...
/* 0x39B6 */ DEFINE_SFX(CHAN_EN_BATTA_DEAD, NA_SE_EN_BATTA_DEAD, 0x48, 5, 0, 0)
...
/* 0x39BA */ DEFINE_SFX(CHAN_EN_PAMET_VOICE, NA_SE_EN_PAMET_VOICE, 0x34, 3, 0, 0)
/* 0x39BB */ DEFINE_SFX(CHAN_5403, NA_SE_EN_TWINROBA_YOUNG_WINK, 0x30, 0, 0, SFX_FLAG_13)
/* 0x39BC */ DEFINE_SFX(CHAN_EN_PAMET_WALK, NA_SE_EN_PAMET_WALK, 0x24, 0, 1, 0)
/* 0x39BD */ DEFINE_SFX(CHAN_EN_PAMET_ROLL, NA_SE_EN_PAMET_ROLL, 0x30, 3, 0, 0)
...
/* 0x39C3 */ DEFINE_SFX(CHAN_EN_PAMET_REVERSE, NA_SE_EN_PAMET_REVERSE, 0x40, 3, 0, 0)
/* 0x39C4 */ DEFINE_SFX(CHAN_EN_PAMET_ROAR, NA_SE_EN_PAMET_ROAR, 0x30, 3, 0, 0)
/* 0x39C5 */ DEFINE_SFX(CHAN_EN_PAMET_WAKEUP, NA_SE_EN_PAMET_WAKEUP, 0x28, 2, 2, 0)
...
/* 0x39EC */ DEFINE_SFX(CHAN_EN_SUISEN_EAT, NA_SE_EN_SUISEN_EAT, 0x30, 0, 0, 0)
...
/* 0x39F3 */ DEFINE_SFX(CHAN_EN_STAL_DMGED,      NA_SE_EN_STAL_DMGED,      0x32, 0, 0, 0)
/* 0x39F4 */ DEFINE_SFX(CHAN_EN_STAL_GATHER,     NA_SE_EN_STAL_GATHER,     0x33, 0, 0, 0)
/* 0x39F5 */ DEFINE_SFX(CHAN_EN_STAL_DIE,        NA_SE_EN_STAL_DIE,        0x34, 0, 0, 0)
/* 0x39F6 */ DEFINE_SFX(CHAN_EN_STAL_PICK,       NA_SE_EN_STAL_PICK,       0x31, 0, 0, 0)
/* 0x39F7 */ DEFINE_SFX(CHAN_EN_STAL_REPLACE,    NA_SE_EN_STAL_REPLACE,    0x31, 0, 0, 0)
/* 0x39F8 */ DEFINE_SFX(CHAN_EN_STAL_SCREECH,    NA_SE_EN_STAL_SCREECH,    0x34, 0, 0, 0)
/* 0x39F9 */ DEFINE_SFX(CHAN_EN_STAL_STEP,       NA_SE_EN_STAL_STEP,       0x30, 0, 0, 0)
/* 0x39FA */ DEFINE_SFX(CHAN_EN_STAL_SWING,      NA_SE_EN_STAL_SWING,      0x31, 0, 0, 0)
/* 0x39FB */ DEFINE_SFX(CHAN_EN_STAL_TELEGRAPH,  NA_SE_EN_STAL_TELEGRAPH,  0x30, 0, 0, 0)
/* 0x39FC */ DEFINE_SFX(CHAN_EN_KUROSUKE_MOVE,   NA_SE_EN_KUROSUKE_MOVE,   0x14, 0, 0, 0)
/* 0x39FD */ DEFINE_SFX(CHAN_EN_KUROSUKE_ATTACK, NA_SE_EN_KUROSUKE_ATTACK, 0x34, 0, 0, 0)
/* 0x39FE */ DEFINE_SFX(CHAN_EN_BATTA_FLY,       NA_SE_EN_BATTA_FLY,       0x28, 5, 0, 0)
/* 0x39FF */ DEFINE_SFX(CHAN_EN_BATTA_ATTACK,    NA_SE_EN_BATTA_ATTACK,    0x36, 5, 0, 0)
