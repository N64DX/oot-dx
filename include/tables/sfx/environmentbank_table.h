...
/* 0x28F8 */ DEFINE_SFX(CHAN_EV_FLOWERPETAL_MOVE,        NA_SE_EV_FLOWERPETAL_MOVE,        0x30, 0, 0, 0)
/* 0x28F9 */ DEFINE_SFX(CHAN_EV_FLOWERPETAL_STOP,        NA_SE_EV_FLOWERPETAL_STOP,        0x30, 0, 0, 0)
/* 0x28FA */ DEFINE_SFX(CHAN_EV_FLOWER_ROLLING,          NA_SE_EV_FLOWER_ROLLING,          0x40, 0, 0, 0)
/* 0x28FB */ DEFINE_SFX(CHAN_EV_ICE_FREEZE2,             NA_SE_EV_ICE_FREEZE2,             0x30, 3, 0, 0)
/* 0x28FC */ DEFINE_SFX(CHAN_EV_FALLING_KEY,             NA_SE_EV_FALLING_KEY,             0x30, 0, 0, 0)
/* 0x28FD */ DEFINE_SFX(CHAN_EV_WATERDROP_GRD,           NA_SE_EV_WATERDROP_GRD,           0x30, 0, 0, 0)
/* 0x28FE */ DEFINE_SFX(CHAN_EV_CURTAIN_DOWN,            NA_SE_EV_CURTAIN_DOWN,            0x30, 0, 0, 0)
/* 0x28FF */ DEFINE_SFX(CHAN_EV_OWL_WARP_SWITCH_ON,      NA_SE_EV_OWL_WARP_SWITCH_ON,      0x80, 0, 0, 0)
/* 0x2900 */ DEFINE_SFX(CHAN_EV_WOODPLATE_BROKEN,        NA_SE_EV_WOODPLATE_BROKEN,        0x30, 3, 1, 0)
/* 0x2901 */ DEFINE_SFX(CHAN_EV_SMALL_WOODPLATE_BOUND_0, NA_SE_EV_SMALL_WOODPLATE_BOUND_0, 0x30, 3, 1, 0)
/* 0x2902 */ DEFINE_SFX(CHAN_EV_IKANA_BLOCK_SWITCH,      NA_SE_EV_IKANA_BLOCK_SWITCH,      0x70, 3, 0, 0)
/* 0x2903 */ DEFINE_SFX(CHAN_EV_IKANA_BLOCK_MOVE_X,      NA_SE_EV_IKANA_BLOCK_MOVE_X,      0x60, 3, 0, 0)
/* 0x2904 */ DEFINE_SFX(CHAN_EV_IKANA_BLOCK_MOVE_Z,      NA_SE_EV_IKANA_BLOCK_MOVE_Z,      0x60, 3, 0, 0)
/* 0x2905 */ DEFINE_SFX(CHAN_EV_IKANA_BLOCK_MOVE_Y,      NA_SE_EV_IKANA_BLOCK_MOVE_Y,      0x60, 3, 0, 0)
/* 0x2906 */ DEFINE_SFX(CHAN_EV_IKANA_BLOCK_STOP_C,      NA_SE_EV_IKANA_BLOCK_STOP_C,      0x70, 3, 0, 0)
/* 0x2907 */ DEFINE_SFX(CHAN_EV_IKANA_BLOCK_STOP_F,      NA_SE_EV_IKANA_BLOCK_STOP_F,      0x70, 3, 0, 0)
/* 0x2908 */ DEFINE_SFX(CHAN_EV_EARTHQUAKE_TOWER,        NA_SE_EV_EARTHQUAKE_TOWER,        0xA0, 3, 0, 0)
