...
DEFINE_SEQUENCE    (Sequence_115,       NA_BGM_DEEP_WOODS,       MEDIUM_CART, CACHE_LOAD_TEMPORARY,  SEQ_FLAG_RESUME | SEQ_FLAG_ENEMY       ) // deep_woods
...
DEFINE_SEQUENCE    (Sequence_124,       NA_BGM_RED_ICE_CAVERN,   MEDIUM_CART, CACHE_LOAD_TEMPORARY,  SEQ_FLAG_RESUME | SEQ_FLAG_ENEMY       ) // red_ice_cavern
DEFINE_SEQUENCE    (Sequence_125,       NA_BGM_DAWNGROVE,        MEDIUM_CART, CACHE_LOAD_TEMPORARY,  SEQ_FLAG_RESUME | SEQ_FLAG_ENEMY       ) // dawngrove
