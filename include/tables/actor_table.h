...
/* 0x01DC */ DEFINE_ACTOR(En_BuffDeku, ACTOR_EN_BUFFDEKU, ACTOROVL_ALLOC_NORMAL, "Buff Scrub")
/* 0x01DD */ DEFINE_ACTOR(En_Hammergeist, ACTOR_EN_HAMMERGEIST, ACTOROVL_ALLOC_NORMAL, "En_Hammergeist")
