...
/* 0x004F */ DEFINE_ACTOR_UNSET(ACTOR_UNSET_4F)
...
/* 0x0072 */ DEFINE_ACTOR_UNSET(ACTOR_UNSET_72)
...
/* 0x007C */ DEFINE_ACTOR_UNSET(ACTOR_UNSET_7C)
/* 0x007D */ DEFINE_ACTOR_UNSET(ACTOR_UNSET_7D)
...
/* 0x0082 */ DEFINE_ACTOR_UNSET(ACTOR_UNSET_82)
...
/* 0x0135 */ DEFINE_ACTOR_UNSET(ACTOR_UNSET_135)
...
/* 0x0152 */ DEFINE_ACTOR_UNSET(ACTOR_UNSET_152)
...
DEFINE_ACTOR(Item_Shield_Young, ACTOR_ITEM_SHIELD_YOUNG, ACTOROVL_ALLOC_NORMAL, "Item_Shield_Young")
DEFINE_ACTOR(Item_Somaria_Cube, ACTOR_ITEM_SOMARIA_CUBE, ACTOROVL_ALLOC_NORMAL, "Item_Somaria_Cube")
DEFINE_ACTOR(Bg_Weather, ACTOR_BG_WEATHER, ACTOROVL_ALLOC_NORMAL, "Bg_Weather")
DEFINE_ACTOR(En_Invisible_Ruppe, ACTOR_EN_INVISIBLE_RUPPE, ACTOROVL_ALLOC_NORMAL, "En_Invisible_Ruppe")
DEFINE_ACTOR(En_Hit_Tag, ACTOR_EN_HIT_TAG, ACTOROVL_ALLOC_NORMAL, "En_Hit_Tag")
DEFINE_ACTOR(Obj_Warpstone, ACTOR_OBJ_WARPSTONE, ACTOROVL_ALLOC_NORMAL, "Obj_Warpstone")
DEFINE_ACTOR(Obj_HsStump, ACTOR_OBJ_HSSTUMP, ACTOROVL_ALLOC_NORMAL, "Obj_HsStump")
DEFINE_ACTOR(Bg_Lbfshot, ACTOR_BG_LBFSHOT, ACTOROVL_ALLOC_NORMAL, "Bg_Lbfshot")
DEFINE_ACTOR(Obj_Flowerpot, ACTOR_OBJ_FLOWERPOT, ACTOROVL_ALLOC_NORMAL, "Obj_Flowerpot")
DEFINE_ACTOR(Obj_Kibako3, ACTOR_OBJ_KIBAKO3, ACTOROVL_ALLOC_NORMAL, "Obj_Kibako3")
DEFINE_ACTOR(Bg_Ladder, ACTOR_BG_LADDER, ACTOROVL_ALLOC_NORMAL, "Bg_Ladder")
DEFINE_ACTOR(Bg_Icefloe, ACTOR_BG_ICEFLOE, ACTOROVL_ALLOC_NORMAL, "Bg_Icefloe")
DEFINE_ACTOR(Obj_Visiblock, ACTOR_OBJ_VISIBLOCK, ACTOROVL_ALLOC_NORMAL, "Obj_Visiblock")
DEFINE_ACTOR(Dm_Char01, ACTOR_DM_CHAR01, ACTOROVL_ALLOC_NORMAL, "Dm_Char01")
DEFINE_ACTOR(Bg_Wood_Pillar, ACTOR_BG_WOOD_PILLAR, ACTOROVL_ALLOC_NORMAL, "Bg_Wood_Pillar")
DEFINE_ACTOR(Door_Spiral, ACTOR_DOOR_SPIRAL, ACTOROVL_ALLOC_PERSISTENT, "Door_Spiral")
DEFINE_ACTOR(Bg_Teleporter, ACTOR_BG_TELEPORTER, ACTOROVL_ALLOC_NORMAL, "Bg_Teleporter")
DEFINE_ACTOR(Bg_Ydan_Hasi2, ACTOR_BG_YDAN_HASI2, ACTOROVL_ALLOC_NORMAL, "Bg_Ydan_Hasi2")
DEFINE_ACTOR(Bg_Ydan_Maruta2, ACTOR_BG_YDAN_MARUTA2, ACTOROVL_ALLOC_NORMAL, "Bg_Ydan_Maruta2")
DEFINE_ACTOR(Obj_Lost_Woods, ACTOR_OBJ_LOST_WOODS, ACTOROVL_ALLOC_NORMAL, "Obj_Lost_Woods")
DEFINE_ACTOR(Obj_Dhouse, ACTOR_OBJ_DHOUSE, ACTOROVL_ALLOC_NORMAL, "Obj_Dhouse")
DEFINE_ACTOR(Obj_Hakaisi, ACTOR_OBJ_HAKAISI, ACTOROVL_ALLOC_NORMAL, "Obj_Hakaisi")
DEFINE_ACTOR(Bg_Haka_Bombwall, ACTOR_BG_HAKA_BOMBWALL, ACTOROVL_ALLOC_NORMAL, "Bg_Haka_Bombwall")
DEFINE_ACTOR(Bg_Haka_Curtain, ACTOR_BG_HAKA_CURTAIN, ACTOROVL_ALLOC_NORMAL, "Bg_Haka_Curtain")
DEFINE_ACTOR(Bg_Haka_Tomb, ACTOR_BG_HAKA_TOMB, ACTOROVL_ALLOC_NORMAL, "Bg_Haka_Tomb")
DEFINE_ACTOR(En_Water_Effect, ACTOR_EN_WATER_EFFECT, ACTOROVL_ALLOC_NORMAL, "En_Water_Effect")
DEFINE_ACTOR(En_Test2, ACTOR_EN_TEST2, ACTOROVL_ALLOC_NORMAL, "En_Test2")
DEFINE_ACTOR(Bg_Spdweb, ACTOR_BG_SPDWEB, ACTOROVL_ALLOC_NORMAL, "Bg_Spdweb")
DEFINE_ACTOR(Obj_Spidertent, ACTOR_OBJ_SPIDERTENT, ACTOROVL_ALLOC_NORMAL, "Obj_Spidertent")
DEFINE_ACTOR(Bg_Kin2_Bombwall, ACTOR_BG_KIN2_BOMBWALL, ACTOROVL_ALLOC_NORMAL, "Bg_Kin2_Bombwall")
DEFINE_ACTOR(Bg_Kin2_Shelf, ACTOR_BG_KIN2_SHELF, ACTOROVL_ALLOC_NORMAL, "Bg_Kin2_Shelf")
DEFINE_ACTOR(Bg_Kin2_Picture, ACTOR_BG_KIN2_PICTURE, ACTOROVL_ALLOC_NORMAL, "Bg_Kin2_Picture")
DEFINE_ACTOR(Bg_Kin2_Fence, ACTOR_BG_KIN2_FENCE, ACTOROVL_ALLOC_NORMAL, "Bg_Kin2_Fene")
DEFINE_ACTOR(Bg_Breakwall2, ACTOR_BG_BREAKWALL2, ACTOROVL_ALLOC_NORMAL, "Bg_Breakwall2")
DEFINE_ACTOR(Bg_Dodoago2, ACTOR_BG_DODOAGO2, ACTOROVL_ALLOC_NORMAL, "Bg_Dodoago2")
DEFINE_ACTOR(Bg_Flame_Thrower, ACTOR_BG_FLAME_THROWER, ACTOROVL_ALLOC_NORMAL, "Bg_Flame_Thrower")
DEFINE_ACTOR(Bg_Dblue_Waterfall, ACTOR_BG_DBLUE_WATERFALL, ACTOROVL_ALLOC_NORMAL, "Bg_Dblue_Waterfall")
DEFINE_ACTOR(Obj_Crashbox, ACTOR_OBJ_CRASHBOX, ACTOROVL_ALLOC_NORMAL, "Obj_Crashbox")
DEFINE_ACTOR(Obj_Floater, ACTOR_OBJ_FLOATER, ACTOROVL_ALLOC_NORMAL, "Obj_Floater")
DEFINE_ACTOR(Obj_Purify, ACTOR_OBJ_PURIFY, ACTOROVL_ALLOC_NORMAL, "Obj_Purify")
DEFINE_ACTOR(Obj_Raillift, ACTOR_OBJ_RAILLIFT, ACTOROVL_ALLOC_NORMAL, "Obj_Raillift")
DEFINE_ACTOR(Bg_Dkjail_Ivy, ACTOR_BG_DKJAIL_IVY, ACTOROVL_ALLOC_NORMAL, "Bg_Dkjail_Ivy")
DEFINE_ACTOR(Bg_Numa_Hana, ACTOR_BG_NUMA_HANA, ACTOROVL_ALLOC_NORMAL, "Bg_Numa_Hana")
DEFINE_ACTOR(Bg_F40_Block, ACTOR_BG_F40_BLOCK, ACTOROVL_ALLOC_NORMAL, "Bg_F40_Block")
DEFINE_ACTOR(Bg_F40_Switch, ACTOR_BG_F40_SWITCH, ACTOROVL_ALLOC_NORMAL, "Bg_F40_Switch")
DEFINE_ACTOR(Obj_Fireshield, ACTOR_OBJ_FIRESHIELD, ACTOROVL_ALLOC_NORMAL, "Obj_Fireshield")
DEFINE_ACTOR(Obj_Wturn, ACTOR_OBJ_WTURN, ACTOROVL_ALLOC_NORMAL, "Obj_Wturn")
DEFINE_ACTOR(Obj_Pzlblock, ACTOR_OBJ_PZLBLOCK, ACTOROVL_ALLOC_NORMAL, "Obj_Pzlblock")
DEFINE_ACTOR(Obj_Syokudai2, ACTOR_OBJ_SYOKUDAI2, ACTOROVL_ALLOC_NORMAL, "Obj_Syokudai2")
DEFINE_ACTOR(Obj_Syokudai3, ACTOR_OBJ_SYOKUDAI3, ACTOROVL_ALLOC_NORMAL, "Obj_Syokudai3")
DEFINE_ACTOR(En_Horse_Young, ACTOR_EN_HORSE_YOUNG, ACTOROVL_ALLOC_NORMAL, "En_Horse_Young")
DEFINE_ACTOR(En_Encount3, ACTOR_EN_ENCOUNT3, ACTOROVL_ALLOC_NORMAL, "En_Encount3")
DEFINE_ACTOR(En_Tanron1, ACTOR_EN_TANRON1, ACTOROVL_ALLOC_NORMAL, "En_Tanron1")
DEFINE_ACTOR(En_Raf, ACTOR_EN_RAF, ACTOROVL_ALLOC_NORMAL, "En_Raf")
DEFINE_ACTOR(En_Dinofos, ACTOR_EN_DINOFOS, ACTOROVL_ALLOC_NORMAL, "En_Dinofos")
DEFINE_ACTOR(En_BuffDeku, ACTOR_EN_BUFFDEKU, ACTOROVL_ALLOC_NORMAL, "Buff Scrub")
DEFINE_ACTOR(En_Hammergeist, ACTOR_EN_HAMMERGEIST, ACTOROVL_ALLOC_NORMAL, "En_Hammergeist")
DEFINE_ACTOR(En_Sbeetle, ACTOR_EN_SBEETLE, ACTOROVL_ALLOC_NORMAL, "En_Sbeetle")
DEFINE_ACTOR(En_Miniblin, ACTOR_EN_MINIBLIN, ACTOROVL_ALLOC_NORMAL, "En_Miniblin")
DEFINE_ACTOR(En_Goomba, ACTOR_EN_GOOMBA, ACTOROVL_ALLOC_NORMAL, "En_Goomba")
DEFINE_ACTOR(En_Slim, ACTOR_EN_SLIM, ACTOROVL_ALLOC_NORMAL, "En_Slim")
DEFINE_ACTOR(En_Beast, ACTOR_EN_BEAST, ACTOROVL_ALLOC_NORMAL, "En_Beast")
DEFINE_ACTOR(En_Spider, ACTOR_EN_SPIDER, ACTOROVL_ALLOC_NORMAL, "En_Spider")
DEFINE_ACTOR(En_Thefather, ACTOR_EN_THEFATHER, ACTOROVL_ALLOC_NORMAL, "En_Thefather")
DEFINE_ACTOR(En_Mkk, ACTOR_EN_MKK, ACTOROVL_ALLOC_NORMAL, "En_Mkk")
DEFINE_ACTOR(En_Bee, ACTOR_EN_BEE, ACTOROVL_ALLOC_NORMAL, "En_Bee")
DEFINE_ACTOR(En_Bat, ACTOR_EN_BAT, ACTOROVL_ALLOC_NORMAL, "En_Bat")
DEFINE_ACTOR(En_Grasshopper, ACTOR_EN_GRASSHOPPER, ACTOROVL_ALLOC_NORMAL, "En_Grasshopper")
DEFINE_ACTOR(En_Kame, ACTOR_EN_KAME, ACTOROVL_ALLOC_NORMAL, "En_Kame")
DEFINE_ACTOR(En_Railgibud, ACTOR_EN_RAILGIBUD, ACTOROVL_ALLOC_NORMAL, "En_Railgibud")
DEFINE_ACTOR(En_Jso, ACTOR_EN_JSO, ACTOROVL_ALLOC_NORMAL, "En_Jso")
DEFINE_ACTOR(En_Stalm, ACTOR_EN_STALM, ACTOROVL_ALLOC_NORMAL, "En_Stalm")
DEFINE_ACTOR(Bg_Ganon_Ladder, ACTOR_BG_GANON_LADDER, ACTOROVL_ALLOC_NORMAL, "Bg_Ganon_Ladder")
DEFINE_ACTOR(En_Ganon_Sword, ACTOR_EN_GANON_SWORD, ACTOROVL_ALLOC_NORMAL, "En_Ganon_Sword")
DEFINE_ACTOR(En_Go3, ACTOR_EN_GO3, ACTOROVL_ALLOC_NORMAL, "En_Go3")
DEFINE_ACTOR(En_Jg, ACTOR_EN_JG, ACTOROVL_ALLOC_NORMAL, "En_Jg")
DEFINE_ACTOR(En_Kbt, ACTOR_EN_KBT, ACTOROVL_ALLOC_NORMAL, "En_Kbt")
DEFINE_ACTOR(En_Po_Composer, ACTOR_EN_PO_COMPOSER, ACTOROVL_ALLOC_NORMAL, "En_Po_Composer")
DEFINE_ACTOR(En_Poh_Soul, ACTOR_EN_POH_SOUL, ACTOROVL_ALLOC_NORMAL, "En_Poh_Soul")
