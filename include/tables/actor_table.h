...
/* 0x01DB */ DEFINE_ACTOR(En_Horse_Young, ACTOR_EN_HORSE_YOUNG, ACTOROVL_ALLOC_NORMAL, "En_Horse_Young")
/* 0x01DC */ DEFINE_ACTOR(En_Dinofos, ACTOR_EN_DINOFOS, ACTOROVL_ALLOC_NORMAL, "En_Dinofos")
/* 0x01DD */ DEFINE_ACTOR(En_BuffDeku, ACTOR_EN_BUFFDEKU, ACTOROVL_ALLOC_NORMAL, "Buff Scrub")
/* 0x01DE */ DEFINE_ACTOR(En_Hammergeist, ACTOR_EN_HAMMERGEIST, ACTOROVL_ALLOC_NORMAL, "En_Hammergeist")
...
/* 0x01E5 */ DEFINE_ACTOR(Bg_Ganon_Ladder, ACTOR_BG_GANON_LADDER, ACTOROVL_ALLOC_NORMAL, "Bg_Ganon_Ladder")
/* 0x01E6 */ DEFINE_ACTOR(En_Ganon_Sword, ACTOR_EN_GANON_SWORD, ACTOROVL_ALLOC_NORMAL, "En_Ganon_Sword")
