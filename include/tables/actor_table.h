...
/* 0x01D7 */ DEFINE_ACTOR(En_Invisible_Ruppe, ACTOR_EN_INVISIBLE_RUPPE, ACTOROVL_ALLOC_NORMAL, "En_Invisible_Ruppe")
/* 0x01D8 */ DEFINE_ACTOR(En_Hit_Tag, ACTOR_EN_HIT_TAG, ACTOROVL_ALLOC_NORMAL, "En_Hit_Tag")
/* 0x01D9 */ DEFINE_ACTOR(Bg_Ladder, ACTOR_BG_LADDER, ACTOROVL_ALLOC_NORMAL, "Bg_Ladder")
/* 0x01DA */ DEFINE_ACTOR(En_Horse_Young, ACTOR_EN_HORSE_YOUNG, ACTOROVL_ALLOC_NORMAL, "En_Horse_Young")
/* 0x01DB */ DEFINE_ACTOR(En_BuffDeku, ACTOR_EN_BUFFDEKU, ACTOROVL_ALLOC_NORMAL, "Buff Scrub")
/* 0x01DC */ DEFINE_ACTOR(En_Hammergeist, ACTOR_EN_HAMMERGEIST, ACTOROVL_ALLOC_NORMAL, "En_Hammergeist")
