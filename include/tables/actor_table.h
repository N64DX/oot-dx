...
/* 0x01D7 */ DEFINE_ACTOR(Item_Shield_Young, ACTOR_ITEM_SHIELD_YOUNG, ACTOROVL_ALLOC_NORMAL, "Item_Shield_Young")
/* 0x01D8 */ DEFINE_ACTOR(En_Invisible_Ruppe, ACTOR_EN_INVISIBLE_RUPPE, ACTOROVL_ALLOC_NORMAL, "En_Invisible_Ruppe")
/* 0x01D9 */ DEFINE_ACTOR(En_Hit_Tag, ACTOR_EN_HIT_TAG, ACTOROVL_ALLOC_NORMAL, "En_Hit_Tag")
/* 0x01DA */ DEFINE_ACTOR(Bg_Ladder, ACTOR_BG_LADDER, ACTOROVL_ALLOC_NORMAL, "Bg_Ladder")
/* 0x01DB */ DEFINE_ACTOR(Bg_Ydan_Hasi2, ACTOR_BG_YDAN_HASI2, ACTOROVL_ALLOC_NORMAL, "Bg_Ydan_Hasi2")
/* 0x01DC */ DEFINE_ACTOR(Bg_Ydan_Maruta2, ACTOR_BG_YDAN_MARUTA2, ACTOROVL_ALLOC_NORMAL, "Bg_Ydan_Maruta2")
/* 0x01DD */ DEFINE_ACTOR(Obj_Lost_Woods, ACTOR_OBJ_LOST_WOODS, ACTOROVL_ALLOC_NORMAL, "Obj_Lost_Woods")
/* 0x01DF */ DEFINE_ACTOR(En_Horse_Young, ACTOR_EN_HORSE_YOUNG, ACTOROVL_ALLOC_NORMAL, "En_Horse_Young")
/* 0x01DF */ DEFINE_ACTOR(En_Dinofos, ACTOR_EN_DINOFOS, ACTOROVL_ALLOC_NORMAL, "En_Dinofos")
/* 0x01E0 */ DEFINE_ACTOR(En_BuffDeku, ACTOR_EN_BUFFDEKU, ACTOROVL_ALLOC_NORMAL, "Buff Scrub")
/* 0x01E1 */ DEFINE_ACTOR(En_Hammergeist, ACTOR_EN_HAMMERGEIST, ACTOROVL_ALLOC_NORMAL, "En_Hammergeist")
/* 0x01E2 */ DEFINE_ACTOR(En_Miniblin, ACTOR_EN_MINIBLIN, ACTOROVL_ALLOC_NORMAL, "En_Miniblin")
/* 0x01E3 */ DEFINE_ACTOR(En_Slim, ACTOR_EN_SLIM, ACTOROVL_ALLOC_NORMAL, "En_Slim")
