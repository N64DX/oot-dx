...
/* 0x0006 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_6)
...
/* 0x000F */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_F)
...
/* 0x0023 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_23)
...
/* 0x0028 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_28)
...
/* 0x0033 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_33)
/* 0x0034 */ DEFINE_OBJECT(object_oE_anime, OBJECT_OE_ANIME)
/* 0x0035 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_35)
...
/* 0x003B */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_3B)
/* 0x003C */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_3C)
/* 0x003D */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_3D)
/* 0x003E */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_3E)
/* 0x003F */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_3F)
/* 0x0040 */ DEFINE_OBJECT(object_jj, OBJECT_JJ)
/* 0x0041 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_41)
/* 0x0042 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_42)
/* 0x0043 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_43)
/* 0x0044 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_44)
/* 0x0045 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_45)
...
/* 0x0049 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_49)
/* 0x004A */ DEFINE_OBJECT(object_dekunuts, OBJECT_DEKUNUTS)
/* 0x004B */ DEFINE_OBJECT(object_oE3, OBJECT_OE3)
/* 0x004C */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_4C)
/* 0x004D */ DEFINE_OBJECT(object_menkuri_objects, OBJECT_MENKURI_OBJECTS)
/* 0x004E */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_4E)
/* 0x004F */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_4F)
/* 0x0050 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_50)
/* 0x0051 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_51)
/* 0x0052 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_52)
/* 0x0053 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_53)
/* 0x0054 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_54)
/* 0x0055 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_55)
/* 0x0056 */ DEFINE_OBJECT(object_vali, OBJECT_VALI)
/* 0x0057 */ DEFINE_OBJECT(object_oA10, OBJECT_OA10)
/* 0x0058 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_58)
...
/* 0x0086 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_86)
...
/* 0x009F */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_9F)
...
/* 0x00A9 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_A9)
...
/* 0x00C3 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_C3)
/* 0x00C4 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_C4)
...
/* 0x00CF */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_CF)
...
/* 0x00E3 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_E3)
...
/* 0x00FA */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_FA)
...
/* 0x0124 */ DEFINE_OBJECT_UNSET(OBJECT_UNSET_124)
...
DEFINE_OBJECT(object_link_young, OBJECT_LINK_YOUNG)
DEFINE_OBJECT(object_sek, OBJECT_SEK)
DEFINE_OBJECT(object_hsstump, OBJECT_HSSTUMP)
DEFINE_OBJECT(object_lbfshot, OBJECT_LBFSHOT)
DEFINE_OBJECT(object_flowerpot, OBJECT_FLOWERPOT)
DEFINE_OBJECT(object_ladder, OBJECT_LADDER)
DEFINE_OBJECT(object_icefloe, OBJECT_ICEFLOE)
DEFINE_OBJECT(object_mtoride, OBJECT_MTORIDE)
DEFINE_OBJECT(object_wood_pillar, OBJECT_WOOD_PILLAR)
DEFINE_OBJECT(object_dekucity_obj, OBJECT_DEKUCITY_OBJ)
DEFINE_OBJECT(object_numa_obj, OBJECT_NUMA_OBJ)
DEFINE_OBJECT(object_raillift, OBJECT_RAILLIFT)
DEFINE_OBJECT(object_dkjail_obj, OBJECT_DKJAIL_OBJ)
DEFINE_OBJECT(object_bg_teleporter, OBJECT_BG_TELEPORTER)
DEFINE_OBJECT(object_bridge_piece, OBJECT_BRIDGE_PIECE)
DEFINE_OBJECT(object_deku_platforms, OBJECT_DEKU_PLATFORMS)
DEFINE_OBJECT(object_deku_door, OBJECT_DEKU_DOOR)
DEFINE_OBJECT(object_lost_woods, OBJECT_LOST_WOODS)
DEFINE_OBJECT(object_bwall2, OBJECT_BWALL2)
DEFINE_OBJECT(object_dblue_object, OBJECT_DBLUE_OBJECT)
DEFINE_OBJECT(object_crashbox, OBJECT_CRASHBOX)
DEFINE_OBJECT(object_dhouse, OBJECT_DHOUSE)
DEFINE_OBJECT(object_hakaisi, OBJECT_HAKAISI)
DEFINE_OBJECT(object_haka_obj, OBJECT_HAKA_OBJ)
DEFINE_OBJECT(object_water_effect, OBJECT_WATER_EFFECT)
DEFINE_OBJECT(object_big_fwall, OBJECT_BIG_FWALL)
DEFINE_OBJECT(object_spdweb, OBJECT_SPDWEB)
DEFINE_OBJECT(object_spidertent, OBJECT_SPIDERTENT)
DEFINE_OBJECT(object_kin2_obj, OBJECT_KIN2_OBJ)
DEFINE_OBJECT(object_kinsta2_obj, OBJECT_KINSTA2_OBJ)
DEFINE_OBJECT(object_f40_obj, OBJECT_F40_OBJ)
DEFINE_OBJECT(object_f40_switch, OBJECT_F40_SWITCH)
DEFINE_OBJECT(object_gi_gold_dust, OBJECT_GI_GOLD_DUST)
DEFINE_OBJECT(object_gi_heros_bow, OBJECT_GI_HEROS_BOW)
DEFINE_OBJECT(object_gi_hookshot_mm, OBJECT_GI_HOOKSHOT_MM)
DEFINE_OBJECT(object_gi_feather, OBJECT_GI_FEATHER)
DEFINE_OBJECT(object_gi_pendant, OBJECT_GI_PENDANT)
DEFINE_OBJECT(object_gi_camera, OBJECT_GI_CAMERA)
DEFINE_OBJECT(object_gi_room_key, OBJECT_GI_ROOM_KEY)
DEFINE_OBJECT(object_gi_cane, OBJECT_GI_CANE)
DEFINE_OBJECT(object_gi_title_deed, OBJECT_GI_TITLE_DEED)
DEFINE_OBJECT(object_gi_sword_1_mm, OBJECT_GI_SWORD_1_MM)
DEFINE_OBJECT(object_gi_sword_2_mm, OBJECT_GI_SWORD_2_MM)
DEFINE_OBJECT(object_gi_sword_3_mm, OBJECT_GI_SWORD_3_MM)
DEFINE_OBJECT(object_gi_sword_4_mm, OBJECT_GI_SWORD_4_MM)
DEFINE_OBJECT(object_gi_shield_2_mm, OBJECT_GI_SHIELD_2_MM)
DEFINE_OBJECT(object_gi_shield_3_mm, OBJECT_GI_SHIELD_3_MM)
DEFINE_OBJECT(object_horse_young, OBJECT_HORSE_YOUNG)
DEFINE_OBJECT(object_kgy, OBJECT_KGY)
DEFINE_OBJECT(object_kbt, OBJECT_KBT)
DEFINE_OBJECT(object_jg, OBJECT_JG)
DEFINE_OBJECT(object_raf, OBJECT_RAF)
DEFINE_OBJECT(object_dinofos, OBJECT_DINOFOS)
DEFINE_OBJECT(object_buffdeku, OBJECT_BUFFDEKU)
DEFINE_OBJECT(object_hammergeist, OBJECT_HAMMERGEIST)
DEFINE_OBJECT(object_sbeetle, OBJECT_SBEETLE)
DEFINE_OBJECT(object_miniblin, OBJECT_MINIBLIN)
DEFINE_OBJECT(object_goomba, OBJECT_GOOMBA)
DEFINE_OBJECT(object_slime, OBJECT_SLIME)
DEFINE_OBJECT(object_beast, OBJECT_BEAST)
DEFINE_OBJECT(object_spider, OBJECT_SPIDER)
DEFINE_OBJECT(object_thefather, OBJECT_THEFATHER)
DEFINE_OBJECT(object_mkk, OBJECT_MKK)
DEFINE_OBJECT(object_bee, OBJECT_BEE)
DEFINE_OBJECT(object_bat, OBJECT_BAT)
DEFINE_OBJECT(object_grasshopper, OBJECT_GRASSHOPPER)
DEFINE_OBJECT(object_tl, OBJECT_TL)
DEFINE_OBJECT(object_jso, OBJECT_JSO)
DEFINE_OBJECT(object_stalm, OBJECT_STALM)
