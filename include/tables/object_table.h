...
/* 0x0192 */ DEFINE_OBJECT(object_link_young, OBJECT_LINK_YOUNG)
/* 0x0193 */ DEFINE_OBJECT(object_ladder, OBJECT_LADDER)
/* 0x0194 */ DEFINE_OBJECT(object_bridge_piece, OBJECT_BRIDGE_PIECE)
/* 0x0195 */ DEFINE_OBJECT(object_deku_platforms, OBJECT_DEKU_PLATFORMS)
/* 0x0196 */ DEFINE_OBJECT(object_deku_door, OBJECT_DEKU_DOOR)
/* 0x0197 */ DEFINE_OBJECT(object_lost_woods, OBJECT_LOST_WOODS)
/* 0x0198 */ DEFINE_OBJECT(object_gi_gold_dust, OBJECT_GI_GOLD_DUST)
/* 0x0199 */ DEFINE_OBJECT(object_gi_heros_bow, OBJECT_GI_HEROS_BOW)
/* 0x019A */ DEFINE_OBJECT(object_gi_hookshot_mm, OBJECT_GI_HOOKSHOT_MM)
/* 0x019D */ DEFINE_OBJECT(object_gi_sword_heros, OBJECT_GI_SWORD_HEROS)
/* 0x019E */ DEFINE_OBJECT(object_gi_longsword_mm, OBJECT_GI_LONGSWORD_MM)
/* 0x019F */ DEFINE_OBJECT(object_gi_shield_3_mm, OBJECT_GI_SHIELD_3_MM)
/* 0x01A0 */ DEFINE_OBJECT(object_gi_shield_4, OBJECT_GI_SHIELD_4)
/* 0x01A1 */ DEFINE_OBJECT(object_horse_young, OBJECT_HORSE_YOUNG)
/* 0x01A2 */ DEFINE_OBJECT(object_dinofos, OBJECT_DINOFOS)
/* 0x01A3 */ DEFINE_OBJECT(object_buffdeku, OBJECT_BUFFDEKU)
/* 0x01A4 */ DEFINE_OBJECT(object_hammergeist, OBJECT_HAMMERGEIST)
/* 0x01A5 */ DEFINE_OBJECT(object_miniblin, OBJECT_MINIBLIN)
/* 0x01A6 */ DEFINE_OBJECT(object_slime, OBJECT_SLIME)
