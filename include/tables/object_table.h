...
/* 0x0192 */ DEFINE_OBJECT(object_ladder, OBJECT_LADDER)
/* 0x0193 */ DEFINE_OBJECT(object_gi_gold_dust, OBJECT_GI_GOLD_DUST)
/* 0x0194 */ DEFINE_OBJECT(object_gi_heros_bow, OBJECT_GI_HEROS_BOW)
/* 0x0195 */ DEFINE_OBJECT(object_gi_hookshot_mm, OBJECT_GI_HOOKSHOT_MM)
/* 0x0196 */ DEFINE_OBJECT(object_gi_sword_heros, OBJECT_GI_SWORD_HEROS)
/* 0x0197 */ DEFINE_OBJECT(object_gi_longsword_mm, OBJECT_GI_LONGSWORD_MM)
/* 0x0197 */ DEFINE_OBJECT(object_gi_shield_3_mm, OBJECT_GI_SHIELD_3_MM)
/* 0x0198 */ DEFINE_OBJECT(object_gi_shield_4, OBJECT_GI_SHIELD_4)
/* 0x0199 */ DEFINE_OBJECT(object_horse_young, OBJECT_HORSE_YOUNG)
/* 0x019A */ DEFINE_OBJECT(object_buffdeku, OBJECT_BUFFDEKU)
/* 0x019B */ DEFINE_OBJECT(object_hammergeist, OBJECT_HAMMERGEIST)
