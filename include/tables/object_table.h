...
/* 0x019B */ DEFINE_OBJECT(object_gi_sword_heros, OBJECT_GI_SWORD_HEROS)
/* 0x019C */ DEFINE_OBJECT(object_gi_longsword_mm, OBJECT_GI_LONGSWORD_MM)
/* 0x019D */ DEFINE_OBJECT(object_gi_shield_3_mm, OBJECT_GI_SHIELD_3_MM)
/* 0x019E */ DEFINE_OBJECT(object_gi_shield_4, OBJECT_GI_SHIELD_4)
/* 0x019F */ DEFINE_OBJECT(object_horse_young, OBJECT_HORSE_YOUNG)
/* 0x01A0 */ DEFINE_OBJECT(object_dinofos, OBJECT_DINOFOS)
/* 0x01A1 */ DEFINE_OBJECT(object_buffdeku, OBJECT_BUFFDEKU)
/* 0x01A2 */ DEFINE_OBJECT(object_hammergeist, OBJECT_HAMMERGEIST)
