...
void EndTitle_DrawFull(Actor* thisx, PlayState* play) {
    ...
    gSPTextureRectangle(OVERLAY_DISP++, X_MULTIPLY(HIRES_MULTIPLY(120 + WS_SHIFT_HALF)) << 2, HIRES_MULTIPLY(90 << 2), X_MULTIPLY(HIRES_MULTIPLY(200 + WS_SHIFT_HALF)) << 2, HIRES_MULTIPLY(113 << 2), G_TX_RENDERTILE, 0, 0, X_DIVIDE(HIRES_DIVIDE(1 << 10)), HIRES_DIVIDE(1 << 10));
    ...
    gSPTextureRectangle(OVERLAY_DISP++, X_MULTIPLY(HIRES_MULTIPLY(100 + WS_SHIFT_HALF)) << 2, HIRES_MULTIPLY(160 << 2), X_MULTIPLY(HIRES_MULTIPLY(220 + WS_SHIFT_HALF)) << 2, HIRES_MULTIPLY(183 << 2), G_TX_RENDERTILE, 0, 0, X_DIVIDE(HIRES_DIVIDE(1 << 10)),
                        HIRES_DIVIDE(1 << 10));
    gDPPipeSync(OVERLAY_DISP++);
    ...
    gDPLoadTextureTile(OVERLAY_DISP++, sOcarinaOfTimeTex, G_IM_FMT_IA, G_IM_SIZ_8b, sOcarinaOfTimeTex_WIDTH,
                       ...
                       0, 0, 0, 0);
    gSPTextureRectangle(OVERLAY_DISP++, X_MULTIPLY(HIRES_MULTIPLY(104 + WS_SHIFT_HALF)) << 2, HIRES_MULTIPLY(177 << 2), X_MULTIPLY(HIRES_MULTIPLY(216 + WS_SHIFT_HALF)) << 2, HIRES_MULTIPLY(192 << 2), G_TX_RENDERTILE, 0, 0, X_DIVIDE(HIRES_DIVIDE(1 << 10)),
                        HIRES_DIVIDE(1 << 10));
