...
typedef enum EnGirlAShopItem {
    ...
    /* 0x35 */ SI_SPIRIT_TUNIC,
    /* 0x36 */ SI_SHIELD_POTION,
    /* 0x37 */ SI_WALLET_ADULT,
    /* 0x38 */ SI_WALLET_GIANT,
    /* 0x39 */ SI_WALLET_MASTER,
    /* 0x3A */ SI_WALLET_ROYAL,
    /* 0x3B */ SI_WALLET_TYCOON,
    /* 0x3C */ SI_WALLET_BOTTOMLESS,
    /* 0x3D */ SI_DEKU_SHIELD_REPAIR,
    /* 0x3E */ SI_HYLIAN_SHIELD_REPAIR,
    /* 0x3F */ SI_MIRROR_SHIELD_REPAIR,
    /* 0x40 */ SI_HEROS_SHIELD_REPAIR,
    /* 0x41 */ SI_WOODEN_SHIELD_REPAIR,
    /* 0x42 */ SI_METAL_SHIELD_REPAIR,
    /* 0x43 */ SI_DEKU_SHIELD_UPGRADE,
    /* 0x44 */ SI_HYLIAN_SHIELD_UPGRADE,
    /* 0x45 */ SI_MIRROR_SHIELD_UPGRADE,
    /* 0x46 */ SI_HEROS_SHIELD_UPGRADE,
    /* 0x47 */ SI_MAX
} EnGirlAShopItem;
