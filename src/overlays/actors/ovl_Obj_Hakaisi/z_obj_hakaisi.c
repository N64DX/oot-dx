...
void ObjHakaisi_Init(Actor* thisx, struct PlayState* play);
void ObjHakaisi_Destroy(Actor* thisx, struct PlayState* play);
...
void func_80B14CF8(PlayState* play, Vec3f vec, u8 arg2, u8 arg3, u8 arg4) {
    ...
    for (i=0; i<arg4; i++) {
        ...
        func_8002836C(play, &pos, &velocity, &accel, &sPrimColor, &sEnvColor, arg2, arg3, 10);
    }
}
