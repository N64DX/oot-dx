...
#include "assets/objects/object_toki_objects/object_toki_objects_extra.h"
...
void BgTokiSwd_Draw(Actor* thisx, PlayState* play2) {
    ...
    } else if (this->actor.params == MASTER_SWORD_TEMPLE_OF_TIME) {
        gSPDisplayList(POLY_OPA_DISP++, gObjectTokiObjectsFourSwordDullDL);
    } else {
        gSPDisplayList(POLY_OPA_DISP++, gObjectTokiObjectsFourSwordDL);
    }
