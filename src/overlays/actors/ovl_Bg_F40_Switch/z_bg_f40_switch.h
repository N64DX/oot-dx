...
#define BGF40SWITCH_GET_SWITCH_FLAG(thisx) (((thisx)->params & 0x7E00) >> 9)

typedef void (*BgF40SwitchActionFunc)(struct BgF40Switch*, struct PlayState*);
...
typedef struct BgF40Switch {
    ...
    /* 0x160 */ s8 isInitiator; // true if this switch is the one that initiated a state change; false if this switch is changing as a result of another switch tied to the same flag. this is a temporary flag related to something currently happening, not a permanent property of the switch.
