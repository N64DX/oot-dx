...
static GetItemEntry sGetItemTable[] = {
    ...
    GET_ITEM_NONE,
    // GI_ROCS_FEATHER
    GET_ITEM(ITEM_ROCS_FEATHER, OBJECT_GI_HOVERBOOTS, GID_ROCS_FEATHER, 0x900C, 0x80, CHEST_ANIM_LONG),
    // GI_GOLDEN_FEATHER
    GET_ITEM(ITEM_GOLDEN_FEATHER, OBJECT_GI_HOVERBOOTS, GID_GOLDEN_FEATHER, 0x900D, 0x80, CHEST_ANIM_LONG),
    // GI_SHIELD_MIRROR_MM
    ...
    if (!(this->stateFlags1 & (PLAYER_STATE1_CARRYING_ACTOR | PLAYER_STATE1_29)) && !func_8008F128(this)) {
        ...
        if (item >= ITEM_NONE_FE) {
            ...
            if ( ( (this->actor.bgCheckFlags & BGCHECKFLAG_GROUND) && this->speedXZ <= 0.2f && item == ITEM_ROCS_FEATHER) || item == ITEM_GOLDEN_FEATHER) {
                ...
                func_80838940(this, &gPlayerAnim_link_normal_newroll_jump_20f, !(2 & 1) ? 5.8f : 3.5f, play, /* NA_SE_VO_LI_SWORD_N*/ 0);
                effectsPos.y += 3;
