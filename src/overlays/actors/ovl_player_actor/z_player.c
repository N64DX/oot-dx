...
static GetItemEntry sGetItemTable[] = {
    ...
    // GI_FURTHER_JUMP
	GET_ITEM(ITEM_FURTHER_JUMP, OBJECT_GI_BOOTS_2, GID_BOOTS_KOKIRI, 0x900D, 0x80, CHEST_ANIM_LONG),
    // GI_PERFECT_BLOCK
	GET_ITEM(ITEM_PERFECT_BLOCK, OBJECT_GI_TITLE_DEED, GID_LAND_TITLE_DEED, 0x900B, 0x80, CHEST_ANIM_LONG),
    // GI_WALLET_MASTER
