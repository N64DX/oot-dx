...
static GetItemEntry sGetItemTable[] = {
    ...
    // GI_PICTOBOX
	GET_ITEM(ITEM_PICTOBOX, OBJECT_GI_CAMERA, GID_PICTOGRAPH_BOX, 0x9022, 0x80, CHEST_ANIM_SHORT),
    // GI_SHRINE_KEY
	GET_ITEM(ITEM_SHRINE_KEY, OBJECT_GI_ROOM_KEY, GID_ROOM_KEY, 0x9023, 0x80, CHEST_ANIM_SHORT),
    // GI_BOOTS_UPGRADE
    ...
    // GI_BULLET_BAG_60
	GET_ITEM(ITEM_BULLET_BAG_60, OBJECT_GI_DEKUPOUCH, GID_BULLET_BAG_50, 0x9020, 0x80, CHEST_ANIM_LONG),
    // GI_QUIVER_60
	GET_ITEM(ITEM_QUIVER_60, OBJECT_GI_ARROWCASE, GID_QUIVER_50, 0x9021, 0x80, CHEST_ANIM_LONG),
};
