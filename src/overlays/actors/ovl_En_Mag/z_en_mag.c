...
void EnMag_ResetSram(void) {
    ...
    gSaveContext.skipLogoSetting = 0;
...
void func_80AEEA48_unknown(Gfx** gfxP, s16 arg1, s16 arg2, u32 arg3) {
    if ((D_80121212 != 0) && (func_801C70FC() != 0)) {
        ...
        gSPTextureRectangle(gfx++, HIRES_MULTIPLY(temp_a3), HIRES_MULTIPLY(temp_t0), HIRES_MULTIPLY(temp_a3 + (48 << 2)), HIRES_MULTIPLY(temp_t0 + (16 << 2)), G_TX_RENDERTILE, 0, 0,
