...
BAD_RETURN(s32) EnMag_DrawTextureI8(Gfx** gfxP, void* texture, s16 texWidth, s16 texHeight, s16 rectLeft, s16 rectTop,
    ...
    gSPTextureRectangle(gfx++, X_MULTIPLY(HIRES_MULTIPLY(rectLeft + WS_SHIFT_HALF)) << 2, HIRES_MULTIPLY(rectTop << 2), X_MULTIPLY(HIRES_MULTIPLY(rectLeft + WS_SHIFT_HALF + rectWidth)) << 2, HIRES_MULTIPLY((rectTop + rectHeight) << 2),
                        G_TX_RENDERTILE, 0, 0, HIRES_DIVIDE(dsdx) / SCALE_X, HIRES_DIVIDE(dtdy));
...
void EnMag_DrawImageRGBA32(Gfx** gfxP, s16 centerX, s16 centerY, u8* source, u32 width, u32 height) {
    ...
    for (i = 0; i < textureCount; i++) {
        ...
        gSPTextureRectangle(gfx++, X_MULTIPLY(HIRES_MULTIPLY(rectLeft + WS_SHIFT_HALF)) << 2, HIRES_MULTIPLY(rectTop << 2), X_MULTIPLY(HIRES_MULTIPLY(rectLeft + WS_SHIFT_HALF + (s32)width)) << 2,
                            HIRES_MULTIPLY((rectTop + textureHeight) << 2), G_TX_RENDERTILE, 0, 0, HIRES_DIVIDE(1 << 10) / SCALE_X, HIRES_DIVIDE(1 << 10));
...
void EnMag_DrawCharTexture(Gfx** gfxP, u8* texture, s32 rectLeft, s32 rectTop) {
    ...
    gSPTextureRectangle(gfx++, X_MULTIPLY(HIRES_MULTIPLY(rectLeft + WS_SHIFT_HALF)) << 2, HIRES_MULTIPLY(rectTop << 2), X_MULTIPLY(HIRES_MULTIPLY(rectLeft + WS_SHIFT_HALF + YREG(2))) << 2, HIRES_MULTIPLY((rectTop + YREG(2)) << 2),
                        G_TX_RENDERTILE, 0, 0, HIRES_DIVIDE(YREG(0)) / SCALE_X, HIRES_DIVIDE(YREG(0)));
...
void EnMag_DrawInner(Actor* thisx, PlayState* play, Gfx** gfxP) {
    ...
    if ((s16)this->copyrightAlpha != 0) {
        ...
        gDPLoadTextureBlock(gfx++, gTitleCopyright1998Tex, G_IM_FMT_IA, G_IM_SIZ_8b, 128, 16, 0,
                            G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMASK, G_TX_NOMASK,
                            G_TX_NOLOD, G_TX_NOLOD);
        gSPTextureRectangle(gfx++, X_MULTIPLY(HIRES_MULTIPLY(94 + WS_SHIFT_HALF)) << 2, HIRES_MULTIPLY(198 << 2), X_MULTIPLY(HIRES_MULTIPLY(222 + WS_SHIFT_HALF)) << 2, HIRES_MULTIPLY(214 << 2), G_TX_RENDERTILE, 0, 0, HIRES_DIVIDE(1 << 10) / SCALE_X, HIRES_DIVIDE(1 << 10));
#elif PLATFORM_GC && OOT_VERSION < GC_US
        gDPLoadTextureBlock(gfx++, gTitleCopyright19982002Tex, G_IM_FMT_IA, G_IM_SIZ_8b, 160, 16, 0,
                            G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMASK, G_TX_NOMASK,
                            G_TX_NOLOD, G_TX_NOLOD);
        gSPTextureRectangle(gfx++, X_MULTIPLY(HIRES_MULTIPLY(78 + WS_SHIFT_HALF)) << 2, HIRES_MULTIPLY(198 << 2), X_MULTIPLY(HIRES_MULTIPLY(238 + WS_SHIFT_HALF)) << 2, HIRES_MULTIPLY(214 << 2), G_TX_RENDERTILE, 0, 0, HIRES_DIVIDE(1 << 10) / SCALE_X, HIRES_DIVIDE(1 << 10));
        ...
        gDPLoadTextureBlock(gfx++, gTitleCopyright19982003IQueTex, G_IM_FMT_IA, G_IM_SIZ_8b, 128, 32, 0,
                            G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMASK, G_TX_NOMASK,
                            G_TX_NOLOD, G_TX_NOLOD);
        gSPTextureRectangle(gfx++, X_MULTIPLY(HIRES_MULTIPLY(94 + WS_SHIFT_HALF)) << 2, HIRES_MULTIPLY(198 << 2), X_MULTIPLY(HIRES_MULTIPLY(222 + WS_SHIFT_HALF)) << 2, HIRES_MULTIPLY(230 << 2), G_TX_RENDERTILE, 0, 0, HIRES_DIVIDE(1 << 10) / SCALE_X, HIRES_DIVIDE(1 << 10));
#endif
    }
