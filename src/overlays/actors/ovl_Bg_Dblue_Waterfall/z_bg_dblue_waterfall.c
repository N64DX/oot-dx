...
void BgDblueWaterfall_Draw(Actor* thisx, PlayState* play) {
    ...
    if (this->unk_19F > 0) {
        if (this->unk_19F < 255) {
            gSPSegment(POLY_XLU_DISP++, 0x09, Gfx_TwoTexScroll(play->state.gfxCtx, G_TX_RENDERTILE, -play->gameplayFrames & 0x7F, -play->gameplayFrames & 0x7F, 0x20, 0x20, 1, -play->gameplayFrames & 0x7F, play->gameplayFrames & 0x7F, 0x20, 0x20) /*D_801AEF88*/);
            ...
            gSPSegment(POLY_OPA_DISP++, 0x09, Gfx_TwoTexScroll(play->state.gfxCtx, G_TX_RENDERTILE, -play->gameplayFrames & 0x7F, -play->gameplayFrames & 0x7F, 0x20, 0x20, 1, -play->gameplayFrames & 0x7F, play->gameplayFrames & 0x7F, 0x20, 0x20) /*D_801AEFA0*/);
