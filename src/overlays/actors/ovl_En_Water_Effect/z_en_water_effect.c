 ...
 * Description: Water/rock drop spawner
 *
 * Acts as a "spawner" for either water drops or flaming rocks. This spawner can be placed in the ceiling to drop these repeatedly.
 */
...
void EnWaterEffect_Init(Actor* thisx, struct PlayState* play);
void EnWaterEffect_Destroy(Actor* thisx, struct PlayState* play);
void EnWaterEffect_Update(Actor* thisx, struct PlayState* play);
void EnWaterEffect_Draw(Actor* thisx, struct PlayState* play);

void EnWaterEffect_80A59C04(Actor* thisx, struct PlayState* play);
void EnWaterEffect_80A5A184(Actor* thisx, struct PlayState* play);
void EnWaterEffect_80A5A534(Actor* thisx, struct PlayState* play);
...
void EnWaterEffect_80A587A0(EnWaterEffect* this, Vec3f* arg1, u8 arg2) {
    s16 i;
...
void EnWaterEffect_80A58908(EnWaterEffect* this, Vec3f* arg1, Vec3f* arg2, u8 arg3) {
...
void EnWaterEffect_Init(Actor* thisx, PlayState* play) {
    ...
    if (this->actor.params == ENWATEREFFECT_TYPE_FALLING_ROCK_SPAWNER) {
        this->actor.update = EnWaterEffect_80A59C04;
        this->actor.draw = EnWaterEffect_80A5A184;
    ...
    if (!Flags_GetSwitch(play, this->actor.params)) {
        ...
        if ((this->unk_DC4 % 32) == 0) {
            if (Rand_ZeroOne() < 0.5f) {
                Actor_UpdateBgCheckInfo(play, &this->actor, 20.0f, 10.0f, 40.0f, UPDBGCHECKINFO_FLAG_2);
                ...
                EnWaterEffect_80A587A0(this, &sp88, phi_v1);
            }
        }
    }
    ...
    for (i=0; i<ARRAY_COUNT(this->unk_144) / 2; i++, ptr++) {
        if (ptr->unk_00 != 0) {
            ...
            if (ptr->unk_00 == 1) {
                ...
                if (fabsf(ptr->unk_04.x - player->actor.world.pos.x) < 15.0f && fabsf(ptr->unk_04.z - player->actor.world.pos.z) < 15.0f && player->actor.world.pos.y < ptr->unk_04.y && (ptr->unk_04.y - player->actor.world.pos.y) < 40.0f)
                    phi_v0 = true;
                else phi_v0 = false;
                ...
                if ((ptr->unk_04.y <= this->actor.floorHeight) || phi_v0) {
                    ...
                    for (j=0; j<12; j++) {
                        ...
                        EnWaterEffect_80A58908(this, &ptr->unk_04, &spA4, ptr->unk_2A);
                    }
                }
...
void EnWaterEffect_Draw(Actor* thisx, PlayState* play) {
    ...
    for (i=0; i<ARRAY_COUNT(this->unk_144) / 2; i++, ptr++) {
        if (ptr->unk_00 == 3) {
            ...
            gDPSetPrimColor(POLY_XLU_DISP++, 0, 0, (u8)ptr->unk_38, (u8)(((void)0, ptr->unk_38) + 55.0f), 225, ptr->unk_3C);
...
void EnWaterEffect_80A599E8(EnWaterEffect* this, Vec3f* arg1, u8 arg2) {
    s16 i;
    EnWaterEffectStruct* ptr = &this->unk_144[0];
...
void EnWaterEffect_80A59C04(Actor* thisx, PlayState* play) {
    EnWaterEffect* this = (EnWaterEffect*)thisx;
    f32 temp_f0_2;
    Player* player = GET_PLAYER(play);
    Vec3f sp74, sp90;
    ...
    if (/*rotaryRoom != NULL && Flags_GetSwitch(play, BGIKANAROTARYROOM_GET_SWITCH_FLAG_1(rotaryRoom))*/true)
        ...
        if (this->unk_DC6 == 0) {
            ...
            EnWaterEffect_80A599E8(this, &sp74, 0);
        }
    }
    ...
    for (i=0; i<ARRAY_COUNT(this->unk_144); i++, ptr++) {
        ...
        if (ptr->unk_00 != 0) {
            ...
            if (ptr->unk_00 == 4) {
                ...
                if ((ptr->unk_2A % 2) == 0) {
                    if (ptr->unk_2A == 0)
                        EnWaterEffect_80A599E8(this, &ptr->unk_04, 1);
                    else if ((ptr->unk_01 & 1) == 0)
                        EnWaterEffect_80A599E8(this, &ptr->unk_04, 3);

                    if (ptr->unk_10.y < -20.0f)
                        ptr->unk_10.y = -20.0f;

                    ptr->unk_28 += 0x800;
                    if (fabsf(ptr->unk_04.x - player->actor.world.pos.x) < 20.0f && fabsf(ptr->unk_04.z - player->actor.world.pos.z) < 20.0f && fabsf(ptr->unk_04.y - (player->actor.world.pos.y + 25.0f)) < 30.0f) {
                        phi_s5 = true;
                        if (!player->bodyIsBurning) {
                            Actor_SetPlayerKnockbackLarge(play, &this->actor, 2.0f, Rand_ZeroFloat(0x10000), 0.0f, 0x10);
                    ...
                    if ((ptr->unk_04.y <= temp_f0_2) || (phi_s5 != 0)) {
                        ...
                        if (ptr->unk_2A == 0) {
                            for (j = 0; j < 5; j++)
                                EnWaterEffect_80A599E8(this, &ptr->unk_04, 2);
...
void EnWaterEffect_80A5A184(Actor* thisx, PlayState* play) {
    EnWaterEffect* this = (EnWaterEffect*)thisx;
    GraphicsContext* gfxCtx = play->state.gfxCtx;
    EnWaterEffectStruct* ptr = &this->unk_144[0];
    u8 i, flag = false;
    ...
    for (i=0; i<ARRAY_COUNT(this->unk_144); i++, ptr++) {
        if (ptr->unk_00 == 4) {
            ...
            gSPSegment(POLY_XLU_DISP++, 0x08, Gfx_TwoTexScroll(play->state.gfxCtx, 0, 0, 0, 0x20, 0x40, 1, 0, (ptr->unk_01 * -20) & 0x1FF, 0x20, 0x80));
            ...
            if ((ptr->unk_2A & 1) == 0) {
                ...
                gSPDisplayList(POLY_OPA_DISP++, object_water_effect_DL_06AB30);
            }
        }
    }
...
void EnWaterEffect_80A5A534(Actor* thisx, PlayState* play) {
    EnWaterEffect* this = (EnWaterEffect*)thisx;
    u8 i;
