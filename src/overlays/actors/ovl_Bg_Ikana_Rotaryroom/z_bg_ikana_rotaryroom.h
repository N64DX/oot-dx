...
typedef void (*BgIkanaRotaryroomActionFunc)(struct BgIkanaRotaryroom*, struct PlayState*);
typedef void (*BgIkanaRotaryroomUnkFunc)(Actor*, PlayState*);
typedef void (*BgIkanaRotaryroomUnkFunc2)(struct BgIkanaRotaryroom*, struct PlayState*);
...
typedef struct BgIkanaRotaryroomStruct1 {
    /* 0x00 */ Actor* unk_00;
    /* 0x04 */ MtxF unk_04;
} BgIkanaRotaryroomStruct1; // size = 0x44

typedef struct BgIkanaRotaryroomStruct2 {
    /* 0x00 */ Actor* unk_00;
    /* 0x04 */ MtxF unk_04;
    /* 0x44 */ Vec3s unk_44;
    /* 0x4C */ f32 unk_4C;
...
typedef struct BgIkanaRotaryroomStruct3 {
    /* 0x00 */ MtxF unk_00;
    /* 0x40 */ Vec3s unk_40;
    /* 0x48 */ f32 unk_48;
    /* 0x4C */ Vec3f unk_4C;
