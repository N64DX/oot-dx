...
void KaleidoScope_DrawGameOver(PlayState* play) {
    ...
    gSPTextureRectangle(POLY_OPA_DISP++, X_MULTIPLY(HIRES_MULTIPLY(VREG(87) + WS_SHIFT_HALF)) << 2, HIRES_MULTIPLY(VREG(88) << 2), X_MULTIPLY(HIRES_MULTIPLY(VREG(87) + WS_SHIFT_HALF + 64)) << 2, HIRES_MULTIPLY((VREG(88) + 32) << 2),
    ...
    gSPTextureRectangle(POLY_OPA_DISP++, X_MULTIPLY(HIRES_MULTIPLY(VREG(87) + WS_SHIFT_HALF + 64)) << 2, HIRES_MULTIPLY(VREG(88) << 2), X_MULTIPLY(HIRES_MULTIPLY(VREG(87) + WS_SHIFT_HALF + 128)) << 2,
                        HIRES_MULTIPLY((VREG(88) + 32) << 2), G_TX_RENDERTILE, 0, 0, X_DIVIDE(HIRES_DIVIDE(1 << 10)), HIRES_DIVIDE(1 << 10));

    gDPLoadMultiBlock(POLY_OPA_DISP++, gGameOverP3Tex, 0x0000, G_TX_RENDERTILE, G_IM_FMT_IA, G_IM_SIZ_8b, 64, 32, 0,
                      G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD,
                      G_TX_NOLOD);
    gSPTextureRectangle(POLY_OPA_DISP++, X_MULTIPLY(HIRES_MULTIPLY(VREG(87) + WS_SHIFT_HALF + 128)) << 2, HIRES_MULTIPLY(VREG(88) << 2), X_MULTIPLY(HIRES_MULTIPLY(VREG(87) + WS_SHIFT_HALF + 192)) << 2,
                        HIRES_MULTIPLY((VREG(88) + 32) << 2), G_TX_RENDERTILE, 0, 0, X_DIVIDE(HIRES_DIVIDE(1 << 10)), HIRES_DIVIDE(1 << 10));
...
void KaleidoScope_DrawSwapItemIcons(PlayState* play, ItemID currItem, ItemID nextItem, u16 alpha) {
    ...
    gSPTextureRectangle(OVERLAY_DISP++, X_MULTIPLY(HIRES_MULTIPLY(WS_SHIFT_FULL + x)) << 2, HIRES_MULTIPLY(y << 2), X_MULTIPLY(HIRES_MULTIPLY(WS_SHIFT_FULL + x + 40)) << 2, HIRES_MULTIPLY((y + 20) << 2), G_TX_RENDERTILE, 0, 0, X_DIVIDE(HIRES_DIVIDE(1850)), HIRES_DIVIDE(1230));
    ...
    gSPTextureRectangle(OVERLAY_DISP++, X_MULTIPLY(HIRES_MULTIPLY(WS_SHIFT_FULL + x + 40)) << 2, HIRES_MULTIPLY(y << 2), X_MULTIPLY(HIRES_MULTIPLY(WS_SHIFT_FULL + x + 40 + 40)) << 2, HIRES_MULTIPLY((y + 20) << 2), G_TX_RENDERTILE, 0, 0, X_DIVIDE(HIRES_DIVIDE(1850)), HIRES_DIVIDE(1230));
    ...
    gSPTextureRectangle(OVERLAY_DISP++, X_MULTIPLY(HIRES_MULTIPLY(WS_SHIFT_FULL + x + 16)) << 2, HIRES_MULTIPLY((y + 3) << 2), X_MULTIPLY(HIRES_MULTIPLY(WS_SHIFT_FULL + x + 16 + 14)) << 2, HIRES_MULTIPLY((y + 3 + 14) << 2), G_TX_RENDERTILE, 0, 0, X_DIVIDE(HIRES_DIVIDE(2340)), HIRES_DIVIDE(2340));
    ...
    gSPTextureRectangle(OVERLAY_DISP++, X_MULTIPLY(HIRES_MULTIPLY(WS_SHIFT_FULL + x + 28)) << 2, HIRES_MULTIPLY((y - 2) << 2), X_MULTIPLY(HIRES_MULTIPLY(WS_SHIFT_FULL + x + 28 + 24)) << 2, HIRES_MULTIPLY((y - 2 + 24) << 2), G_TX_RENDERTILE, 0, 0, X_DIVIDE(HIRES_DIVIDE(1365)), HIRES_DIVIDE(1365));
    ...
    gSPTextureRectangle(OVERLAY_DISP++, X_MULTIPLY(HIRES_MULTIPLY(WS_SHIFT_FULL + x + 52)) << 2, HIRES_MULTIPLY((y + 3) << 2), X_MULTIPLY(HIRES_MULTIPLY(WS_SHIFT_FULL + x + 52 + 14)) << 2, HIRES_MULTIPLY((y + 3 + 14) << 2), G_TX_RENDERTILE, 0, 0, X_DIVIDE(HIRES_DIVIDE(2340)), HIRES_DIVIDE(2340));
