...
void KaleidoScope_DrawGameOver(PlayState* play) {
    ...
    gSPTextureRectangle(POLY_OPA_DISP++, (VREG(87) + (WIDESCREEN ? 52 : 0)) << 2, VREG(88) << 2, (VREG(87) + (WIDESCREEN ? 52 : 0) + 64) << 2, (VREG(88) + 32) << 2,
    ...
    gSPTextureRectangle(POLY_OPA_DISP++, (VREG(87) + (WIDESCREEN ? 52 : 0) + 64) << 2, VREG(88) << 2, (VREG(87) + (WIDESCREEN ? 52 : 0) + 128) << 2,
    ...
    gDPLoadMultiBlock(POLY_OPA_DISP++, gGameOverP3Tex, 0x0000, G_TX_RENDERTILE, G_IM_FMT_IA, G_IM_SIZ_8b, 64, 32, 0,
                      G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD,
                      G_TX_NOLOD);
    gSPTextureRectangle(POLY_OPA_DISP++, (VREG(87) + (WIDESCREEN ? 52 : 0) + 128) << 2, VREG(88) << 2, (VREG(87) + (WIDESCREEN ? 52 : 0) + 192) << 2,
                        (VREG(88) + 32) << 2, G_TX_RENDERTILE, 0, 0, 1 << 10, 1 << 10);
