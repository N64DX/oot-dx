...
void KaleidoScope_DrawGameOver(PlayState* play) {
    ...
    gSPTextureRectangle(POLY_OPA_DISP++, HIRES_MULTIPLY((VREG(87) + WS_SHIFT_HALF) << 2) * SCALE_X, HIRES_MULTIPLY(VREG(88) << 2), HIRES_MULTIPLY((VREG(87) + WS_SHIFT_HALF + 64) << 2) * SCALE_X, HIRES_MULTIPLY((VREG(88) + 32) << 2),
    ...
    gSPTextureRectangle(POLY_OPA_DISP++, HIRES_MULTIPLY((VREG(87) + WS_SHIFT_HALF + 64) << 2) * SCALE_X, HIRES_MULTIPLY(VREG(88) << 2), HIRES_MULTIPLY((VREG(87) + WS_SHIFT_HALF + 128) << 2) * SCALE_X,
    ...
    gDPLoadMultiBlock(POLY_OPA_DISP++, gGameOverP3Tex, 0x0000, G_TX_RENDERTILE, G_IM_FMT_IA, G_IM_SIZ_8b, 64, 32, 0,
                      G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD,
                      G_TX_NOLOD);
    gSPTextureRectangle(POLY_OPA_DISP++, HIRES_MULTIPLY((VREG(87) + WS_SHIFT_HALF + 128) << 2) * SCALE_X, HIRES_MULTIPLY(VREG(88) << 2), HIRES_MULTIPLY((VREG(87) + WS_SHIFT_HALF + 192) << 2) * SCALE_X,
                        HIRES_MULTIPLY((VREG(88) + 32) << 2), G_TX_RENDERTILE, 0, 0, HIRES_DIVIDE(1 << 10) / SCALE_X, HIRES_DIVIDE(1 << 10));
...
void KaleidoScope_DrawSwapItemIcons(PlayState* play, ItemID currItem, ItemID nextItem, u16 alpha) {
    ...
    gSPTextureRectangle(OVERLAY_DISP++, HIRES_MULTIPLY((WS_SHIFT_FULL + x) << 2) * SCALE_X, HIRES_MULTIPLY(y << 2), HIRES_MULTIPLY((WS_SHIFT_FULL + x + 40) << 2) * SCALE_X, HIRES_MULTIPLY((y + 20) << 2), G_TX_RENDERTILE, 0, 0, HIRES_DIVIDE(1850) / SCALE_X, HIRES_DIVIDE(1230));
    ...
    gSPTextureRectangle(OVERLAY_DISP++, HIRES_MULTIPLY((WS_SHIFT_FULL + x + 40) << 2) * SCALE_X, HIRES_MULTIPLY(y << 2), HIRES_MULTIPLY((WS_SHIFT_FULL + x + 40 + 40) << 2) * SCALE_X, HIRES_MULTIPLY((y + 20) << 2), G_TX_RENDERTILE, 0, 0, HIRES_DIVIDE(1850) / SCALE_X, HIRES_DIVIDE(1230));
    ...
    gSPTextureRectangle(OVERLAY_DISP++, HIRES_MULTIPLY((WS_SHIFT_FULL + x + 16) << 2) * SCALE_X, HIRES_MULTIPLY((y + 3) << 2), HIRES_MULTIPLY((WS_SHIFT_FULL + x + 16 + 14) << 2) * SCALE_X, HIRES_MULTIPLY((y + 3 + 14) << 2), G_TX_RENDERTILE, 0, 0, HIRES_DIVIDE(2340) / SCALE_X, HIRES_DIVIDE(2340));
    ...
    gSPTextureRectangle(OVERLAY_DISP++, HIRES_MULTIPLY((WS_SHIFT_FULL + x + 28) << 2) * SCALE_X, HIRES_MULTIPLY((y - 2) << 2), HIRES_MULTIPLY((WS_SHIFT_FULL + x + 28 + 24) << 2) * SCALE_X, HIRES_MULTIPLY((y - 2 + 24) << 2), G_TX_RENDERTILE, 0, 0, HIRES_DIVIDE(1365) / SCALE_X, HIRES_DIVIDE(1365));
    ...
    gSPTextureRectangle(OVERLAY_DISP++, HIRES_MULTIPLY((WS_SHIFT_FULL + x + 52) << 2) * SCALE_X, HIRES_MULTIPLY((y + 3) << 2), HIRES_MULTIPLY((WS_SHIFT_FULL + x + 52 + 14) << 2) * SCALE_X, HIRES_MULTIPLY((y + 3 + 14) << 2), G_TX_RENDERTILE, 0, 0, HIRES_DIVIDE(2340) / SCALE_X, HIRES_DIVIDE(2340));
