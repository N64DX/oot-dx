...
static u8 sSavedButtonStatus[9];
...
void KaleidoScope_DrawGameOver(PlayState* play) {
    ...
    gSPTextureRectangle(POLY_OPA_DISP++, X_HIRES_MULTIPLY(VREG(87) + WS_SHIFT_HALF) << 2, HIRES_MULTIPLY(VREG(88) << 2), X_HIRES_MULTIPLY(VREG(87) + WS_SHIFT_HALF + 64) << 2, HIRES_MULTIPLY((VREG(88) + 32) << 2),
    ...
    gSPTextureRectangle(POLY_OPA_DISP++, X_HIRES_MULTIPLY(VREG(87) + WS_SHIFT_HALF + 64) << 2, HIRES_MULTIPLY(VREG(88) << 2), X_HIRES_MULTIPLY(VREG(87) + WS_SHIFT_HALF + 128) << 2,
                        HIRES_MULTIPLY((VREG(88) + 32) << 2), G_TX_RENDERTILE, 0, 0, X_HIRES_DIVIDE(1 << 10), HIRES_DIVIDE(1 << 10));

    gDPLoadMultiBlock(POLY_OPA_DISP++, gGameOverP3Tex, 0x0000, G_TX_RENDERTILE, G_IM_FMT_IA, G_IM_SIZ_8b, 64, 32, 0,
                      G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD,
                      G_TX_NOLOD);
    gSPTextureRectangle(POLY_OPA_DISP++, X_HIRES_MULTIPLY(VREG(87) + WS_SHIFT_HALF + 128) << 2, HIRES_MULTIPLY(VREG(88) << 2), X_HIRES_MULTIPLY(VREG(87) + WS_SHIFT_HALF + 192) << 2,
                        HIRES_MULTIPLY((VREG(88) + 32) << 2), G_TX_RENDERTILE, 0, 0, X_HIRES_DIVIDE(1 << 10), HIRES_DIVIDE(1 << 10));
...
void KaleidoScope_Update(PlayState* play) {
    ...
    switch (pauseCtx->state) {
        case PAUSE_STATE_INIT:
            ...
            sSavedButtonStatus[5] = dpadStatus[0];
            sSavedButtonStatus[6] = dpadStatus[1];
            sSavedButtonStatus[7] = dpadStatus[2];
            sSavedButtonStatus[8] = dpadStatus[3];
