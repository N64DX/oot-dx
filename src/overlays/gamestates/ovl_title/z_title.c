...
void ConsoleLogo_Draw(ConsoleLogoState* this) {
    ...
    for (idx = 0, y = 94; idx < 16; idx++, y += 2) {
        ...
        gSPTextureRectangle(POLY_OPA_DISP++, (((WIDESCREEN ? 52 : 0) + 97) << 2) * (HIRES ? 2 : 1), (y << 2) * (HIRES ? 2 : 1), (((WIDESCREEN ? 52 : 0) + 289) << 2) * (HIRES ? 2 : 1), ((y + 2) << 2) * (HIRES ? 2 : 1), G_TX_RENDERTILE, 0, 0, (1 << 10) / (HIRES ? 2 : 1),
                            (1 << 10) / (HIRES ? 2 : 1));
    }
