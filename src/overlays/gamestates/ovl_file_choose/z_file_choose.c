...
#if OOT_VERSION <= PAL_1_1
static void* sQuestButtonTextures[QUEST_MAX+1] = { gFileSelQuestOcarinaOfTimeButtonTex, gFileSelQuestMasterQuestButtonTex, gFileSelQuestUraQuestButtonTex, gFileSelQuestChildQuestButtonTex, gFileSelQuestChildMasterQuestButtonTex, NULL,
                                                   gFileSelQuestOcarinaOfTimeButtonTex, gFileSelQuestOcarinaOfTimeButtonTex, gFileSelQuestOcarinaOfTimeButtonTex, gFileSelQuestOcarinaOfTimeButtonTex };
#endif
