...
void FileSelectGlobalOptions_ToggleScreenMode(FileSelectState* this, u8 index, u8 shift) {
    gSaveContext.screenMode++;
    if (gSaveContext.screenMode > 3)
        gSaveContext.screenMode = 0;
    Audio_PlaySfxGeneral(NA_SE_IT_SWORD_IMPACT, &gSfxDefaultPos, 4, &gSfxDefaultFreqAndVolScale, &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
}

void FileSelectGlobalOptions_ToggleSkipLogo(FileSelectState* this, u8 index, u8 shift) {
    gSaveContext.skipLogo ^= 1;
    Audio_PlaySfxGeneral(NA_SE_IT_SWORD_IMPACT, &gSfxDefaultPos, 4, &gSfxDefaultFreqAndVolScale, &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
}
...
char* FileSelectGlobalOptions_GetToggleScreenMode(FileSelectState* this, u8 index, u8 shift) {
    switch (gSaveContext.screenMode) {
        case 1:
            return "Hires";
        case 2:
            return "16:9";
...
char* FileSelectGlobalOptions_GetToggleSkipLogo(FileSelectState* this, u8 index, u8 shift) {
    return gSaveContext.skipLogo ? "On" : "Off";
}
...
static FileSelectOptionsEntry sFileOptionsEntries[] = {
    ...
    { 0, "Pull Sword Out",         FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 9  },
    { 0, "No Disruptive Text",     FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 10 },
    { 0, "Bow Aiming Reticle",     FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 11 },
    { 0, "No Low Health Beep",     FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 12 },
    { 0, "Uninverted  Aiming",     FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 13 },
    { 0, "Fix Power Crouch Stab",  FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 14 },
    { 0, "Reflect Chest Contents", FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 15 },
    { 0, "Easier Fishing",         FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 16 },
    { 0, "Use MM Young Link",      FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 17 },
...
static FileSelectOptionsEntry sGlobalOptionsEntries[] = {
    { 0, "Screen Mode", FileSelectGlobalOptions_ToggleScreenMode, FileSelectGlobalOptions_GetToggleScreenMode, 0, 0 },
