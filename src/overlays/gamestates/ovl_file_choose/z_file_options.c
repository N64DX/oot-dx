...
static FileSelectOptionsEntry sFileOptionsEntries[] = {
    ...
    { 0, "Extended Draw Distance", FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 2  },
    { 0, "No Letterboxing",        FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 3  },
    { 0, "Resume Last Area",       FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 4  },
#if !PLATFORM_IQUE
    { 0, "Disable Token Freeze",   FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 5  },
#endif
    { 0, "Censor Fire Temple",     FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 6  },
    { 0, "Skip Intros",            FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 7  },
    { 0, "No Owl",                 FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 8  },
    { 0, "Instant Put Away",       FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 9  },
    { 0, "Pull Sword Out",         FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 10 },
    { 0, "No Disruptive Text",     FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 11 },
    { 0, "Bow Aiming Reticle",     FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 12 },
    { 0, "No Low Health Beep",     FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 13 },
    { 0, "Uninverted  Aiming",     FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 14 },
    { 0, "Fix Power Crouch Stab",  FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 15 },
    { 0, "Reflect Chest Contents", FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 16 },
    { 0, "Easier Fishing",         FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 17 },
    { 0, "Use MM Young Link",      FileSelectOptions_ToggleOption,      FileSelectOptions_GetOption,         0, 18 },
