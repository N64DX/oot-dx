...
static MapSelectEntry sMapSelectEntries[] = {
    ...
    { "128:" T(GFXP_HIRAGANA "ﾄﾞｰﾝｸﾞﾛｰﾌﾞ･ﾋﾞﾚｯｼﾞ", "Dawngrove Village"), MapSelect_LoadGame, ENTR_DAWNGROVE_VILLAGE_0 },
    { "129:" T(GFXP_HIRAGANA "ﾄﾞｰﾝｸﾞﾛｰﾌﾞ･ﾊｳｽ", "Dawngrove House"), MapSelect_LoadGame, ENTR_DAWNGROVE_HOUSE_0 },
    { "130:" T(GFXP_HIRAGANA "ｲｺﾞｰﾙの家", "Igor's House"), MapSelect_LoadGame, ENTR_IGORS_HOUSE_0 },
    { "131:" T(GFXP_HIRAGANA "ﾄﾞｰﾝｸﾞﾛｰﾌﾞ･ｲﾝﾞ", "Dawngrove Inn"), MapSelect_LoadGame, ENTR_DAWNGROVE_INN_0 },
    { "132:" T(GFXP_HIRAGANA "ﾄﾞｰﾝｸﾞﾛｰﾌﾞ", "Dawngrove"), MapSelect_LoadGame, ENTR_DAWNGROVE_0 },
    { "133:" T(GFXP_HIRAGANA "ﾄﾞｰﾝｸﾞﾛｰﾌﾞ･ｼｮｯﾌﾟﾞ", "Dawngrove Shop"), MapSelect_LoadGame, ENTR_DAWNGROVE_SHOP_0 },
    ...
    { "147:" T(GFXP_HIRAGANA "ﾄﾞｰﾝｸﾞﾛｰﾌﾞ･ｸﾞﾛｯﾄ", "Dawngrove Grotto"), MapSelect_LoadGame, ENTR_GROTTOS2_7 },
