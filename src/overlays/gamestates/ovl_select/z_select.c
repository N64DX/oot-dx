...
static MapSelectEntry sMapSelectEntries[] = {
    ...
    { "27:" T(GFXP_HIRAGANA "ﾀﾞｲﾖｳｾｲﾉｲｽﾞﾐ", "Great Fairy's Fountain R1"), MapSelect_LoadGame,
    ...
    { "29:" T(GFXP_HIRAGANA "ﾏﾎｳｾｷ ﾖｳｾｲﾉｲｽﾞﾐ", "Great Fairy's Fountain G1"), MapSelect_LoadGame,
    ...
    { "124:" T(GFXP_HIRAGANA "ﾄﾞｰﾝｸﾞﾛｰﾌﾞ･ﾋﾞﾚｯｼﾞ", "Dawngrove Village"), MapSelect_LoadGame, ENTR_DAWNGROVE_VILLAGE_0 },
    { "125:" T(GFXP_HIRAGANA "ﾄﾞｰﾝｸﾞﾛｰﾌﾞ", "Dawngrove"), MapSelect_LoadGame, ENTR_DAWNGROVE_0 },
    { "126:" T(GFXP_HIRAGANA "ﾚｲｸﾊｲﾘｱﾐﾁ", "Path to Lake Hylia"), MapSelect_LoadGame, ENTR_PATH_TO_LAKE_HYLIA_0 },
    { "127:" T(GFXP_HIRAGANA "ｽﾌﾟﾘﾝｸﾞﾚｲｸ", "Spring Lake"), MapSelect_LoadGame, ENTR_SPRING_LAKE_0 },
    { "128:" T(GFXP_HIRAGANA "ｽﾌﾟﾘﾝｸﾞﾚｲｸﾉｶｼﾞﾔ", "Spring Lake Smithy"), MapSelect_LoadGame, ENTR_SPRING_LAKE_SMITHY_0 },
    { "129:" T(GFXP_HIRAGANA "ｺﾞﾛﾝﾉｻﾄﾍﾉﾐﾁ", "Path to Goron Village"), MapSelect_LoadGame, ENTR_PATH_TO_GORON_VILLAGE_0 },
    { "130:" T(GFXP_HIRAGANA "ｺﾞﾛﾝﾉｻﾄ", "Goron Village"), MapSelect_LoadGame, ENTR_GORON_VILLAGE_0 },
    { "131:" T(GFXP_HIRAGANA "ｺﾞﾛﾝﾉﾎｺﾗ", "Goron Shrine"), MapSelect_LoadGame, ENTR_GORON_SHRINE_0 },
    { "132:" T(GFXP_HIRAGANA "ｳｯﾄﾞﾌｫｰﾙ ﾄﾚｲﾙ", "Path to Woodfall"), MapSelect_LoadGame, ENTR_PATH_TO_WOODFALL_0 },
    { "133:" T(GFXP_HIRAGANA "ｳｯﾄﾞﾌｫｰﾙ ﾄﾚｲﾙ", "Ghost Shop"), MapSelect_LoadGame, ENTR_MARKET_GUARD_HOUSE_1 },
    { "134:" T(GFXP_HIRAGANA "ﾄﾘﾃﾞﾐﾁ", "Path to Gerudo's Fortress"), MapSelect_LoadGame, ENTR_PATH_TO_FORTRESS_0 },
    { "135:" T(GFXP_HIRAGANA "ｽｶﾙﾁｭﾗﾄﾞｳｸﾂ", "Webbed Shrine"), MapSelect_LoadGame, ENTR_WEBBED_SHRINE_0 },
    { "136:" T(GFXP_HIRAGANA "古代樹", "Forbidden Woods"), MapSelect_LoadGame, ENTR_FORBIDDEN_WOODS_0 },
    { "137:" T(GFXP_HIRAGANA "古代樹", "Ancient Hollow"), MapSelect_LoadGame, ENTR_ANCIENT_HOLLOW_0 },
    { "138:" T(GFXP_HIRAGANA "ｺﾞﾛﾝｺｳｻﾞﾝ", "Goron Mines"), MapSelect_LoadGame, ENTR_GORON_MINES_0 },
    { "139:" T(GFXP_HIRAGANA "ｳｯﾄﾞﾌｫｰﾙﾉｼﾝﾃﾞﾝ", "Woodfall"), MapSelect_LoadGame, ENTR_WOODFALL_0 },
    { "140:" T(GFXP_HIRAGANA "ｳｯﾄﾞﾌｫｰﾙﾉｼﾝﾃﾞﾝ", "Woodfall Temple"), MapSelect_LoadGame, ENTR_WOODFALL_TEMPLE_0 },
    { "141:" T(GFXP_HIRAGANA "ｳｯﾄﾞﾌｫｰﾙﾉｼﾝﾃﾞﾝﾎﾞｽ", "Woodfall Temple (Boss)"), MapSelect_LoadGame, ENTR_WOODFALL_TEMPLE_BOSS_0 },
    { "142:" T(GFXP_HIRAGANA "ｼｮｰﾄｶｯﾄﾄﾋﾞｺﾐｱ 1", "Grotto (Shortcut 1)"), MapSelect_LoadGame, ENTR_GROTTOS2_0 },
    { "143:" T(GFXP_HIRAGANA "ｼｮｰﾄｶｯﾄﾄﾋﾞｺﾐｱ 2", "Grotto (Shortcut 2)"), MapSelect_LoadGame, ENTR_GROTTOS2_2 },
    { "144:" T(GFXP_HIRAGANA "ｼｮｰﾄｶｯﾄﾄﾋﾞｺﾐｱ 3", "Grotto (Dinolfos)"), MapSelect_LoadGame, ENTR_GROTTOS2_4 },
    { "145:" T(GFXP_HIRAGANA "ｽﾀﾙﾏｽﾀｰﾉﾚｱｰ", "Stalmaster Miniboss 1"), MapSelect_LoadGame, ENTR_GROTTOS2_5 },
    { "146:" T(GFXP_HIRAGANA "ｽﾀﾙﾏｽﾀｰﾉﾚｱｰ", "Stalmaster Miniboss 2"), MapSelect_LoadGame, ENTR_GROTTOS2_6 },
#endif
