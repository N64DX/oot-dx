...
void GfxPrint_SetPos(GfxPrint* this, s32 x, s32 y) {
    GfxPrint_SetPosPx(this, (x + GFXPRINT_SHIFT) * GFX_CHAR_X_SPACING, y * GFX_CHAR_Y_SPACING);
}
...
void GfxPrint_PrintCharImpl(GfxPrint* this, u8 c) {
    ...
    if (this->flags & GFXP_FLAG_SHADOW) {
        ...
        gSPTextureRectangle(this->dList++, X_MULTIPLY(HIRES_MULTIPLY(this->posX + 4 + WS_SHIFT_HALF)), HIRES_MULTIPLY(this->posY + 4), X_MULTIPLY(HIRES_MULTIPLY(this->posX + 4 + 32 + WS_SHIFT_HALF) - (HIRES_PX_SHIFT * 2)), HIRES_MULTIPLY(this->posY + 4 + 32) - (HIRES_PX_SHIFT * 2),
                            tile, (u16)(c & 4) * 64, (u16)(c >> 3) * 256, X_DIVIDE(HIRES_DIVIDE(1 << 10)), HIRES_DIVIDE(1 << 10));

        gDPSetColor(this->dList++, G_SETPRIMCOLOR, this->color.rgba);
    }

    gSPTextureRectangle(this->dList++, X_MULTIPLY(HIRES_MULTIPLY(this->posX + WS_SHIFT_HALF)), HIRES_MULTIPLY(this->posY), X_MULTIPLY(HIRES_MULTIPLY(this->posX + 32 + WS_SHIFT_HALF) - (HIRES_PX_SHIFT * 2)), HIRES_MULTIPLY(this->posY + 32) - (HIRES_PX_SHIFT * 2), tile,
                        (u16)(c & 4) * 64, (u16)(c >> 3) * 256, X_DIVIDE(HIRES_DIVIDE(1 << 10)), HIRES_DIVIDE(1 << 10));
