...
void GfxPrint_PrintCharImpl(GfxPrint* this, u8 c) {
    ...
    if (this->flags & GFXP_FLAG_SHADOW) {
        ...
        gSPTextureRectangle(this->dList++, X_MULTIPLY(HIRES_MULTIPLY(this->posX + 4 + WS_SHIFT_HALF)), HIRES_MULTIPLY(this->posY + 4), X_MULTIPLY(HIRES_MULTIPLY(this->posX + 4 + 32 + WS_SHIFT_HALF) - 2), HIRES_MULTIPLY(this->posY + 4 + 32) - 2,
                            tile, (u16)(c & 4) * 64, (u16)(c >> 3) * 256, X_DIVIDE(HIRES_DIVIDE(1 << 10)), HIRES_DIVIDE(1 << 10));

        gDPSetColor(this->dList++, G_SETPRIMCOLOR, this->color.rgba);
    }

    gSPTextureRectangle(this->dList++, X_MULTIPLY(HIRES_MULTIPLY(this->posX + WS_SHIFT_HALF)), HIRES_MULTIPLY(this->posY), X_MULTIPLY(HIRES_MULTIPLY(this->posX + 32 + WS_SHIFT_HALF) - 2), HIRES_MULTIPLY(this->posY + 32) - 2, tile,
