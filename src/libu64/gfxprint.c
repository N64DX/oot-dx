...
void GfxPrint_PrintCharImpl(GfxPrint* this, u8 c) {
    ...
    if (this->flags & GFXP_FLAG_SHADOW) {
        ...
        gSPTextureRectangle(this->dList++, HIRES_MULTIPLY(this->posX + 4 + WS_SHIFT_HALF) * SCALE_X, HIRES_MULTIPLY(this->posY + 4), (HIRES_MULTIPLY(this->posX + 4 + 32 + WS_SHIFT_HALF) - (HIRES_PX_SHIFT * 2)) * SCALE_X, HIRES_MULTIPLY(this->posY + 4 + 32) - (HIRES_PX_SHIFT * 2),
                            tile, (u16)(c & 4) * 64, (u16)(c >> 3) * 256, HIRES_DIVIDE(1 << 10) / SCALE_X, HIRES_DIVIDE(1 << 10));

        gDPSetColor(this->dList++, G_SETPRIMCOLOR, this->color.rgba);
    }

    gSPTextureRectangle(this->dList++, HIRES_MULTIPLY(this->posX + WS_SHIFT_HALF) * SCALE_X, HIRES_MULTIPLY(this->posY), (HIRES_MULTIPLY(this->posX + 32 + WS_SHIFT_HALF) - (HIRES_PX_SHIFT * 2)) * SCALE_X, HIRES_MULTIPLY(this->posY + 32) - (HIRES_PX_SHIFT * 2), tile,
                        (u16)(c & 4) * 64, (u16)(c >> 3) * 256, HIRES_DIVIDE(1 << 10) / SCALE_X, HIRES_DIVIDE(1 << 10));
