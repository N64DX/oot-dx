...
void Magic_DrawMeter(PlayState* play) {
    ...
    if (gSaveContext.save.info.playerData.magicLevel != 0) {
        ...
        OVERLAY_DISP = Gfx_DrawTexRectIA8_DropShadow(OVERLAY_DISP, gMagicMeterEndTex, 8, 16, R_MAGIC_METER_X, magicMeterY, 8, 16, 1 << 10, 1 << 10, sMagicBorderR, sMagicBorderG, sMagicBorderB, interfaceCtx->magicAlpha);
        OVERLAY_DISP = Gfx_DrawTexRectIA8_DropShadow(OVERLAY_DISP, gMagicMeterMidTex, 24, 16, (R_MAGIC_METER_X + 8), magicMeterY, ((void)0, gSaveContext.magicCapacity), 16, 1 << 10, 1 << 10, sMagicBorderR, sMagicBorderG, sMagicBorderB, interfaceCtx->magicAlpha);
        OVERLAY_DISP = Gfx_DrawTexRectIA8_DropShadowOffset(OVERLAY_DISP, gMagicMeterEndTex, 8, 16, (R_MAGIC_METER_X + 8 + gSaveContext.magicCapacity), magicMeterY, 8, 16, 1 << 10, 1 << 10, sMagicBorderR, sMagicBorderG, sMagicBorderB, interfaceCtx->magicAlpha, 3, 0x100);
...
void Interface_DrawItemButtons(PlayState* play) {
    ...
    OVERLAY_DISP = Gfx_DrawTexRectIA8_DropShadow(OVERLAY_DISP, hudTexture, 32, 32, R_ITEM_BTN_X(0), R_ITEM_BTN_Y(0), R_ITEM_BTN_WIDTH(0), R_ITEM_BTN_WIDTH(0), R_ITEM_BTN_DD(0) << 1, R_ITEM_BTN_DD(0) << 1, R_B_BTN_COLOR(0), R_B_BTN_COLOR(1), R_B_BTN_COLOR(2), interfaceCtx->bAlpha);
    gDPPipeSync(OVERLAY_DISP++);

    OVERLAY_DISP = Gfx_DrawRect_DropShadow(OVERLAY_DISP, R_ITEM_BTN_X(1), R_ITEM_BTN_Y(1), R_ITEM_BTN_WIDTH(1), R_ITEM_BTN_WIDTH(1), R_ITEM_BTN_DD(1) << 1, R_ITEM_BTN_DD(1) << 1, R_C_BTN_COLOR(0), R_C_BTN_COLOR(1), R_C_BTN_COLOR(2), interfaceCtx->cLeftAlpha);
    OVERLAY_DISP = Gfx_DrawRect_DropShadow(OVERLAY_DISP, R_ITEM_BTN_X(2), R_ITEM_BTN_Y(2), R_ITEM_BTN_WIDTH(2), R_ITEM_BTN_WIDTH(2), R_ITEM_BTN_DD(2) << 1, R_ITEM_BTN_DD(2) << 1, R_C_BTN_COLOR(0), R_C_BTN_COLOR(1), R_C_BTN_COLOR(2), interfaceCtx->cDownAlpha);
    OVERLAY_DISP = Gfx_DrawRect_DropShadow(OVERLAY_DISP, R_ITEM_BTN_X(3), R_ITEM_BTN_Y(3), R_ITEM_BTN_WIDTH(3), R_ITEM_BTN_WIDTH(3), R_ITEM_BTN_DD(3) << 1, R_ITEM_BTN_DD(3) << 1, R_C_BTN_COLOR(0), R_C_BTN_COLOR(1), R_C_BTN_COLOR(2), interfaceCtx->cRightAlpha);
...
#if (OOT_VERSION < PAL_1_0) && !OOT_NTSC_N64
            gSPTextureRectangle(OVERLAY_DISP++, HIRES_MULTIPLY((R_START_BTN_X + startButtonLeftMMShift + WS_SHIFT_FULL) << 2), HIRES_MULTIPLY(R_START_BTN_Y << 2), HIRES_MULTIPLY((R_START_BTN_X + startButtonLeftMMShift + WS_SHIFT_FULL + 22) << 2),
                                HIRES_MULTIPLY((R_START_BTN_Y + 22) << 2), G_TX_RENDERTILE, 0, 0, (s32)(1.4277344 * HIRES_DIVIDE(1 << 10)),
                                (s32)(1.4277344 * HIRES_DIVIDE(1 << 10)));
#elif OOT_NTSC && !OOT_NTSC_N64
            gSPTextureRectangle(OVERLAY_DISP++, HIRES_MULTIPLY((132 + startButtonLeftMMShift + WS_SHIFT_FULL) << 2), HIRES_MULTIPLY(17 << 2), HIRES_MULTIPLY((132 + startButtonLeftMMShift + WS_SHIFT_FULL + 22) << 2), HIRES_MULTIPLY((17 + 22) << 2), G_TX_RENDERTILE, 0,
                                0, (s32)(1.4277344 * HIRES_DIVIDE(1 << 10)), (s32)(1.4277344 * HIRES_DIVIDE(1 << 10)));
#else
            gSPTextureRectangle(OVERLAY_DISP++, HIRES_MULTIPLY((startButtonLeftPos[gSaveContext.language] + startButtonLeftMMShift + WS_SHIFT_FULL) << 2), HIRES_MULTIPLY(17 << 2),
                                HIRES_MULTIPLY((startButtonLeftPos[gSaveContext.language] + startButtonLeftMMShift + WS_SHIFT_FULL + 22) << 2), HIRES_MULTIPLY((17 + 22) << 2), G_TX_RENDERTILE,
...
void Interface_Draw(PlayState* play) {
    ...
    if (pauseCtx->debugState == PAUSE_DEBUG_STATE_CLOSED) {
        ...
        OVERLAY_DISP = Gfx_TextureIA8(OVERLAY_DISP, USE_MM_HUD ? gMMRupeeCounterIconTex : gRupeeCounterIconTex, 16, 16, HIRES_MULTIPLY(26), HIRES_MULTIPLY(206), HIRES_MULTIPLY(16), HIRES_MULTIPLY(16), HIRES_DIVIDE(1 << 10), HIRES_DIVIDE(1 << 10));
        ...
        switch (play->sceneId) {
            ...
            case SCENE_TREASURE_BOX_SHOP:
                if (gSaveContext.save.info.inventory.dungeonKeys[gSaveContext.mapIndex] >= 0) {
                    ...
                    OVERLAY_DISP = Gfx_TextureIA8(OVERLAY_DISP, USE_MM_HUD ? gMMSmallKeyCounterIconTex : gSmallKeyCounterIconTex, 16, 16, HIRES_MULTIPLY(26), HIRES_MULTIPLY(190), HIRES_MULTIPLY(16), HIRES_MULTIPLY(16),
                    ...
                    if (interfaceCtx->counterDigits[2] != 0) {
                        if (USE_MM_HUD) {
                            ...
                            OVERLAY_DISP = Gfx_TextureI8(OVERLAY_DISP, ((u8*)gCounterDigit0Tex + (8 * 16 * interfaceCtx->counterDigits[2])), 8, 16, HIRES_MULTIPLY(svar3 + 1), HIRES_MULTIPLY(191), HIRES_MULTIPLY(8), HIRES_MULTIPLY(16), HIRES_DIVIDE(1 << 10), HIRES_DIVIDE(1 << 10));
                            gDPPipeSync(OVERLAY_DISP++);
                            gDPSetPrimColor(OVERLAY_DISP++, 0, 0, 255, 255, 255, interfaceCtx->magicAlpha);
                            gSPTextureRectangle(OVERLAY_DISP++, HIRES_MULTIPLY(svar3 << 2), HIRES_MULTIPLY(190 << 2), HIRES_MULTIPLY((svar3 + 8) << 2), HIRES_MULTIPLY(206 << 2), G_TX_RENDERTILE, 0, 0, HIRES_DIVIDE(1 << 10), HIRES_DIVIDE(1 << 10));
                        } else {
                            gDPSetPrimColor(OVERLAY_DISP++, 0, 0, 255, 255, 255, interfaceCtx->magicAlpha);
                            OVERLAY_DISP = Gfx_TextureI8(OVERLAY_DISP, ((u8*)gCounterDigit0Tex + (8 * 16 * interfaceCtx->counterDigits[2])), 8, 16, HIRES_MULTIPLY(svar3), HIRES_MULTIPLY(190), HIRES_MULTIPLY(8), HIRES_MULTIPLY(16), HIRES_DIVIDE(1 << 10), HIRES_DIVIDE(1 << 10));
                        }
                        svar3 += 8;
                    }
                    ...
                    if (USE_MM_HUD) {
                        gDPPipeSync(OVERLAY_DISP++);
                        gDPSetPrimColor(OVERLAY_DISP++, 0, 0, 0, 0, 0, interfaceCtx->magicAlpha);
                        OVERLAY_DISP = Gfx_TextureI8(OVERLAY_DISP, ((u8*)gCounterDigit0Tex + (8 * 16 * interfaceCtx->counterDigits[3])), 8, 16, HIRES_MULTIPLY(svar3 + 1), HIRES_MULTIPLY(191), HIRES_MULTIPLY(8), HIRES_MULTIPLY(16), HIRES_DIVIDE(1 << 10), HIRES_DIVIDE(1 << 10));
                        gDPPipeSync(OVERLAY_DISP++);
                        gDPSetPrimColor(OVERLAY_DISP++, 0, 0, 255, 255, 255, interfaceCtx->magicAlpha);
                        gSPTextureRectangle(OVERLAY_DISP++, HIRES_MULTIPLY(svar3 << 2), HIRES_MULTIPLY(190 << 2), HIRES_MULTIPLY((svar3 + 8) << 2), HIRES_MULTIPLY(206 << 2), G_TX_RENDERTILE, 0, 0, HIRES_DIVIDE(1 << 10), HIRES_DIVIDE(1 << 10));
                    }
                        ...
                        gDPSetPrimColor(OVERLAY_DISP++, 0, 0, 255, 255, 255, interfaceCtx->magicAlpha);
                        OVERLAY_DISP = Gfx_TextureI8(OVERLAY_DISP, ((u8*)gCounterDigit0Tex + (8 * 16 * interfaceCtx->counterDigits[3])), 8, 16, HIRES_MULTIPLY(svar3), HIRES_MULTIPLY(190), HIRES_MULTIPLY(8), HIRES_MULTIPLY(16), HIRES_DIVIDE(1 << 10), HIRES_DIVIDE(1 << 10));
                    }
                }
                break;
            default:
        ...
        for (svar1 = 0, svar3 = 42; svar1 < svar4; svar1++, svar2++, svar3 += 8) {
            if (USE_MM_HUD) {
                gDPPipeSync(OVERLAY_DISP++);
                gDPSetPrimColor(OVERLAY_DISP++, 0, 0, 0, 0, 0, interfaceCtx->magicAlpha);
                OVERLAY_DISP = Gfx_TextureI8(OVERLAY_DISP, ((u8*)gCounterDigit0Tex + (8 * 16 * interfaceCtx->counterDigits[svar2])), 8, 16, HIRES_MULTIPLY(svar3 + 1), HIRES_MULTIPLY(207), HIRES_MULTIPLY(8), HIRES_MULTIPLY(16), HIRES_DIVIDE(1 << 10), HIRES_DIVIDE(1 << 10));
                gDPPipeSync(OVERLAY_DISP++);
                ...
                gSPTextureRectangle(OVERLAY_DISP++, HIRES_MULTIPLY(svar3 * 4), HIRES_MULTIPLY(206 << 2), HIRES_MULTIPLY((svar3 + 8) * 4), HIRES_MULTIPLY(222 << 2), G_TX_RENDERTILE, 0, 0, HIRES_DIVIDE(1 << 10), HIRES_DIVIDE(1 << 10));
            } else {
                if (gSaveContext.save.info.playerData.rupees == CUR_CAPACITY(UPG_WALLET)) {
                    gDPSetPrimColor(OVERLAY_DISP++, 0, 0, 120, 255, 0, interfaceCtx->magicAlpha);
                } else if (gSaveContext.save.info.playerData.rupees != 0) {
                ...
                OVERLAY_DISP = Gfx_TextureI8(OVERLAY_DISP, ((u8*)gCounterDigit0Tex + (8 * 16 * interfaceCtx->counterDigits[svar2])), 8, 16, HIRES_MULTIPLY(svar3), HIRES_MULTIPLY(206), HIRES_MULTIPLY(8), HIRES_MULTIPLY(16), HIRES_DIVIDE(1 << 10), HIRES_DIVIDE(1 << 10));
            }
        }
