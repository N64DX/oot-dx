...
#define OVERWORLD_MINIMAPS SCENE_GROTTOS2 - SCENE_HYRULE_FIELD + 4
...
static u16 sOwMinimapTexSize[OVERWORLD_MINIMAPS] = {
    ...
    3400, 1792, 1888, 2040, 3120, 2304, 2176, 1888, 2432, 1080, 920,  2400, 2960, 2160, 1880, 2400, 1560, 3240, 2600, 3400,
};
...
static u32 sOwMinimapTexOffset[OVERWORLD_MINIMAPS] = {
    ...
    0x7068, 0x7DB0, 0x84B0, 0x8C10, 0x9408, 0xA038, 0xA938, 0xB1B8, 0xE348, 0xECC8, 0xF100, 0xF498, 0xFDF8, 0x10988, 0x111F8, 0x11950, 0xB918, 0xBF30, 0xCBD8, 0xD600,
};

static u8 sOwMinimapPosX[OVERWORLD_MINIMAPS] = {
    216, 216, 218, 202, 202, 250, 216, 234, 234, 216, 234, 234,
    216, 234, 234, 250, 216, 234, 234, 234, 230, 218, 218, 224, 218, 218, 218, 218, 218, 80, 80, 216,
};

static u8 sOwMinimapPosY[OVERWORLD_MINIMAPS] = {
    150, 158, 184, 164, 160, 138, 140, 150, 156, 158, 168, 162,
    138, 168, 162, 138, 146, 150, 154, 162, 150, 200, 204, 174, 154, 170, 174, 164, 218, 81, 65, 216,
};

static s16 sOwCompassInfo[OVERWORLD_MINIMAPS][4] = {
...
static u8 sOwMinimapWidth[OVERWORLD_MINIMAPS] = {
    80, 80, 80, 96, 96, 48, 80, 64, 64, 80, 64, 64, 80, 64, 64, 48, 80, 64, 64, 64, 64, 80, 80, 80, 80, 80, 80, 80, 80, 80, 80, 80,
};

static u8 sOwMinimapHeight[OVERWORLD_MINIMAPS] = {
    73, 64, 39, 58, 62, 85, 81, 73, 65, 65, 56, 59, 85, 56, 59, 85, 78, 72, 68, 59, 76, 27, 23, 60, 74, 54, 47, 60, 39, 81, 65, 85,
};

static s16 sOwEntranceIconPosX[OVERWORLD_MINIMAPS] = {
    1, 269, 1, 1, 273, 279, 259, 1, 260, 1, 1, 235, 1, 1, 1, 267, 261, 1, 1, 260, 1, 1, 1, 1, 1, 1, 1, 271, 294, 259, 1, 243,
};

static s16 sOwEntranceIconPosY[OVERWORLD_MINIMAPS] = {
    -10, -833, -10, -10, -850, -889, -829, -10, -844, -10, -10, -836, -10, -10, -10, -852, -873, -10, -10, -848, -10, -10, -10, -10, -10, -10, -10, -816, -825, -829, -10, -833,
};

static u16 sOwEntranceFlag[OVERWORLD_MINIMAPS - 4] = {
    0xFFFF,
    INFTABLE_1A8_SHIFT,
    INFTABLE_1A7_SHIFT,
    0xFFFF,
