...
#define OVERWORLD_EXTENDED_MINIMAPS OVERWORLD_MINIMAPS + 6
...
static u16 sOwMinimapTexSize[OVERWORLD_MINIMAPS] = {
    ...
    3400, 1792, 1888, 2040, 3120, 2304, 2176, 1888, 2432, 1080, 920,  2400, 2960, 2160, 1880, 2400, 2976, 1792, 3320, 1848,
};
...
static u32 sOwMinimapTexOffset[OVERWORLD_MINIMAPS] = {
    ...
    0x7068, 0x7DB0, 0x84B0, 0x8C10, 0x9408, 0xA038, 0xA938, 0xB1B8, 0xE348, 0xECC8, 0xF100, 0xF498, 0xFDF8, 0x10988, 0x111F8, 0x11950, 0x122B0, 0x12E50, 0x13550, 0x14248,
};

static u8 sOwMinimapPosX[OVERWORLD_EXTENDED_MINIMAPS] = {
    216, 216, 218, 202, 202, 250, 216, 234, 234, 216, 234, 234,
    216, 234, 234, 250, 216, 234, 234, 234, 230, 218, 218, 224, 218, 218, 218, 218, 208, 234, 216, 250,
    218, 80, 80, 216, 255, 248,
};

static u8 sOwMinimapPosY[OVERWORLD_EXTENDED_MINIMAPS] = {
    150, 158, 184, 164, 160, 138, 140, 150, 156, 158, 168, 162,
    138, 168, 162, 138, 146, 150, 154, 162, 150, 200, 204, 174, 154, 170, 174, 164, 162, 168, 140, 150,
    218, 81, 65, 216, 190, 206,
};
...
static s16 sOwCompassInfo[OVERWORLD_EXTENDED_MINIMAPS][4] = {
    ...
    { 6, 6, 780, -300 },    { 12, 12, 900, -1020 }, { 6, 6, 1750, -700 },   { 8, 8, 900, -770 }, { 5, 5, 980, -710 }, { 6, 6, 1020, -760 }, { 6, 6, 980, -850 }, { 3, 3, 985, -800 }, { 4, 4, 1275, -725 }, { 5, 5, 1350, -800 }, { 9, 9, 950, -450 }, { 7, 7, 1100, -900 },
    { 6, 6, 890, -800 },    { 13, 13, 1080, -260 }, { 11, 11, 1060, -680 }, { 9, 9, 850, -830 }, { 3, 5, 1410, -1475 }, { 3, 3, 1600, -950 },
};
...
static u8 sOwMinimapWidth[OVERWORLD_EXTENDED_MINIMAPS] = {
    80, 80, 80, 96, 96, 48, 80, 64, 64, 80, 64, 64, 80, 64, 64, 48, 80, 64, 64, 64, 64, 80, 80, 80, 80, 80, 80, 80, 96, 64, 80, 48,
    80, 80, 80, 80, 16, 48,
};

static u8 sOwMinimapHeight[OVERWORLD_EXTENDED_MINIMAPS] = {
    73, 64, 39, 58, 62, 85, 81, 73, 65, 65, 56, 59, 85, 56, 59, 85, 78, 72, 68, 59, 76, 27, 23, 60, 74, 54, 47, 60, 62, 56, 83, 77,
    39, 81, 65, 85, 38, 19,
};

static s16 sOwEntranceIconPosX[OVERWORLD_EXTENDED_MINIMAPS] = {
    1, 269, 1, 1, 273, 279, 259, 1, 260, 1, 1, 235, 1, 1, 1, 267, 261, 1, 1, 260, 1, 1, 1, 1, 1, 1, 1, 271, 1, 1, 1, 1,
    294, 259, 1, 243, 1, 1,
};

static s16 sOwEntranceIconPosY[OVERWORLD_EXTENDED_MINIMAPS] = {
    -10, -833, -10, -10, -850, -889, -829, -10, -844, -10, -10, -836, -10, -10, -10, -852, -873, -10, -10, -848, -10, -10, -10, -10, -10, -10, -10, -816, -10, -10, -10, -10,
    -825, -829, -10, -833, -10, -10,
};
...
static s8 sOverworldXOffset[OVERWORLD_EXTENDED_MINIMAPS] = {
    11, 3, 3, 3, 3, 20, 17, 13, 3, 15, 6, 1, 5, 6, 15, 10, 12, 3, 14, 14, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
    3, 17, 15, 5, 3, 3
};
