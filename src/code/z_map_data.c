...
static u16 sOwMinimapTexSize[27] = {
    2920, 2560, 1560, 2784, 2976, 2040, 3240, 2336, 2080, 2600, 1792, 1888,
    3400, 1792, 1888, 2040, 3120, 2304, 2176, 1888, 2432, 1080, 920,  1560, 3240, 2600, 3400,
};

static u16 sOwMinimapTexOffset[27] = {
    0x0000, 0x0B68, 0x1568, 0x1B80, 0x2660, 0x3200, 0x39F8, 0x46A0, 0x4FC0, 0x57E0, 0x6208, 0x6908,
    0x7068, 0x7DB0, 0x84B0, 0x8C10, 0x9408, 0xA038, 0xA938, 0xB1B8, 0xE348, 0xECC8, 0xF100, 0xB918, 0xBF30, 0xCBD8, 0xD600,
};

static u8 sOwMinimapPosX[27] = {
    216, 216, 218, 202, 202, 250, 216, 234, 234, 216, 234, 234,
    216, 234, 234, 250, 216, 234, 234, 234, 230, 218, 218, 218, 80, 80, 216,
};

static u8 sOwMinimapPosY[27] = {
    150, 158, 184, 164, 160, 138, 140, 150, 156, 158, 168, 162,
    138, 168, 162, 138, 146, 150, 154, 162, 150, 200, 204, 218, 81, 65, 216,
};

static s16 sOwCompassInfo[27][4] = {
    ...
    { 6, 6, 780, -300 },    { 12, 12, 900, -1020 }, { 6, 6, 1750, -700 },
...
static u8 sOwMinimapWidth[27] = {
    80, 80, 80, 96, 96, 48, 80, 64, 64, 80, 64, 64, 80, 64, 64, 48, 80, 64, 64, 64, 64, 80, 80, 80, 80, 80, 80,
};

static u8 sOwMinimapHeight[27] = {
    73, 64, 39, 58, 62, 85, 81, 73, 65, 65, 56, 59, 85, 56, 59, 85, 78, 72, 68, 59, 76, 27, 23, 39, 81, 65, 85,
};

static s16 sOwEntranceIconPosX[27] = {
    1, 269, 1, 1, 273, 279, 259, 1, 260, 1, 1, 235, 1, 1, 1, 267, 261, 1, 1, 260, 1, 1, 1, 294, 259, 1, 243,
};

static s16 sOwEntranceIconPosY[27] = {
    -10, -833, -10, -10, -850, -889, -829, -10, -844, -10, -10, -836, -10, -10, -10, -852, -873, -10, -10, -848, -10, -10, -10, -825, -829, -10, -833,
};

static u16 sOwEntranceFlag[23] = {
    0xFFFF,
    INFTABLE_1A8_SHIFT,
    INFTABLE_1A7_SHIFT,
    0xFFFF,
