...
void Interface_Init(PlayState* play) {
    ...
    if (IS_CHILD_QUEST) {
        ...
        if (INV_CONTENT(ITEM_ARROW_FIRE)  > ITEM_BOOTS_HOVER && INV_CONTENT(ITEM_ARROW_FIRE)  < ITEM_SONG_MINUET)
            INV_CONTENT(ITEM_ARROW_FIRE)  = ITEM_ARROW_FIRE;
        if (INV_CONTENT(ITEM_ARROW_ICE)   > ITEM_BOOTS_HOVER && INV_CONTENT(ITEM_ARROW_ICE)   < ITEM_SONG_MINUET)
            INV_CONTENT(ITEM_ARROW_ICE)   = ITEM_ARROW_ICE;
        if (INV_CONTENT(ITEM_ARROW_LIGHT) > ITEM_BOOTS_HOVER && INV_CONTENT(ITEM_ARROW_LIGHT) < ITEM_SONG_MINUET)
