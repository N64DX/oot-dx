...
s32 Horse_CanSpawn(s32 sceneId) {
    s32 validSceneIds[] = { SCENE_HYRULE_FIELD, SCENE_LAKE_HYLIA, SCENE_GERUDO_VALLEY, SCENE_GERUDOS_FORTRESS,
                            SCENE_LON_LON_RANCH, SCENE_PATH_TO_FORTRESS, SCENE_PATH_TO_LAKE_HYLIA, SCENE_SPRING_LAKE, SCENE_PATH_TO_GORON_VILLAGE, SCENE_GORON_VILLAGE, SCENE_FORBIDDEN_WOODS };
    s32 i;
...
void Horse_SetupInGameplay(PlayState* play, Player* player) {
    ...
    HorseSpawn horseSpawns[] = {
        ...
        { SCENE_PATH_TO_LAKE_HYLIA, -3800, 1, 1400, 0, HORSE_PTYPE_INACTIVE },
      //{ SCENE_PATH_TO_WOODFALL, 326, -138, 432, 0, HORSE_PTYPE_INACTIVE },
        { SCENE_PATH_TO_FORTRESS, -2428, 40, -128, 0, HORSE_PTYPE_INACTIVE },
        { SCENE_SPRING_LAKE, -350, 0, 900, 0, HORSE_PTYPE_INACTIVE },
        { SCENE_PATH_TO_GORON_VILLAGE, -1200, 200, 750, 0, HORSE_PTYPE_INACTIVE },
        { SCENE_GORON_VILLAGE, -500, -200, 300, 0, HORSE_PTYPE_INACTIVE },
        { SCENE_FORBIDDEN_WOODS, 1000, 426, -2580, 0, HORSE_PTYPE_INACTIVE },
    };
