...
Vtx object_yabusame_pointMirroredVtx_000D80[] = {
#include "assets/objects/object_yabusame_point/object_yabusame_pointMirroredVtx_000D80.vtx.inc"
};
...
Gfx object_yabusame_point_DL_000DC0[] = {
    ...
    gsDPLoadTextureBlock(0x08000000, G_IM_FMT_IA, G_IM_SIZ_8b, 48, 24, 0, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR | G_TX_CLAMP, 6, 5, G_TX_NOLOD, G_TX_NOLOD),
...
Gfx object_yabusame_point_mirrored_DL_000DC0[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    ...
    gsSPSetGeometryMode(G_CULL_BACK),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(object_yabusame_pointMirroredVtx_000D80, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};
