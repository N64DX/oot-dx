...
DEFINE_MESSAGE(0x08A0, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
QUICKTEXT_ENABLE COLOR(ADJUSTABLE) "Warp to a location?" COLOR(DEFAULT) QUICKTEXT_DISABLE "\n"
THREE_CHOICE
    COLOR(ADJUSTABLE) "Sacred Forest Meadow\n"
    "Ancient Grove\n"
...
DEFINE_MESSAGE(0x08A1, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
QUICKTEXT_ENABLE COLOR(RED) "Warp to a location?" COLOR(DEFAULT) QUICKTEXT_DISABLE "\n"
THREE_CHOICE
    COLOR(ADJUSTABLE) "Death Mountain Crater\n"
    "Goron Village\n"
    "Cancel" COLOR(DEFAULT)
),
MSG(),
...
DEFINE_MESSAGE(0x08A2, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
QUICKTEXT_ENABLE COLOR(BLUE) "Warp to a location?" COLOR(DEFAULT) QUICKTEXT_DISABLE "\n"
THREE_CHOICE
    COLOR(ADJUSTABLE) "Lake Hylia\n"
    "Spring Lake\n"
    "Cancel" COLOR(DEFAULT)
),
MSG(),
...
DEFINE_MESSAGE(0x08A3, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
QUICKTEXT_ENABLE COLOR(YELLOW) "Warp to a location?" COLOR(DEFAULT) QUICKTEXT_DISABLE "\n"
THREE_CHOICE
    COLOR(ADJUSTABLE) "Desert Colossus\n"
    "Path to Gerudo's Fortress\n"
    "Cancel" COLOR(DEFAULT)
),
MSG(),
MSG()
...
DEFINE_MESSAGE(0x08A4, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
QUICKTEXT_ENABLE COLOR(PURPLE) "Warp to a location?" COLOR(DEFAULT) QUICKTEXT_DISABLE "\n"
THREE_CHOICE
    COLOR(ADJUSTABLE) "Graveyard\n"
    "Forsaken Kingdom\n"
    "Cancel" COLOR(DEFAULT)
),
MSG(),
...
DEFINE_MESSAGE(0x08A5, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
QUICKTEXT_ENABLE COLOR(LIGHTBLUE) "Warp to a location?" COLOR(DEFAULT) QUICKTEXT_DISABLE "\n"
THREE_CHOICE
    COLOR(ADJUSTABLE) "Temple of Time\n"
    "Stone Tower\n"
    "Cancel" COLOR(DEFAULT)
),
MSG(),
...
DEFINE_MESSAGE(0x08A6, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
QUICKTEXT_ENABLE "Play the song of the " COLOR(ADJUSTABLE) "Forest" COLOR(DEFAULT) "\n"
"to warp back here." QUICKTEXT_DISABLE FADE(60)
),
MSG(),
MSG()
)

DEFINE_MESSAGE(0x08A7, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
QUICKTEXT_ENABLE "Play the song of " COLOR(RED) "Fire" COLOR(DEFAULT) "\n"
"to warp back here." QUICKTEXT_DISABLE FADE(60)
),
MSG(),
MSG()
...
DEFINE_MESSAGE(0x08A8, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
QUICKTEXT_ENABLE "Play the song of " COLOR(BLUE) "Water" COLOR(DEFAULT) "\n"
"to warp back here." QUICKTEXT_DISABLE FADE(60)
),
MSG(),
MSG()
...
DEFINE_MESSAGE(0x08A9, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
QUICKTEXT_ENABLE "Play the song of " COLOR(YELLOW) "Spirits" COLOR(DEFAULT) "\n"
"to warp back here." QUICKTEXT_DISABLE FADE(60)
),
MSG(),
MSG()
...
DEFINE_MESSAGE(0x08AA, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
QUICKTEXT_ENABLE "Play the song of " COLOR(PURPLE) "Shadows" COLOR(DEFAULT) "\n"
"to warp back here." QUICKTEXT_DISABLE FADE(60)
),
MSG(),
MSG()
...
DEFINE_MESSAGE(0x08AB, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
QUICKTEXT_ENABLE "Play the song of " COLOR(LIGHTBLUE) "Light" COLOR(DEFAULT) "\n"
"to warp back here." QUICKTEXT_DISABLE FADE(60)
),
MSG(),
MSG()
