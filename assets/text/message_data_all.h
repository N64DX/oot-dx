...
"worrrrrrrrrrk...\n"
UNSKIPPABLE "I really want to repairrrrr it, but..."
BOX_BREAK
...
"a " COLOR(BLUE) "Water Temple" COLOR(BLUE) " " COLOR(DEFAULT) "used to worship \n"
...
UNSKIPPABLE QUICKTEXT_ENABLE SHIFT(12) "\"" COLOR(PURPLE) "Help me." COLOR(PURPLE) "\n"
COLOR(DEFAULT) SHIFT(12) COLOR(PURPLE) "I'm waiting for you inside\n"
COLOR(DEFAULT) SHIFT(12) COLOR(YELLOW) "Lord Jabu-Jabu's" COLOR(PURPLE) " " COLOR(PURPLE) "belly." COLOR(PURPLE) "\n"
...
"source of the river.\n"
COLOR(RED) "Lord Jabu-Jabu" COLOR(RED) " " COLOR(DEFAULT) "lives in the \n"
...
,
MSG(
UNSKIPPABLE "We haven't found " COLOR(RED) "Princess Ruto" COLOR(RED) "\n"
...
"last long" COLOR(RED) " " COLOR(DEFAULT) "at this temperature."
BOX_BREAK
...
"down " COLOR(BLUE) "[A]" COLOR(DEFAULT) " and " COLOR(LIGHTBLUE) "[R]" COLOR(LIGHTBLUE) " " COLOR(DEFAULT) "to reel it in \n"
"faster."
BOX_BREAK
...
UNSKIPPABLE "On top of that, my hair..."
BOX_BREAK
...
UNSKIPPABLE "Here are your " COLOR(RED) "10 Rupees" COLOR(DEFAULT) ".\n"
"Take them."
BOX_BREAK
...
"On top of that, I'll put " COLOR(RED) "100\n"
