...
UNSKIPPABLE TEXT_SPEED(2) "Sagst Du ihn mir?" TEXT_SPEED(0)
BOX_BREAK
...
UNSKIPPABLE "Oh, ich muß Dir etwas über " COLOR(RED) "Basil\n"
COLOR(DEFAULT) "erzählen..."
BOX_BREAK
...
UNSKIPPABLE "Nun ist er wieder " COLOR(RED) "so wie früher" COLOR(DEFAULT) ".\n"
"Daher kehrte auch mein Vater auf" COLOR(RED) "\n"
COLOR(DEFAULT) "die Farm zurück!"
BOX_BREAK
...
COLOR(RED) "Monsieur Ingo" COLOR(DEFAULT) "..."
BOX_BREAK
...
"il redevint un " COLOR(RED) "homme gentil" COLOR(DEFAULT) "!"
BOX_BREAK
...
,
MSG(
"Wie geht es " COLOR(RED) "Epona" COLOR(DEFAULT) "?"
BOX_BREAK

"Spielst Du " COLOR(RED) "Eponas Lied " COLOR(DEFAULT) "auf Deiner\n"
...
,
MSG(
"Comment se porte " COLOR(RED) "Epona" COLOR(DEFAULT) "?"
BOX_BREAK

"Si tu joues le " COLOR(RED) "Chant d'Epona" COLOR(DEFAULT) " avec \n"
...
"Epona an dem " COLOR(RED) "Hindernisparcours" COLOR(DEFAULT) "?"
BOX_BREAK

"Du mußt " COLOR(RED) "zwei Runden" COLOR(DEFAULT) " reiten und \n"
...
"petite " COLOR(RED) "course d'obstacle" COLOR(DEFAULT) "?"
BOX_BREAK
...
MSG(
NAME ", kannst Du mich\n"
"hören? Ich bin es, Zelda..." FADE(60)
)
,
MSG(
UNSKIPPABLE SHIFT(9) NAME "... M'entends-tu?\n"
SHIFT(48) "C'est moi...Zelda..." FADE(60)
)
)
...
,
MSG(
SFX(NA_SE_EV_COW_CRY) "Muuuuuuuuuuuuuuuuuuuuuuuuuuuuh!"
BOX_BREAK
...
,
MSG(
SFX(NA_SE_EV_COW_CRY) "Meuuuuuuu!"
BOX_BREAK
...
"Je me sens si repooooosée!" EVENT
)
)
...
"Okarina übergeben...\n"
"Und diese " COLOR(LIGHTBLUE) "Melodie" COLOR(DEFAULT) "..." FADE(60)
)
,
MSG(
...
"ocarina ainsi que " COLOR(LIGHTBLUE) "cette melodie" COLOR(DEFAULT) "..." FADE(60)
)
)
...
"danach! \n"
"Wie wäre es, wenn..." TEXTID(0x200B)
)
,
MSG(
...
UNSKIPPABLE "Ach, Du bist es! Hallo!"
BOX_BREAK
...
UNSKIPPABLE "Hé, c'est toi? Bien le bonjour!"
BOX_BREAK
...
"königlicher Erlaubnis" COLOR(DEFAULT) " möglich!"
BOX_BREAK
...
UNSKIPPABLE "Hmmm... Na gut..."
BOX_BREAK

"\"" COLOR(PURPLE) "Dies ist " NAME ".\n"
" Er hat den Auftrag, Hyrule\n"
" vor dem Untergang zu bewahren." COLOR(DEFAULT) "\"\n"
SHIFT(90) "Prinzessin Zelda"
BOX_BREAK
...
TEXT_SPEED(1) "Hahaha!" TEXT_SPEED(0) EVENT
)
,
MSG(
...
UNSKIPPABLE SHIFT(6) "\"" COLOR(PURPLE) "Ce preux chevalier se nomme\n"
COLOR(DEFAULT) SHIFT(6) COLOR(PURPLE) NAME "...\n"
COLOR(DEFAULT) SHIFT(6) COLOR(PURPLE) "Sa noble quête est de sauver \n"
COLOR(DEFAULT) SHIFT(6) COLOR(PURPLE) "Hyrule." COLOR(DEFAULT) "\""
BOX_BREAK
...
TEXT_SPEED(1) "Hahaha!" TEXT_SPEED(0) "!"
)
,
MSG(
"Oh, le Preux Chevalier!\n"
"Merci de sauver Hyrule!\n"
TEXT_SPEED(1) "Wah ha ha hah" TEXT_SPEED(0) "!!"
)
)
...
,
MSG(
UNSKIPPABLE "Ach, Herr Nachwuchsheld..."
BOX_BREAK
...
UNSKIPPABLE SHIFT(76) "Seufz..." EVENT
)
,
MSG(
UNSKIPPABLE "Au fait, Preux Chevalier..."
BOX_BREAK
...
UNSKIPPABLE "Es-tu déjà allé à la " COLOR(RED) "Foire aux \n"
...
UNSKIPPABLE "Mon boulot est vraiment nul."
BOX_BREAK

UNSKIPPABLE SHIFT(75) "...pfff..." EVENT
)
)
...
"à la " COLOR(RED) "Foire aux Masques " COLOR(DEFAULT) "..."
BOX_BREAK
...
,
MSG(
UNSKIPPABLE QUICKTEXT_ENABLE SHIFT(30) "Verdammt!" QUICKTEXT_DISABLE " Sie ist fort!"
)
,
MSG(
UNSKIPPABLE QUICKTEXT_ENABLE SHIFT(16) "Tssss...!" QUICKTEXT_DISABLE " Elle s'est échappée!"
)
)
...
,
MSG(
UNSKIPPABLE SHIFT(74) "Du da! \n"
SHIFT(57) QUICKTEXT_ENABLE "Kleiner Wicht!" QUICKTEXT_DISABLE
)
,
MSG(
UNSKIPPABLE SHIFT(65) "Toi, là-bas!\n"
SHIFT(65) QUICKTEXT_ENABLE "Moucheron!" QUICKTEXT_DISABLE
)
)
...
,
MSG(
UNSKIPPABLE SHIFT(65) TEXT_SPEED(10) QUICKTEXT_ENABLE "Ha" QUICKTEXT_DISABLE " " QUICKTEXT_ENABLE "Ha" QUICKTEXT_DISABLE " " QUICKTEXT_ENABLE "Ha" QUICKTEXT_DISABLE "..." TEXT_SPEED(0) "\n"
SHIFT(58) "Du hast Mut!\n"
SHIFT(23) "Doch Mut kann manchmal...\n"
SHIFT(57) "...tödlich sein!"
)
,
MSG(
UNSKIPPABLE SHIFT(67) TEXT_SPEED(10) QUICKTEXT_ENABLE "Ha" QUICKTEXT_DISABLE " " QUICKTEXT_ENABLE "ha" QUICKTEXT_DISABLE " " QUICKTEXT_ENABLE "ha" QUICKTEXT_DISABLE "..." TEXT_SPEED(0) "\n"
SHIFT(26) "Tu cherches le contact?!\n"
SHIFT(60) "Bonne blague!\n"
SHIFT(28) "Tu es brave, mais sot!"
)
)
...
,
MSG(
UNSKIPPABLE QUICKTEXT_ENABLE SHIFT(54) "Armseliger Tropf!" QUICKTEXT_DISABLE "\n"
SHIFT(50) "Weißt Du, wem Du \n"
SHIFT(51) "gegenüberstehst?!"
)
,
MSG(
UNSKIPPABLE QUICKTEXT_ENABLE SHIFT(52) "Insecte ridicule!" QUICKTEXT_DISABLE "\n"
SHIFT(25) "Sais-tu bien qui je suis?!"
)
)
...
,
MSG(
UNSKIPPABLE SHIFT(45) "Ich bin " COLOR(RED) "Ganondorf" COLOR(DEFAULT) "!\n"
QUICKTEXT_ENABLE SHIFT(30) "Der König der Gerudos!" QUICKTEXT_DISABLE
)
,
MSG(
UNSKIPPABLE SHIFT(45) "Je suis " COLOR(RED) "Ganondorf" COLOR(DEFAULT) "!\n"
QUICKTEXT_ENABLE SHIFT(4) "Et sous peu, le monde sera mien!" QUICKTEXT_DISABLE
)
)
...
,
MSG(
UNSKIPPABLE SHIFT(34) "Du mußt das weiße Pferd\n"
SHIFT(32) "gesehen haben! In welche\n"
SHIFT(16) "Richtung sind sie entkommen?!\n"
SHIFT(57) QUICKTEXT_ENABLE "Antworte mir!" QUICKTEXT_DISABLE
)
,
MSG(
UNSKIPPABLE SHIFT(3) "Un destrier blanc vient de passer\n"
SHIFT(46) "il y a un instant...\n"
SHIFT(38) "Par où s'est-il enfui?\n"
SHIFT(70) QUICKTEXT_ENABLE "Réponds!!" QUICKTEXT_DISABLE
)
)
...
,
MSG(
UNSKIPPABLE SFX(NA_SE_SY_TRE_BOX_APPEAR) "Du hast die Maske, für die Du\n"
...
,
MSG(
UNSKIPPABLE SFX(NA_SE_SY_TRE_BOX_APPEAR) "Vous vendez le masque pour\n"
...
,
MSG(
QUICKTEXT_ENABLE "Gyaah!" QUICKTEXT_DISABLE " C'est Igor le fossoyeur!"
BOX_BREAK
...
,
MSG(
UNSKIPPABLE SFX(NA_SE_SY_TRE_BOX_APPEAR) "Du hast die Maske, die Dich\n"
...
,
MSG(
UNSKIPPABLE SFX(NA_SE_SY_TRE_BOX_APPEAR) "Vous vendez le masque à l'enfant\n"
...
"prophezeit hat... Hoppeldihö..." TEXTID(0x202B)
)
,
MSG(
...
"lapinou tout mimi et tout poilu?" TEXTID(0x202B)
)
)
...
,
MSG(
UNSKIPPABLE SFX(NA_SE_SY_TRE_BOX_APPEAR) "Für die Maske hast Du 50\n"
...
,
MSG(
UNSKIPPABLE SFX(NA_SE_SY_TRE_BOX_APPEAR) "Ce masque à 50 rubis a été\n"
...
,
MSG(
UNSKIPPABLE SHIFT(17) "Glaubst Du im Ernst, daß Du\n"
SHIFT(15) "sie vor mir schützen kannst?\n"
SHIFT(71) "Du Narr!"
)
,
MSG(
UNSKIPPABLE SHIFT(16) "Tu crois que ton silence les \n"
SHIFT(18) "protègera? Jeune impudent..."
)
)
...
UNSKIPPABLE QUICKTEXT_ENABLE SHIFT(45) "Das ist lächerlich!" QUICKTEXT_DISABLE
BOX_BREAK
...
"eines meiner Pferde zu reiten?" TEXTID(0x2031)
)
,
MSG(
...
UNSKIPPABLE QUICKTEXT_ENABLE SHIFT(30) "C'est du n'importe quoi!" QUICKTEXT_DISABLE
BOX_BREAK
...
UNSKIPPABLE "Le " COLOR(RED) "grand Ganondorf " COLOR(DEFAULT) "a reconnu mes\n"
...
"monter l'un de mes chevaux?" TEXTID(0x2031)
)
)
...
"Mit " COLOR(BLUE) "[A]" COLOR(DEFAULT) " steigst Du auf."
BOX_BREAK

"Nutze den " COLOR(LIGHTBLUE) "[Control-Pad]" COLOR(DEFAULT) ", um mit Epona zu \n"
...
"et appuie sur " COLOR(BLUE) "[A]" COLOR(DEFAULT) " pour le monter."
BOX_BREAK

"Utilise le " COLOR(LIGHTBLUE) "[Control-Pad] " COLOR(DEFAULT) "pour le faire galoper.\n"
...
"\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "Nein, ich will reiten!\n"
...
"\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "Non, je veux encore monter\n"
...
"Paie-moi " COLOR(RED) "50 Rubis " COLOR(DEFAULT) "et c'est parti!\n"
"Tu es d'accord?\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "Oui\n"
    "Non" COLOR(DEFAULT)
...
,
MSG(
UNSKIPPABLE SHIFT(57) "Ver" QUICKTEXT_ENABLE "maledeit!" QUICKTEXT_DISABLE
BOX_BREAK
...
,
MSG(
UNSKIPPABLE SHIFT(60) "Nooooooooon!"
BOX_BREAK
...
"Ist das wirklich " COLOR(RED) "Epona" COLOR(DEFAULT) "?"
BOX_BREAK
...
"Est-ce " COLOR(RED) "Epona" COLOR(DEFAULT) "?"
BOX_BREAK
...
,
MSG(
UNSKIPPABLE SHIFT(26) "Nun gut, so sei es denn!"
BOX_BREAK
...
UNSKIPPABLE SHIFT(60) "Cependant..."
BOX_BREAK
...
UNSKIPPABLE "Ich bin " COLOR(RED) "Basil" COLOR(DEFAULT) ". Diese Farm liegt \n"
"mir sehr am Herzen."
BOX_BREAK
...
UNSKIPPABLE "Mon nom est " COLOR(RED) "Ingo " COLOR(DEFAULT) "et je m'occupe\n"
"du ranch."
BOX_BREAK
...
"tient le Ranch Lon Lon." TEXTID(0x2042)
)
)
...
COLOR(RED) "Vater" COLOR(DEFAULT) " für mich suchen?"
BOX_BREAK

UNSKIPPABLE SFX(NA_SE_VO_Z0_SMILE_0) "Sicher ist er eingeschlafen \n"
...
"forêt? Peux-tu trouver mon " COLOR(RED) "père" COLOR(DEFAULT) "?"
BOX_BREAK

UNSKIPPABLE SFX(NA_SE_VO_Z0_SMILE_0) "Il a dû s'endormir quelque part\n"
"autour du Château. \n"
...
"gesamte Arbeit erledigen!" TEXTID(0x2046)
)
,
MSG(
...
"corvées! J'en ai ras la moustache!" TEXTID(0x2046)
)
)
...
,
MSG(
UNSKIPPABLE "Ah, der Junge aus dem Wald!"
BOX_BREAK
...
UNSKIPPABLE SFX(NA_SE_VO_Z0_SMILE_0) "Daddy hatte es ganz schön eilig,\n"
...
UNSKIPPABLE SFX(NA_SE_VO_Z0_SMILE_0) "Papa est revenu à la maison\n"
...
,
MSG(
TEXT_SPEED(2) "S C H N A R C H..." TEXT_SPEED(0)
)
,
MSG(
TEXT_SPEED(2) "Z Z Z Z Z Z Z Z Z Z Z Z Z Z Z" TEXT_SPEED(0) "..."
...
,
MSG(
TEXT_SPEED(2) "Zzzzzzzz..." TEXT_SPEED(0) "\n"
"Ruhe... ich... muß...\n"
"Kühe... Hühner..."
)
,
...
MSG(
UNSKIPPABLE "Du...\n"
"Du kennst das Lied " COLOR(RED) "meiner Mutter" COLOR(DEFAULT) "?"
BOX_BREAK
...
"vergangene Zeiten..." TEXTID(0x2052)
)
,
MSG(
UNSKIPPABLE "Tu...\n"
"Tu connais la " COLOR(RED) "chanson de ma mère" COLOR(DEFAULT) "?"
BOX_BREAK
...
"Setze " COLOR(RED) "50 Rubine " COLOR(DEFAULT) "und versuch's \n"
"nochmal!\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "Ja!\n"
    "Nein!" COLOR(DEFAULT)
...
"Aboule " COLOR(RED) "50 Rubis " COLOR(DEFAULT) "et c'est parti!\n"
"\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "OK\n"
    "Pas question" COLOR(DEFAULT)
...
COLOR(RED) "Cocorico" COLOR(DEFAULT) "."
BOX_BREAK
...
UNSKIPPABLE "Es scheint, daß nun die Zeit \n"
...
"tapfer und verliere nie den Mut!" TEXTID(0x2065)
)
,
MSG(
...
UNSKIPPABLE "Prépare-toi car ta noble quête \n"
"débute enfin!"
BOX_BREAK
...
COLOR(RED) "Prinzessin" COLOR(DEFAULT) " zu treffen..."
BOX_BREAK

"Weichst Du ab von Deinen Pfaden, \n"
"und wandelst auf unbekannten \n"
"Wegen, so nutze Deine" COLOR(RED) " Karte" COLOR(DEFAULT) "."
BOX_BREAK
...
"Drücke " COLOR(RED) "START" COLOR(DEFAULT) ", um ins Menü zu \n"
...
"Auf dem " COLOR(RED) "Karten-Bildschirm" COLOR(DEFAULT) " findest\n"
"Du außerdem einen " COLOR(RED) "Hinweis" COLOR(DEFAULT) ", welchen\n"
"Ort Du als nächsten aufsuchen \n"
"solltest." TEXTID(0x2066)
)
,
MSG(
"Va tout droit pour aller au\n"
COLOR(RED) "Château d'Hyrule" COLOR(DEFAULT) "."
BOX_BREAK

"Une " COLOR(RED) "Princesse " COLOR(DEFAULT) "t'y attend..."
BOX_BREAK

"Si par malheur tu perds ton \n"
"chemin, n'hésite pas à consulter\n"
"la " COLOR(RED) "Carte" COLOR(DEFAULT) "."
BOX_BREAK
...
"Sur l'" COLOR(RED) "écran de la carte" COLOR(DEFAULT) " apparaîtra\n"
"un " COLOR(RED) "point clignotant" COLOR(DEFAULT) " t'indiquant la \n"
"position de ta prochaine épreuve." TEXTID(0x2066)
)
)
...
,
MSG(
UNSKIPPABLE NAME "! Hier entlang!"
BOX_BREAK_DELAYED(40)

UNSKIPPABLE "Die Prinzessin befindet sich \n"
...
,
MSG(
UNSKIPPABLE "Hé, " NAME "! Par ici!"
BOX_BREAK_DELAYED(40)

UNSKIPPABLE "La Princesse est dans le Château.\n"
...
"Par là tu trouveras le" COLOR(RED) " village de \n"
...
UNSKIPPABLE "Du befindest Dich vor den Toren \n"
...
UNSKIPPABLE "Par là tu trouveras le " COLOR(RED) "village de \n"
...
"Wasser des " COLOR(RED) "Hylia-Sees" COLOR(DEFAULT) " erkunden."
BOX_BREAK
...
"Au sud s'étend le " COLOR(RED) "Lac Hylia" COLOR(DEFAULT) "."
BOX_BREAK

"A l'ouest tu trouveras la " COLOR(RED) "Vallée\n"
...
"Die " COLOR(BLUE) "Zoras" COLOR(DEFAULT) ", die im Osten des Landes\n"
...
"oder " COLOR(LIGHTBLUE) "[R]" COLOR(DEFAULT) " zum " COLOR(BLUE) "Karten-Bildschirm" COLOR(DEFAULT) "."
BOX_BREAK
...
"Les " COLOR(BLUE) "Zoras" COLOR(DEFAULT) ", un peuple vivant en \n"
...
COLOR(LIGHTBLUE) "[Z] " COLOR(DEFAULT) "ou " COLOR(LIGHTBLUE) "[R]" COLOR(DEFAULT) " pour trouver la carte."
BOX_BREAK
...
,
MSG(
UNSKIPPABLE TEXT_SPEED(1) "Ich fühle etwas..." TEXT_SPEED(0)
BOX_BREAK
...
,
MSG(
UNSKIPPABLE "Ecoute-moi bien, " NAME "..."
BOX_BREAK
...
,
MSG(
SHIFT(35) "Die Okarina der Zeit!" EVENT
)
,
MSG(
SHIFT(40) "L'Ocarina du Temps!" EVENT
)
)
...
,
MSG(
UNSKIPPABLE "Je regardais par cette fenêtre..."
BOX_BREAK

UNSKIPPABLE "Les " COLOR(BLUE) "nuages noirs " COLOR(DEFAULT) "de mon rêve...\n"
...
,
MSG(
UNSKIPPABLE TEXT_SPEED(1) "Ich weiß..." TEXT_SPEED(0) " Er ist es!"
BOX_BREAK
...
,
MSG(
UNSKIPPABLE TEXT_SPEED(1) "........" TEXT_SPEED(0) "Bien sûr!"
BOX_BREAK

UNSKIPPABLE "J'ai parlé de mon rêve à Père..."
BOX_BREAK

UNSKIPPABLE "Mais il n'a rien voulu savoir..."
BOX_BREAK
...
UNSKIPPABLE "Nur das scheint sein Begehr!"
BOX_BREAK
...
UNSKIPPABLE "Ich werde die " COLOR(LIGHTBLUE) "Okarina der Zeit\n"
...
"deux autres " COLOR(RED) "Pierres Ancestrales" COLOR(DEFAULT) "!"
BOX_BREAK
...
COLOR(RED) "Super-Hühner" COLOR(DEFAULT) "!"
BOX_BREAK
...
"mit " COLOR(RED) "etwas Nützlichem " COLOR(DEFAULT) "belohnen!"
BOX_BREAK
...
"sont des " COLOR(RED) "Super Cocottes" COLOR(DEFAULT) "!"
BOX_BREAK
...
COLOR(RED) "un truc cool" COLOR(DEFAULT) "."
BOX_BREAK
...
"Ich vermische diese drei " COLOR(RED) "Super-\n"
...
"ich Dich mit " COLOR(RED) "etwas Nützlichem" COLOR(DEFAULT) "!"
BOX_BREAK
...
"Kommt zu Daddy, ihr Süßen!" EVENT
)
,
MSG(
"Hop là! C'est fini!\n"
...
"\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "Oh oui! Oh oui!\n"
...
"Dann laß uns " COLOR(RED) "Super-Huhn-Suchen \n"
COLOR(DEFAULT) "spielen!" COLOR(RED) " " COLOR(DEFAULT) "Oder willst Du nur \n"
"frische " COLOR(RED) "Lon Lon-Milch" COLOR(DEFAULT) "?"
BOX_BREAK

"Was darf es sein?\n"
THREE_CHOICE
    COLOR(ADJUSTABLE) "Lon Lon-Milch - 30 Rubine\n"
...
COLOR(RED) "lait de Lon Lon" COLOR(DEFAULT) "?"
BOX_BREAK

"Dis-moi tout!\n"
THREE_CHOICE
    COLOR(ADJUSTABLE) "Lait de Lon Lon - 30 Rubis\n"
...
,
MSG(
QUICKTEXT_ENABLE COLOR(RED) "Eine Runde noch!" COLOR(DEFAULT) QUICKTEXT_DISABLE FADE(20)
)
,
MSG(
QUICKTEXT_ENABLE COLOR(RED) "Encore un tour!" COLOR(DEFAULT) QUICKTEXT_DISABLE FADE(20)
)
)
...
COLOR(RED) RACE_TIME COLOR(DEFAULT) " ist neuer Parcours-Rekord!"
BOX_BREAK
...
COLOR(RED) RACE_TIME COLOR(DEFAULT) " est le nouveau record!"
BOX_BREAK
...
"Deine Bestzeit ist " COLOR(RED) HIGHSCORE(HS_HORSE_RACE) COLOR(DEFAULT) "."
BOX_BREAK
