...
COLOR(LIGHTBLUE) "If you cut it, it will burst open and\n"
"knock you back!" COLOR(DEFAULT) QUICKTEXT_DISABLE
),
MSG(
...
COLOR(LIGHTBLUE) "Schlage seine magischen Feuerbälle\n"
...
COLOR(LIGHTBLUE) "Réponds à son attaque magique \n"
...
MSG(),
MSG(
QUICKTEXT_ENABLE "Scissors Beetle\n"
COLOR(LIGHTBLUE) "These monsters have sharp mandibles.\n"
"Hit them when they shoot these away.\n"
"Avoid their attacks to get in close." COLOR(DEFAULT) QUICKTEXT_DISABLE
),
MSG(),
MSG()
)
...
MSG(),
MSG(
QUICKTEXT_ENABLE "Giant Spider\n"
COLOR(LIGHTBLUE) "A dangerous spider that traps you\n"
"in place!" COLOR(DEFAULT) QUICKTEXT_DISABLE
),
MSG(),
MSG()
)
...
MSG(),
MSG(
QUICKTEXT_ENABLE "Giant Bee\n"
COLOR(LIGHTBLUE) "They are not dangerous when alone,\n"
"but can overwhelm you when they\n"
"come in swarms." COLOR(DEFAULT) QUICKTEXT_DISABLE
),
MSG(),
MSG()
)

DEFINE_MESSAGE(0x0667, TEXTBOX_TYPE_BLUE, TEXTBOX_POS_VARIABLE,
MSG(),
MSG(
...
DEFINE_MESSAGE(0x0668, TEXTBOX_TYPE_BLUE, TEXTBOX_POS_VARIABLE,
MSG(),
MSG(
...
DEFINE_MESSAGE(0x0669, TEXTBOX_TYPE_BLUE, TEXTBOX_POS_VARIABLE,
MSG(),
MSG(
QUICKTEXT_ENABLE "Bad Bat\n"
COLOR(LIGHTBLUE) "If you don't do something before it\n"
"swoops down it will quickly\n"
"overwhelm you with swarms!" COLOR(DEFAULT) QUICKTEXT_DISABLE
),
MSG(),
MSG()
)
...
MSG(),
MSG(
QUICKTEXT_ENABLE "Garo\n"
COLOR(LIGHTBLUE) "Just concentrate on blocking and\n"
"dodging those sharp swords!" COLOR(DEFAULT) QUICKTEXT_DISABLE
),
MSG(),
MSG()
)

DEFINE_MESSAGE(0x066B, TEXTBOX_TYPE_BLUE, TEXTBOX_POS_VARIABLE,
MSG(
...
DEFINE_MESSAGE(0x066C, TEXTBOX_TYPE_BLUE, TEXTBOX_POS_VARIABLE,
MSG(),
MSG(
QUICKTEXT_ENABLE "Black Beast\n"
COLOR(LIGHTBLUE) "Watch out, it is extremely strong!\n"
"It will be a battle of endurance.\n"
"It seems weak to ice though..." COLOR(DEFAULT) QUICKTEXT_DISABLE
),
MSG(),
MSG()
)

DEFINE_MESSAGE(0x066D, TEXTBOX_TYPE_BLUE, TEXTBOX_POS_VARIABLE,
MSG(
