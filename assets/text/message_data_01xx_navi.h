...
"Dich genau davor und drücke " COLOR(BLUE) "[A]" COLOR(LIGHTBLUE) "." COLOR(DEFAULT)
BOX_BREAK

UNSKIPPABLE COLOR(LIGHTBLUE) "Achte auf das\n"
...
"ouvre-la avec " COLOR(BLUE) "[A]" COLOR(LIGHTBLUE) "." COLOR(DEFAULT)
BOX_BREAK

UNSKIPPABLE COLOR(LIGHTBLUE) "Observe bien l'" COLOR(BLUE) "icône d'action" COLOR(LIGHTBLUE) ".\n"
...
COLOR(DEFAULT) UNSKIPPABLE COLOR(LIGHTBLUE) "Drücke " COLOR(DEFAULT) "[Z] " COLOR(LIGHTBLUE) "und stelle Dich gleich" COLOR(DEFAULT) " \n"
COLOR(LIGHTBLUE) "in die richtige Richtung.\n"
"So schaust Du sofort den Gang\n"
"hinab, wenn Du um die Ecke gehst."
BOX_BREAK

COLOR(DEFAULT) UNSKIPPABLE COLOR(LIGHTBLUE) "Hast Du Dich richtig hingestellt,\n"
...
COLOR(DEFAULT) UNSKIPPABLE COLOR(LIGHTBLUE) "Utilise la " COLOR(DEFAULT) "Visée [Z] " COLOR(LIGHTBLUE) "pour toujours\n"
"regarder dans la bonne direction.\n"
"Axe-toi pour voir le fond d'un \n"
"couloir avant de bifurquer."
BOX_BREAK

COLOR(DEFAULT) UNSKIPPABLE COLOR(LIGHTBLUE) "Une fois bien placé, maintiens " COLOR(DEFAULT) "[Z]\n"
...
COLOR(DEFAULT) UNSKIPPABLE COLOR(LIGHTBLUE) "Auch zum Hinaufklettern mußt" COLOR(DEFAULT) "\n"
...
COLOR(DEFAULT) "Blocks" COLOR(LIGHTBLUE) " und dann" COLOR(DEFAULT) " " COLOR(BLUE) "[A]" COLOR(LIGHTBLUE) "."
BOX_BREAK

COLOR(DEFAULT) UNSKIPPABLE COLOR(LIGHTBLUE) "Achte auf das\n"
...
COLOR(BLUE) "[A]" COLOR(LIGHTBLUE) ", tu peux le pousser ou le tirer."
BOX_BREAK

COLOR(DEFAULT) UNSKIPPABLE COLOR(LIGHTBLUE) "Tu peux grimper sur un " COLOR(DEFAULT) "bloc de\n"
"pierre " COLOR(LIGHTBLUE) "en maintenant " COLOR(DEFAULT) "[Control-Pad] " COLOR(LIGHTBLUE) "vers le \n"
COLOR(DEFAULT) "bloc" COLOR(LIGHTBLUE) " et en appuyant sur " COLOR(BLUE) "[A]" COLOR(LIGHTBLUE) "."
BOX_BREAK

COLOR(DEFAULT) UNSKIPPABLE COLOR(LIGHTBLUE) "Observe bien l'" COLOR(BLUE) "icône d'action" COLOR(LIGHTBLUE) "!" COLOR(DEFAULT)
)
)
...
"You need a pretty sharp sword to\n"
...
COLOR(DEFAULT) "Donnerblumen " COLOR(LIGHTBLUE) "an!" COLOR(DEFAULT)
BOX_BREAK

UNSKIPPABLE COLOR(LIGHTBLUE) "Meinst Du, Du kannst sie\n"
"alle auf einmal zünden?" COLOR(DEFAULT)
),
MSG(
UNSKIPPABLE COLOR(LIGHTBLUE) "Woah! Mate-moi tous ces \n"
COLOR(DEFAULT) "Choux-Péteurs" COLOR(LIGHTBLUE) "!" COLOR(DEFAULT)
BOX_BREAK

UNSKIPPABLE COLOR(LIGHTBLUE) "Crois-tu pouvoir tous les faire\n"
...
COLOR(LIGHTBLUE) UNSKIPPABLE "Drücke " COLOR(DEFAULT) "[Z]" COLOR(LIGHTBLUE) ", um immer in die\n"
...
COLOR(DEFAULT) UNSKIPPABLE COLOR(LIGHTBLUE) "Utilise la " COLOR(DEFAULT) "Visée [Z] " COLOR(LIGHTBLUE) "pour bien axer\n"
...
COLOR(DEFAULT) UNSKIPPABLE COLOR(LIGHTBLUE) "Sie flüstern mir zu: " COLOR(DEFAULT) "\"Suche\n"
...
COLOR(DEFAULT) UNSKIPPABLE "\"Cherche l'oeil de vérité...\""
)
)
...
COLOR(LIGHTBLUE) "Sie flüstern mir zu:"
BOX_BREAK

COLOR(DEFAULT) UNSKIPPABLE "\"Jener, dessen\n"
...
MSG(
UNSKIPPABLE COLOR(LIGHTBLUE) "J'entends les esprits murmurer \n"
"dans cette pièce:" COLOR(DEFAULT)
BOX_BREAK

UNSKIPPABLE "\"Le héros aux " COLOR(RED) "pieds ailés " COLOR(DEFAULT) "se \n"
...
MSG(
UNSKIPPABLE SHIFT(73) COLOR(LIGHTBLUE) "WAAAAS!?"
BOX_BREAK

COLOR(DEFAULT) UNSKIPPABLE COLOR(LIGHTBLUE) "Schau Dir all die " COLOR(DEFAULT) "Flaggen" COLOR(LIGHTBLUE) " an!\n"
"Finde heraus, welche davon\n"
"echt ist!" COLOR(DEFAULT)
),
MSG(
UNSKIPPABLE SHIFT(43) COLOR(LIGHTBLUE) "Qu... Comm... Hein?"
BOX_BREAK

COLOR(DEFAULT) UNSKIPPABLE COLOR(LIGHTBLUE) "Regarde cette flopée de " COLOR(DEFAULT) "drapeaux" COLOR(LIGHTBLUE) "!\n"
...
COLOR(BLUE) "Heiligen Stein des Wassers" COLOR(DEFAULT) ", oder?"
BOX_BREAK
...
"celle de l'" COLOR(BLUE) "eau" COLOR(DEFAULT) ", n'est-ce pas?"
BOX_BREAK
...
"Sammelst Du die Heiligen Steine?\n"
"Du mußt noch einen finden? Den\n"
COLOR(RED) "Heiligen Stein des Feuers" COLOR(DEFAULT) ", oder?"
BOX_BREAK
...
"celle du " COLOR(RED) "feu" COLOR(DEFAULT) ", n'est-ce pas?"
BOX_BREAK
...
"\"" COLOR(LIGHTBLUE) "Augen, deren Blick die Dunkelheit\n"
...
"\"" COLOR(LIGHTBLUE) "L'oeil qui voit dans les ténèbres\n"
...
"\"" COLOR(LIGHTBLUE) "Geh, junger Held. Besuche die\n"
...
"\"" COLOR(LIGHTBLUE) "Va jusqu'à la Déesse du Désert,\n"
...
"Ich bin im " COLOR(ADJUSTABLE) "Waldtempel" COLOR(DEFAULT) "!\n"
...
"Je suis dans le " COLOR(ADJUSTABLE) "Temple de la Forêt" COLOR(DEFAULT) "!\n"
...
COLOR(ADJUSTABLE) "Weisen des Waldes" COLOR(DEFAULT) " werden..."
BOX_BREAK
...
COLOR(ADJUSTABLE) "Sage de la Forêt" COLOR(DEFAULT) "..."
BOX_BREAK
...
"Kraft des " COLOR(RED) "Siebten Weisen" COLOR(DEFAULT) "."
BOX_BREAK
...
"du " COLOR(RED) "Septième Sage" COLOR(DEFAULT) "."
BOX_BREAK
...
"irgendwo..." COLOR(DEFAULT)
BOX_BREAK

UNSKIPPABLE COLOR(LIGHTBLUE) "Sie flüstert mir zu:\n"
"\n"
COLOR(DEFAULT) SHIFT(17) "\"Sammle fünf silberne Steine...\""
),
MSG(
UNSKIPPABLE COLOR(LIGHTBLUE) "J'entends une voix..." COLOR(DEFAULT)
BOX_BREAK

UNSKIPPABLE COLOR(LIGHTBLUE) "Elle me dit:\n"
"\n"
COLOR(DEFAULT) SHIFT(13) "\"Amasse cinq Rubis d'argent...\""
)
)
...
"etwas mit!" COLOR(DEFAULT)
BOX_BREAK

UNSKIPPABLE COLOR(LIGHTBLUE) "Sie flüstert mir zu:\n"
COLOR(DEFAULT) SHIFT(26) "Willst Du mit einer Fähre\n"
SHIFT(30) "in fremde Gefilde reisen,\n"
SHIFT(53) "so tritt näher..."
),
MSG(
UNSKIPPABLE COLOR(LIGHTBLUE) "Ce mur... Il me parle!" COLOR(DEFAULT)
BOX_BREAK

UNSKIPPABLE COLOR(LIGHTBLUE) "Il dit:\n"
COLOR(DEFAULT) "\n"
SHIFT(10) "Si tu veux un aller simple pour\n"
SHIFT(21) "l'enfer, approche pour voir!"
)
)
