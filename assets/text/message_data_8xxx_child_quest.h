...
DEFINE_MESSAGE(0x800F, TEXTBOX_TYPE_BLUE, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
...
DEFINE_MESSAGE(0x8015, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
...
MSG(
UNSKIPPABLE SHIFT(54) "あの時の約束…\n"
SHIFT(33) "守ってやりたかったね…" FADE(90)
),
MSG(
...
MSG(
UNSKIPPABLE "Dir gebührt eine ganz spezielle\n"
"Anerkennung..." FADE(90)
),
MSG(
UNSKIPPABLE "J'aurais dû tenir ma promesse..." FADE(90)
)
)
...
MSG(
SHIFT(36) "パワーグローブ" COLOR(LIGHTBLUE) "があれば\n"
...
MSG(
COLOR(LIGHTBLUE) "Verwende die " COLOR(DEFAULT) "Kraftarmband" COLOR(LIGHTBLUE) ",\n"
...
MSG(
SHIFT(18) "もし、無事に　" COLOR(BLUE) "パワーグローブ" COLOR(DEFAULT) "を\n"
SHIFT(54) "手に入れたら…"
BOX_BREAK
...
MSG(
"Wenn Du die " COLOR(BLUE) "Kraftarmband\n"
