...
MSG(
UNSKIPPABLE ITEM_ICON(ITEM_SWORD_HEROS) QUICKTEXT_ENABLE "A powerful foe left behind the\n"
...
MSG(),
MSG(
UNSKIPPABLE ITEM_ICON(ITEM_SWORD_RAZOR) QUICKTEXT_ENABLE "You got the edge-cutting\n"
COLOR(RED) "Razor Sword" COLOR(DEFAULT) "!" QUICKTEXT_DISABLE "\n"
"It's so sharp it can cut through\n"
"most defenses."
),
MSG(),
MSG()
...
MSG(),
MSG(
ITEM_ICON(ITEM_CANE_OF_BYRNA) QUICKTEXT_ENABLE "You got the " COLOR(RED) "Cane of Byrna" COLOR(DEFAULT) "!" QUICKTEXT_DISABLE "\n"
"Press " COLOR(YELLOW) "[C]" COLOR(DEFAULT) " to summon a statue at\n"
"will. Use them to hold down\n"
"floor switches!"
),
MSG(),
MSG()
...
MSG(),
MSG(
ITEM_ICON(ITEM_CANE_OF_SOMARIA) QUICKTEXT_ENABLE "You got the " COLOR(RED) "Cane of Somaria" COLOR(DEFAULT) "!" QUICKTEXT_DISABLE "\n"
"Press " COLOR(YELLOW) "[C]" COLOR(DEFAULT) " to summon statues at\n"
"will. Use them to hold down\n"
"floor switches!"
),
MSG(),
...
DEFINE_MESSAGE(0x9102, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(
QUICKTEXT_ENABLE "木の盾（たて）　４０ルピー" QUICKTEXT_DISABLE "\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "かう\n"
    "やめとく" COLOR(DEFAULT)
),
MSG(
QUICKTEXT_ENABLE "Wooden Shield   40 Rupees" QUICKTEXT_DISABLE "\n"
"\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "Buy\n"
    "Don't buy" COLOR(DEFAULT)
...
MSG(
QUICKTEXT_ENABLE "Holzschild   40 Rubine" QUICKTEXT_DISABLE "\n"
"\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "Kaufen!\n"
    "Nicht kaufen!" COLOR(DEFAULT)
...
MSG(
QUICKTEXT_ENABLE "Bouclier de Bois   40 Rubis" QUICKTEXT_DISABLE "\n"
"\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "Acheter\n"
    "Ne pas acheter" COLOR(DEFAULT)
...
MSG(
QUICKTEXT_ENABLE "メタルシールド（たて）　８０ルピー" QUICKTEXT_DISABLE "\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "かう\n"
    "やめとく" COLOR(DEFAULT)
),
MSG(
QUICKTEXT_ENABLE "Metal Shield   80 Rupees" QUICKTEXT_DISABLE "\n"
"\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "Buy\n"
    "Don't buy" COLOR(DEFAULT)
...
MSG(
QUICKTEXT_ENABLE "Metallschild   80 Rubine" QUICKTEXT_DISABLE "\n"
"\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "Kaufen!\n"
    "Nicht kaufen!" COLOR(DEFAULT)
...
MSG(
QUICKTEXT_ENABLE "Bouclier de Métal   80 Rubis" QUICKTEXT_DISABLE "\n"
"\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "Acheter\n"
    "Ne pas acheter" COLOR(DEFAULT)
...
MSG(
QUICKTEXT_ENABLE "精霊の服　　３００ルピー" QUICKTEXT_DISABLE "\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "かう\n"
    "やめとく" COLOR(DEFAULT)
),
MSG(
QUICKTEXT_ENABLE "Spirit Tunic   300 Rupees" QUICKTEXT_DISABLE "\n"
"\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "Buy\n"
    "Don't buy" COLOR(DEFAULT)
...
MSG(
QUICKTEXT_ENABLE "Geister-Rüstung   300 Rubine" QUICKTEXT_DISABLE "\n"
"\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "Kaufen!\n"
    "Nicht kaufen!" COLOR(DEFAULT)
...
MSG(
QUICKTEXT_ENABLE "Tunique de l'Espirit   300 Rubis" QUICKTEXT_DISABLE "\n"
"\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "Acheter\n"
    "Ne pas acheter" COLOR(DEFAULT)
...
MSG(
QUICKTEXT_ENABLE "シールドのクスリ　８０ルピー" QUICKTEXT_DISABLE "\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "かう\n"
    "やめとく" COLOR(DEFAULT)
),
MSG(
QUICKTEXT_ENABLE "Shield Potion   80 Rupees" QUICKTEXT_DISABLE "\n"
"\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "Buy\n"
    "Don't buy" COLOR(DEFAULT)
...
MSG(
QUICKTEXT_ENABLE "Schild-Elixier   80 Rubine" QUICKTEXT_DISABLE "\n"
"\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "Kaufen!\n"
    "Nicht kaufen!" COLOR(DEFAULT)
...
MSG(
QUICKTEXT_ENABLE "Potion Bouclier   80 Rubis" QUICKTEXT_DISABLE "\n"
"\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "Acheter\n"
    "Ne pas acheter" COLOR(DEFAULT)
...
DEFINE_MESSAGE(0x9109, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
...
DEFINE_MESSAGE(0x910A, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
...
DEFINE_MESSAGE(0x910B, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
...
DEFINE_MESSAGE(0x910C, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
...
DEFINE_MESSAGE(0x910D, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
...
DEFINE_MESSAGE(0x910E, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
...
DEFINE_MESSAGE(0x910F, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
...
DEFINE_MESSAGE(0x9110, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
QUICKTEXT_ENABLE "Wooden Shield Repair   30 Rupees" QUICKTEXT_DISABLE "\n"
"\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "Repair\n"
    "Don't repair" COLOR(DEFAULT)
...
DEFINE_MESSAGE(0x9111, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
QUICKTEXT_ENABLE "Metal Shield Repair   60 Rupees" QUICKTEXT_DISABLE "\n"
"\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "Repair\n"
    "Don't repair" COLOR(DEFAULT)
...
DEFINE_MESSAGE(0x9112, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
...
DEFINE_MESSAGE(0x9113, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
...
DEFINE_MESSAGE(0x9114, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
...
DEFINE_MESSAGE(0x9115, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
...
"avec " COLOR(LIGHTBLUE) "[R]" COLOR(DEFAULT) ". Ce bouclier en métal ne\n"
"brûlera plus!" QUICKTEXT_DISABLE PERSISTENT
)
)

DEFINE_MESSAGE(0x9202, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(
QUICKTEXT_ENABLE COLOR(RED) "木の盾（たて）　　４０ルピー\n"
COLOR(DEFAULT) "「そうび」すると　" COLOR(LIGHTBLUE) "[R]" COLOR(DEFAULT) "で防御できる。\n"
"火がつくと　燃えてしまう。" QUICKTEXT_DISABLE PERSISTENT
),
MSG(
QUICKTEXT_ENABLE COLOR(RED) "Wooden Shield   40 Rupees\n"
COLOR(DEFAULT) "Once equipped, you can defend \n"
"with " COLOR(LIGHTBLUE) "[R]" COLOR(DEFAULT) ". If set on fire, it will\n"
"burn!" QUICKTEXT_DISABLE PERSISTENT
),
MSG(
QUICKTEXT_ENABLE COLOR(RED) "Holzschild   40 Rubine\n"
...
MSG(
QUICKTEXT_ENABLE COLOR(RED) "Bouclier de Bois   40 Rubis\n"
...
MSG(
QUICKTEXT_ENABLE COLOR(RED) "メタルシールド　８０ルピー\n"
COLOR(DEFAULT) "装備すると　" COLOR(LIGHTBLUE) "[R]" COLOR(DEFAULT) "　で防御できるよ。\n"
"この金属の盾は燃えなくなる！" QUICKTEXT_DISABLE PERSISTENT
),
MSG(
QUICKTEXT_ENABLE COLOR(RED) "Metal Shield   80 Rupees\n"
COLOR(DEFAULT) "Once equipped, you can defend\n"
"with " COLOR(LIGHTBLUE) "[R]" COLOR(DEFAULT) ". This metal shield won't\n"
"burn anymore!" QUICKTEXT_DISABLE PERSISTENT
),
MSG(
QUICKTEXT_ENABLE COLOR(RED) "Metallschild   80 Rubine\n"
COLOR(DEFAULT) "Einmal ausgerüstet kannst du mit " COLOR(LIGHTBLUE) "[R]" COLOR(DEFAULT) "\n"
"verteidigen. Dieser Metallschild brennt\n"
"nicht mehr!" QUICKTEXT_DISABLE PERSISTENT
),
MSG(
QUICKTEXT_ENABLE COLOR(RED) "Bouclier de Métal   80 Rubis\n"
COLOR(DEFAULT) "Une fois équipé, tu peux te défendre\n"
"avec " COLOR(LIGHTBLUE) "[R]" COLOR(DEFAULT) ". Ce bouclier en métal ne\n"
"brûlera plus!" QUICKTEXT_DISABLE PERSISTENT
)
...
MSG(),
MSG(
QUICKTEXT_ENABLE COLOR(RED) "Spirit Tunic   300 Rupees\n"
COLOR(DEFAULT) "A tunic made with mystical energy.\n"
"Adult size. Prevents you from taking\n"
"curse damage." QUICKTEXT_DISABLE PERSISTENT
),
MSG(),
MSG()
)
...
MSG(),
MSG(
QUICKTEXT_ENABLE COLOR(RED) "Shield Potion   80 Rupees\n"
COLOR(DEFAULT) "Drink to restore your shield\n"
"durability.\n"
...
MSG(),
MSG(
QUICKTEXT_ENABLE COLOR(RED) "Wooden Shield Repair   30 Rupees\n"
COLOR(DEFAULT) "Have your shield repaired\n"
"at a discount" QUICKTEXT_DISABLE PERSISTENT
),
MSG(),
...
MSG(),
MSG(
QUICKTEXT_ENABLE COLOR(RED) "Metal Shield Repair   60 Rupees\n"
COLOR(DEFAULT) "Have your shield repaired\n"
"at a discount" QUICKTEXT_DISABLE PERSISTENT
),
MSG(),
...
DEFINE_MESSAGE(0x9400, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(
...
DEFINE_MESSAGE(0x9401, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
QUICKTEXT_ENABLE "I'm sorry...I can't sell this to\n"
"you. You don't have any need for it\n"
"since your shields won't break." QUICKTEXT_DISABLE PERSISTENT
),
MSG(),
MSG()
)
...
DEFINE_MESSAGE(0x94A1, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_VARIABLE,
MSG(),
MSG(
SFX(NA_SE_EN_NUTS_FAINT) "I give up! If you let me go,\n"
"I will sell you a " COLOR(PURPLE) "Spirit Tunic" COLOR(DEFAULT) "! It's\n"
COLOR(RED) "300 Rupees" COLOR(DEFAULT) "!" TEXTID(0x10A3)
),
MSG(),
MSG()
)
...
DEFINE_MESSAGE(0x94B1, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_VARIABLE,
MSG(),
MSG(
"I'm sorry...\n"
"I can not sell you that tunic until\n"
"you found one before.\n"
"It's mystical powers are concerning..." EVENT
),
MSG(),
MSG()
)
...
DEFINE_MESSAGE(0x94B4, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
"I already told you!\n"
"That tunic isn't for sale!\n"
"Ohhh... I could go for a walk..." PERSISTENT
),
MSG(),
MSG()
)

DEFINE_MESSAGE(0x94B5, TEXTBOX_TYPE_BLACK, TEXTBOX_POS_BOTTOM,
MSG(),
MSG(
