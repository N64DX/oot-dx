...
MSG(
UNSKIPPABLE "Ich mag Dich, Kleiner!"
BOX_BREAK
...
MSG(
UNSKIPPABLE SHIFT(45) "Petit, j't'aime bien!"
BOX_BREAK
...
MSG(
SHIFT(22) "Meine Hochachtung!" FADE(30)
),
MSG(
SHIFT(37) "Viens faire un bisou!" FADE(30)
)
)
...
"schließen, Bruder!" FADE(30)
),
MSG(
SHIFT(20) "Tu veux un gros cââlinouu?" FADE(30)
)
)
...
SHIFT(63) QUICKTEXT_ENABLE "Das groovt!" QUICKTEXT_DISABLE
BOX_BREAK_DELAYED(30)

SHIFT(46) "Yeah! Yeah! " QUICKTEXT_ENABLE "Yeah!" QUICKTEXT_DISABLE
BOX_BREAK_DELAYED(40)

SHIFT(52) QUICKTEXT_ENABLE "Ein heißer Beat!" QUICKTEXT_DISABLE
BOX_BREAK_DELAYED(30)

SHIFT(75) "Groovy!"
BOX_BREAK_DELAYED(40)

SHIFT(62) "Let's dance!"
BOX_BREAK_DELAYED(40)

SHIFT(70) QUICKTEXT_ENABLE "YEEEEAH!" QUICKTEXT_DISABLE
BOX_BREAK_DELAYED(40)

SHIFT(68) QUICKTEXT_ENABLE "YAHOOO!" QUICKTEXT_DISABLE
),
MSG(
SHIFT(80) "Hé!!!"
BOX_BREAK_DELAYED(30)
...
SHIFT(38) QUICKTEXT_ENABLE "Plus fort la musique!" QUICKTEXT_DISABLE
BOX_BREAK_DELAYED(30)

SHIFT(17) "Allez donne-toi..." QUICKTEXT_ENABLE "ça balance" QUICKTEXT_DISABLE "!!"
BOX_BREAK_DELAYED(40)

SHIFT(55) QUICKTEXT_ENABLE "C'est CHAUD!!" QUICKTEXT_DISABLE
BOX_BREAK_DELAYED(30)

SHIFT(40) "Quel rythme!"
BOX_BREAK_DELAYED(40)

SHIFT(50) "WHOOOOAH!"
BOX_BREAK_DELAYED(40)

SHIFT(60) QUICKTEXT_ENABLE "YHAAAAA!" QUICKTEXT_DISABLE
BOX_BREAK_DELAYED(40)

SHIFT(60) QUICKTEXT_ENABLE "YAHBADAA!!" QUICKTEXT_DISABLE
)
)
...
"Kraft vor dem Eingang plazierte!" TEXTID(0x302A)
),
MSG(
...
UNSKIPPABLE "Regarde cet énorme rocher!"
BOX_BREAK

UNSKIPPABLE "Il bloque l'entrée de la " COLOR(RED) "Caverne" COLOR(DEFAULT) "\n"
...
"l'entrée avec ce rocher!" TEXTID(0x302A)
)
)
...
COLOR(DEFAULT) "erreichen! Und..."
BOX_BREAK

QUICKTEXT_ENABLE SHIFT(68) COLOR(RED) "...BUMMS..." COLOR(DEFAULT) QUICKTEXT_DISABLE
BOX_BREAK
...
QUICKTEXT_ENABLE SHIFT(60) COLOR(RED) "BOOOUUUM!" COLOR(DEFAULT) QUICKTEXT_DISABLE
BOX_BREAK
...
"fragen?\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "Über die Donnerblumen\n"
...
"Mit einem " COLOR(RED) "Goronen-Armband " COLOR(DEFAULT) "könnte \n"
...
COLOR(RED) "Dodongos Höhle" COLOR(DEFAULT) "."
BOX_BREAK
...
UNSKIPPABLE "Aus dem Wald?"
BOX_BREAK

UNSKIPPABLE "Was ist das, \"Wald\"?"
BOX_BREAK
...
COLOR(RED) "Donnerblumen" COLOR(DEFAULT) " gar nichts..."
BOX_BREAK
...
"hier höchst selten." TEXTID(0x3022)
),
MSG(
UNSKIPPABLE SHIFT(85) "Oh?"
BOX_BREAK
...
UNSKIPPABLE "La forêt?"
BOX_BREAK

UNSKIPPABLE "C'est quoi une \"forêt\"?"
BOX_BREAK
...
"Ici il y a bien des " COLOR(RED) "Choux-Péteurs" COLOR(DEFAULT) "..."
BOX_BREAK

UNSKIPPABLE "Mais les Bâtons Mojo c'est \n"
"super rare dans l'coin!" TEXTID(0x3022)
)
)
...
MSG(
UNSKIPPABLE SHIFT(33) "Oh... Ich bin so hungrig..."
BOX_BREAK
...
"gäbe," COLOR(RED) " Dodongos Höhle " COLOR(DEFAULT) "zu öffnen."
BOX_BREAK
...
"gewöhnen können!" TEXTID(0x3015)
),
MSG(
UNSKIPPABLE SHIFT(49) "Oh...J'ai si faim..."
BOX_BREAK
...
"que de la pierre Dodongo!" TEXTID(0x3015)
)
)
...
UNSKIPPABLE "Quoi? Tu n'es pas ici pour ça?"
BOX_BREAK
...
"er ein Lied hört, muß er tanzen..." TEXTID(0x3019)
),
MSG(
...
"des Waldes " COLOR(DEFAULT) "mochte..."
BOX_BREAK

"Das waren noch Zeiten...\n"
"Die Musik weckt in mir \n"
"Erinnerungen an vergangene Tage..." TEXTID(0x302C)
),
MSG(
"Je crois que le Chef adore\n"
"la " COLOR(ADJUSTABLE) "musique de la forêt" COLOR(DEFAULT) "..."
BOX_BREAK

"Ha! C'était le bon vieux temps...\n"
"Cette musique me rend nostalgique." TEXTID(0x302C)
)
)
...
MSG(
UNSKIPPABLE "Was?! Wer bist Du?!"
BOX_BREAK

UNSKIPPABLE "Als ich " COLOR(BLUE) "das Lied der Königsfamilie\n"
COLOR(DEFAULT) "hörte, dachte ich, ein Abgesandter \n"
"sei eingetroffen...\n"
"Stattdessen sehe ich ein Kind!"
BOX_BREAK

UNSKIPPABLE "Hat " COLOR(RED) "Darunia" COLOR(DEFAULT) ", der Führer der \n"
...
"Dodongos Höhle eingedrungen..." QUICKTEXT_DISABLE
BOX_BREAK

UNSKIPPABLE QUICKTEXT_ENABLE "Die Donnerblumen-Ernte war\n"
"schlecht..." QUICKTEXT_DISABLE
BOX_BREAK

UNSKIPPABLE QUICKTEXT_ENABLE "Und zudem leidet mein Volk\n"
"Hunger..." QUICKTEXT_DISABLE
BOX_BREAK

UNSKIPPABLE SHIFT(28) "Doch wie dem auch sei..." TEXTID(0x301B)
),
MSG(
UNSKIPPABLE "Mmm? Quoi? Qui es-tu?!"
BOX_BREAK

UNSKIPPABLE "C'est toi qui a joué le " COLOR(BLUE) "chant de la \n"
"Famille Royale" COLOR(DEFAULT) "? Mais tu n'es pas \n"
"un messager! Tu n'es qu'un nabot \n"
"avec un chapeau vert!"
BOX_BREAK

UNSKIPPABLE COLOR(RED) "Darunia" COLOR(DEFAULT) ", le Chef des Gorons,\n"
...
"Caverne Dodongo!" QUICKTEXT_DISABLE
BOX_BREAK

UNSKIPPABLE QUICKTEXT_ENABLE "Notre récolte de Choux-Péteurs\n"
"est minable!" QUICKTEXT_DISABLE
BOX_BREAK

UNSKIPPABLE QUICKTEXT_ENABLE "On crève tous de faim par ici!\n"
"Y'a plus un rocher mangeable!!" QUICKTEXT_DISABLE
BOX_BREAK

UNSKIPPABLE SHIFT(72) "Mais..." TEXTID(0x301B)
)
)
...
MSG(
QUICKTEXT_ENABLE SHIFT(17) "Dies ist Sache der Goronen!" QUICKTEXT_DISABLE
BOX_BREAK

QUICKTEXT_ENABLE SHIFT(11) "Wir sind zu stolz, um die Hilfe\n"
SHIFT(6) "Fremder in Anspruch zu nehmen!" QUICKTEXT_DISABLE
),
MSG(
QUICKTEXT_ENABLE SHIFT(35) "C'est notre problème..." QUICKTEXT_DISABLE
BOX_BREAK

QUICKTEXT_ENABLE SHIFT(5) "Cela ne regarde que les Gorons!" QUICKTEXT_DISABLE
)
)
...
MSG(
UNSKIPPABLE QUICKTEXT_ENABLE SHIFT(39) "Wow! Cooler Sound!" QUICKTEXT_DISABLE
BOX_BREAK
...
UNSKIPPABLE SHIFT(60) "Ich bin " COLOR(RED) "Darunia" COLOR(DEFAULT) "!"
BOX_BREAK
...
UNSKIPPABLE SHIFT(80) "Wie?"
BOX_BREAK

UNSKIPPABLE "Du suchst den " COLOR(RED) "Heiligen Stein\n"
"des Feuers" COLOR(DEFAULT) "?"
BOX_BREAK
...
MSG(
UNSKIPPABLE QUICKTEXT_ENABLE SHIFT(17) "Hé! Ca c'est de la chanson!" QUICKTEXT_DISABLE
BOX_BREAK
...
UNSKIPPABLE SHIFT(50) "Mon nom est " COLOR(RED) "Darunia" COLOR(DEFAULT) "!"
BOX_BREAK
...
UNSKIPPABLE SHIFT(75) "Pardon?"
BOX_BREAK

UNSKIPPABLE "Tu veux la " COLOR(RED) "Pierre Ancestrale du \n"
"Feu" COLOR(DEFAULT) "? Ben voyons!"
BOX_BREAK
...
UNSKIPPABLE COLOR(RED) "Darunia" COLOR(DEFAULT) " nahm ihn an sich...\n"
...
UNSKIPPABLE "Le chef " COLOR(RED) "Darunia" COLOR(DEFAULT) " a dû la cacher\n"
...
"Tout le monde déprime à mort..." TEXTID(0x3025)
)
)
...
"Du auch " COLOR(RED) "Goronia" COLOR(DEFAULT) " besuchen!"
BOX_BREAK
...
"Le" COLOR(RED) " Village Goron " COLOR(DEFAULT) "est au bout du\n"
...
UNSKIPPABLE "Ich bin " COLOR(RED) NAME COLOR(DEFAULT) "! \n"
...
UNSKIPPABLE COLOR(RED) NAME COLOR(DEFAULT) "! \n"
"Héros des Gorons!"
)
)
...
UNSKIPPABLE COLOR(RED) "Darunia " COLOR(DEFAULT) "ist mein Vater...\n"
"Kennst Du ihn?"
BOX_BREAK

UNSKIPPABLE "Er" COLOR(RED) " " COLOR(DEFAULT) "benannte mich nach Dir," COLOR(RED) "\n"
...
"Schreib:\n"
SHIFT(5) "\"Für meinen Freund \n"
SHIFT(5) NAME ", den Goronen!\""
BOX_BREAK
...
"ist mein Vater verloren!" TEXTID(0x3033)
),
MSG(
UNSKIPPABLE "Quoi?"
BOX_BREAK
...
UNSKIPPABLE "Mon pôpa c'est " COLOR(RED) "Darunia" COLOR(DEFAULT) "...\n"
...
"Ecris juste...\n"
SHIFT(12) "\"Pour mon ami...\n"
SHIFT(12) NAME ", le Goron\""
BOX_BREAK
...
"il va se faire croquer!!" TEXTID(0x3033)
)
)
...
"\n"
TWO_CHOICE
    COLOR(ADJUSTABLE) "Über den Drachen\n"
...
"der die Kreatur vernichtete!" TEXTID(0x3033)
),
MSG(
...
"c'est un descendant de ce héros!" TEXTID(0x3033)
)
)
...
"Feuertempel " COLOR(DEFAULT) "verschleppt wurden."
BOX_BREAK
...
UNSKIPPABLE "Jetzt sollen sie " COLOR(RED) "Volvagia " COLOR(DEFAULT) "geopfert \n"
"werden!"
BOX_BREAK
...
COLOR(RED) "Volcania" COLOR(DEFAULT) "!"
BOX_BREAK
...
"Pfad zum Feuertempel zeigen!" TEXTID(0x3038)
),
MSG(
...
"au Temple du Feu!" TEXTID(0x3038)
)
)
...
UNSKIPPABLE "C'est vraiment toi?!?"
BOX_BREAK
...
MSG(
SHIFT(71) "Vergiß nie...\n"
SHIFT(12) "Du und ich, wir sind nun Brüder!" FADE(80)
),
MSG(
SHIFT(57) "N'oublie jamais...\n"
SHIFT(13) "Nous sommes Frères de sang!" FADE(80)
)
)
...
"bleiben!" COLOR(DEFAULT) QUICKTEXT_DISABLE FADE(60)
),
MSG(
QUICKTEXT_ENABLE COLOR(LIGHTBLUE) NAME ", \n"
"il fait beaucoup trop chaud! \n"
"Nous ne tiendrons pas longtemps!" COLOR(DEFAULT) QUICKTEXT_DISABLE FADE(60)
)
)
...
"Drachen gemeinsam bezwungen!" TEXTID(0x3042)
),
MSG(
...
"dragon! Tous les deux!" TEXTID(0x3042)
)
)
...
"Der " COLOR(RED) "Weise des Feuers" COLOR(DEFAULT) "..."
BOX_BREAK
...
COLOR(RED) "Sage du Feu" COLOR(DEFAULT) "..."
BOX_BREAK
...
UNSKIPPABLE "Für all dies war " COLOR(RED) "Ganondorf" COLOR(DEFAULT) "," COLOR(RED) "\n"
COLOR(DEFAULT) "der Gerudokönig, verantwortlich."
BOX_BREAK

UNSKIPPABLE "Er sprach: \n"
"\"" COLOR(LIGHTBLUE) "Gebt mir den Heiligen Stein und\n"
"ich werde eure Höhle wieder \n"
"öffnen!" COLOR(DEFAULT) "\""
BOX_BREAK
...
MSG(
UNSKIPPABLE "Ben dis donc! Quelle histoire!"
BOX_BREAK
...
UNSKIPPABLE "A mon avis " COLOR(RED) "Ganondorf" COLOR(DEFAULT) " est le \n"
"responsable de tout ce tintouin!"
BOX_BREAK

UNSKIPPABLE "\"" COLOR(LIGHTBLUE) "Donne-moi la Pierre Ancestrale et" COLOR(DEFAULT) " \n"
COLOR(LIGHTBLUE) "j'ouvrirai la caverne" COLOR(DEFAULT) "\", qu'il a dit..."
BOX_BREAK
...
"wird noch eine Weile dauern..." TEXTID(0x304B)
),
MSG(
"Je travaille sur un truc vraiment\n"
"costaud! Mais ça va me prendre \n"
"du temps..." TEXTID(0x304B)
)
)
...
"Wie wär's damit?" TEXTID(0x304F)
),
MSG(
"Je viens de finir ce cure-dent. \n"
"Qu'en dis-tu?" TEXTID(0x304F)
)
)
...
COLOR(RED) "König Zora" COLOR(DEFAULT) "..." TEXTID(0x3055)
),
MSG(
...
UNSKIPPABLE "Le " COLOR(RED) "Roi Zoooora " COLOR(DEFAULT) "a" COLOR(RED) " " COLOR(DEFAULT) "des gouttes \n"
"pour mes yeeeuuuuuux..." TEXTID(0x3055)
)
)
...
MSG(
UNSKIPPABLE SHIFT(89) COLOR(RED) "Wow!" COLOR(DEFAULT)
BOX_BREAK
...
"te faaaiiire patienter." TEXTID(0x305C)
)
)
...
MSG(
QUICKTEXT_ENABLE COLOR(LIGHTBLUE) "Du hast Deinen " COLOR(DEFAULT) "Schild " COLOR(LIGHTBLUE) "verloren!" COLOR(DEFAULT) QUICKTEXT_DISABLE FADE(60)
),
MSG(
QUICKTEXT_ENABLE COLOR(LIGHTBLUE) "Votre " COLOR(DEFAULT) "bouclier" COLOR(LIGHTBLUE) " a disparu!" COLOR(DEFAULT) QUICKTEXT_DISABLE FADE(60)
)
)
...
MSG(
QUICKTEXT_ENABLE COLOR(LIGHTBLUE) "Du hast Deine " COLOR(DEFAULT) "Rüstung " COLOR(LIGHTBLUE) "verloren!" COLOR(DEFAULT) QUICKTEXT_DISABLE FADE(60)
),
MSG(
QUICKTEXT_ENABLE COLOR(LIGHTBLUE) "Votre " COLOR(DEFAULT) "tunique " COLOR(LIGHTBLUE) "a disparu!" COLOR(DEFAULT) QUICKTEXT_DISABLE FADE(60)
)
)
...
COLOR(LIGHTBLUE) "Du hast Deine " COLOR(DEFAULT) "Rüstung " COLOR(LIGHTBLUE) "verloren!" COLOR(DEFAULT) QUICKTEXT_DISABLE FADE(60)
),
MSG(
...
"ont disparu!" COLOR(DEFAULT) QUICKTEXT_DISABLE FADE(60)
)
)
...
UNSKIPPABLE "Eine mächtige " COLOR(RED) "Fee" COLOR(DEFAULT) " lebt \n"
...
UNSKIPPABLE "La " COLOR(RED) "Grande Fée" COLOR(DEFAULT) " demeure au sommet.\n"
...
"Wenn Du " COLOR(RED) "zum Fuß des Berges" COLOR(DEFAULT) " \n"
...
"Todesberges eine " COLOR(RED) "Fee" COLOR(DEFAULT) " lebt."
BOX_BREAK
...
"Il te faut le bon " COLOR(LIGHTBLUE) "bouclier " COLOR(DEFAULT) "pour \n"
...
"Ein " COLOR(DEFAULT) "Küken " COLOR(LIGHTBLUE) "ist geschlüpft!" COLOR(DEFAULT) QUICKTEXT_DISABLE FADE(99)
),
MSG(
...
"C'est-y pas mimi la nature? Hein?" COLOR(DEFAULT) QUICKTEXT_DISABLE FADE(99)
)
)
...
UNSKIPPABLE "Die " COLOR(RED) "Fee" COLOR(DEFAULT) " auf dem Gipfel des\n"
...
UNSKIPPABLE "In diesem Tempel gibt es " COLOR(RED) "Türen" COLOR(DEFAULT) ",\n"
COLOR(RED) "die Dich" COLOR(DEFAULT) " beim Versuch, sie zu \n"
"öffnen, " COLOR(RED) "erschlagen" COLOR(DEFAULT) "! Sei gewarnt!"
BOX_BREAK
