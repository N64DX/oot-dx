...
MSG(
QUICKTEXT_ENABLE SHIFT(65) "Just ahead:\n"
SHIFT(70) COLOR(RED) "Lake Hylia" COLOR(DEFAULT) QUICKTEXT_DISABLE
),
MSG(),
MSG()
)
...
MSG(
QUICKTEXT_ENABLE SHIFT(65) "Just ahead:\n"
SHIFT(64) COLOR(RED) "Hyrule Field" COLOR(DEFAULT) QUICKTEXT_DISABLE
),
MSG(),
MSG()
)
...
MSG(),
MSG(
QUICKTEXT_ENABLE SHIFT(55) "Come and relax:\n"
SHIFT(65) COLOR(RED) "Romani Town" COLOR(DEFAULT) QUICKTEXT_DISABLE
),
MSG(),
MSG()
)

DEFINE_MESSAGE(0x034E, TEXTBOX_TYPE_WOODEN, TEXTBOX_POS_VARIABLE,
MSG(),
MSG(
QUICKTEXT_ENABLE SHIFT(65) "This way to:\n"
SHIFT(55) COLOR(RED) "Mountain Village" COLOR(DEFAULT) QUICKTEXT_DISABLE
),
MSG(),
MSG()
)
...
DEFINE_MESSAGE(0x0350, TEXTBOX_TYPE_WOODEN, TEXTBOX_POS_VARIABLE,
MSG(),
MSG(
QUICKTEXT_ENABLE SHIFT(45) COLOR(LIGHTBLUE) "Spring Lake Smithy" COLOR(DEFAULT) "\n"
SHIFT(45) "Open for business!" QUICKTEXT_DISABLE
),
MSG(),
MSG()
)

DEFINE_MESSAGE(0x0351, TEXTBOX_TYPE_WOODEN, TEXTBOX_POS_VARIABLE,
MSG(),
MSG(
QUICKTEXT_ENABLE SHIFT(30) COLOR(LIGHTBLUE) "Welcome to Spring Lake!" COLOR(DEFAULT) "\n"
"Home to the Lakeside Gorons and\n"
"Hyrule's most prestigous shieldsmith." QUICKTEXT_DISABLE
),
MSG(),
MSG()
)

DEFINE_MESSAGE(0x0352, TEXTBOX_TYPE_WOODEN, TEXTBOX_POS_VARIABLE,
MSG(),
MSG(
QUICKTEXT_ENABLE SHIFT(50) "This way to the:\n"
SHIFT(57) COLOR(RED) "Goron Village" COLOR(DEFAULT) QUICKTEXT_DISABLE
),
MSG(),
MSG()
)

DEFINE_MESSAGE(0x0353, TEXTBOX_TYPE_WOODEN, TEXTBOX_POS_VARIABLE,
MSG(),
MSG(
QUICKTEXT_ENABLE SHIFT(70) COLOR(PURPLE) "Beware!" COLOR(DEFAULT) "\n"
SHIFT(30) "Beyond this point lies:\n"
SHIFT(33) COLOR(RED) "The Forbidden Woods" COLOR(DEFAULT) QUICKTEXT_DISABLE
),
MSG(),
MSG()
)
...
QUICKTEXT_ENABLE SHIFT(70) COLOR(PURPLE) "Beware!" COLOR(DEFAULT) "\n"
SHIFT(30) "Beyond this point lies:\n"
SHIFT(57) COLOR(RED) "Stone Tower" COLOR(DEFAULT) QUICKTEXT_DISABLE
),
MSG(),
MSG()
)

DEFINE_MESSAGE(0x0356, TEXTBOX_TYPE_WOODEN, TEXTBOX_POS_VARIABLE,
MSG(),
MSG(
QUICKTEXT_ENABLE SHIFT(35) "Welcome, come inside!\n"
SHIFT(63) COLOR(RED) "Goron Shrine" COLOR(DEFAULT) QUICKTEXT_DISABLE
),
MSG(),
MSG()
)

DEFINE_MESSAGE(0x0357, TEXTBOX_TYPE_WOODEN, TEXTBOX_POS_VARIABLE,
MSG(),
MSG(
QUICKTEXT_ENABLE SHIFT(40) "Overcome the trial\n"
SHIFT(15) "The " COLOR(RED) "Great Fairy of Arcana" COLOR(DEFAULT) "\n"
SHIFT(60) "awaits you" QUICKTEXT_DISABLE
),
MSG(),
MSG()
)

DEFINE_MESSAGE(0x0358, TEXTBOX_TYPE_WOODEN, TEXTBOX_POS_VARIABLE,
MSG(),
MSG(
