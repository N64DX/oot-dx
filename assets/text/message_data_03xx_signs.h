...
MSG(
QUICKTEXT_ENABLE SHIFT(65) "最後の警告:\n"
SHIFT(40) COLOR(RED) "この先　危険な敵" COLOR(DEFAULT)
),
MSG(
QUICKTEXT_ENABLE SHIFT(60) "Last warning:\n"
SHIFT(40) COLOR(RED) "Dangerous foe ahead\n" COLOR(DEFAULT)
),
MSG(
QUICKTEXT_ENABLE SHIFT(60) "Letzte Warnung:\n"
SHIFT(40) COLOR(RED) "Gefährlicher Feind voraus" COLOR(DEFAULT)
),
MSG(
QUICKTEXT_ENABLE SHIFT(60) "Dernier avertissement :\n"
