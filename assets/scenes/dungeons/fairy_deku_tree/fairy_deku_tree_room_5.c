...
#include "fairy_deku_tree_room_5.h"
...
SceneCmd fairy_deku_tree_room_5[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&fairy_deku_tree_room_5MeshHeader0x000080),
    SCENE_CMD_OBJECT_LIST(11, fairy_deku_tree_room_5ObjectList0x000038),
    SCENE_CMD_ACTOR_LIST(5, fairy_deku_tree_room_5ActorList0x00004C),
    SCENE_CMD_END(),
};
...
ActorEntry fairy_deku_tree_room_5ActorList0x00004C[] = {
    ...
    { ACTOR_EN_GOOMBA,   { -240, 1320, -100 }, { 0, 0, 0 }, 0x0000 },
    { ACTOR_EN_GOOMBA,   {  150, 1320, -120 }, { 0, 0, 0 }, 0x0000 },
};

RoomShapeCullable fairy_deku_tree_room_5MeshHeader0x000080 = {
    2,
    2,
    fairy_deku_tree_room_5MeshDListEntry0x00008C,
    fairy_deku_tree_room_5MeshDListEntry0x00008C + ARRAY_COUNTU(fairy_deku_tree_room_5MeshDListEntry0x00008C)
};

RoomShapeCullableEntry fairy_deku_tree_room_5MeshDListEntry0x00008C[2] = {
    { { 0, 1520, 0 }, 447, NULL, fairy_deku_tree_room_5Dlist0x004130 },
    { { 0, 1480, 0 }, 468, fairy_deku_tree_room_5Dlist0x000C80, NULL },
};

static s32 terminatorMaybe = { 0x01000000 };

Vtx fairy_deku_tree_room_5Vtx_0000B0[] = {
...
Vtx fairy_deku_tree_room_5Vtx_0001C0[] = {
...
Vtx fairy_deku_tree_room_5Vtx_000640[] = {
...
Vtx fairy_deku_tree_room_5Vtx_000A00[] = {
...
Vtx fairy_deku_tree_room_5Vtx_000C00[] = {
...
Gfx fairy_deku_tree_room_5Dlist0x000C80[] = {
    ...
    gsSPVertex(&fairy_deku_tree_room_5Vtx_000C00[0], 8, 0),
    ...
    gsSPVertex(&fairy_deku_tree_room_5Vtx_0000B0[0], 17, 0),
    ...
    gsSPVertex(&fairy_deku_tree_room_5Vtx_0001C0[0], 32, 0),
    ...
    gsSPVertex(&fairy_deku_tree_room_5Vtx_0001C0[30], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    ...
    gsSPVertex(&fairy_deku_tree_room_5Vtx_0001C0[61], 11, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    ...
    gsSPVertex(&fairy_deku_tree_room_5Vtx_000640[0], 32, 0),
    ...
    gsSPVertex(&fairy_deku_tree_room_5Vtx_000640[31], 29, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSPVertex(&fairy_deku_tree_room_5Vtx_000A00[0], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
...
Gfx fairy_deku_tree_room_5Dlist0x004130[] = {
    gsDPPipeSync(),
    gsSPClearGeometryMode(G_TEXTURE_ENABLE | G_FOG | G_LIGHTING),
    gsSPVertex(&fairy_deku_tree_room_5Vtx_0040B0[0], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsDPPipeSync(),
    gsSPSetGeometryMode(G_TEXTURE_ENABLE | G_FOG | G_LIGHTING),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(fairy_deku_tree_room_5Tex_004228, G_IM_FMT_IA, G_IM_SIZ_16b, 32, 64, 0, 0, 0, 5, 6, 0, 0),
    gsDPSetCombineLERP(TEXEL0, K5, SHADE, COMBINED_ALPHA, TEXEL0, 0, PRIMITIVE, 0, COMBINED, K5, PRIMITIVE, COMBINED_ALPHA, 0, 0, 0, COMBINED),
    ...
    gsSPVertex(&fairy_deku_tree_room_5Vtx_003FE0[0], 13, 0),
