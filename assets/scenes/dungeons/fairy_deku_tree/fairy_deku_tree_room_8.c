...
SceneCmd fairy_deku_tree_room_8[] = {
    ...
    SCENE_CMD_OBJECT_LIST(6, fairy_deku_tree_room_8ObjectList0x000038),
    SCENE_CMD_ACTOR_LIST(2, fairy_deku_tree_room_8ActorList0x000048),
    SCENE_CMD_END(),
};
...
ActorEntry fairy_deku_tree_room_8ActorList0x000048[] = {
    { ACTOR_EN_BOX,   { 2001, 760, -9 }, { 0x40, 0x4000, 0 }, 0x1006 }, // Chest: 06, on clear, Compass
