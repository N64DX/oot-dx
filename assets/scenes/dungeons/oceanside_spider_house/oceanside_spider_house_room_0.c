...
SceneCmd oceanside_spider_house_room_0[] = {
    ...
    SCENE_CMD_OBJECT_LIST(15, oceanside_spider_house_room_0ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(14, oceanside_spider_house_room_0ActorEntry_00005C),
    SCENE_CMD_END(),
};
...
ActorEntry oceanside_spider_house_room_0ActorEntry_00005C[] = {
  ...
  //{ ACTOR_EN_STH,           { -217, 180, -793 }, {      0,   0xF2,      0 }, 0xFE05 },
    { ACTOR_BG_SPDWEB,        {    4, 400, -909 }, { 0x25B0, 0xCEEE, 0xB555 }, 0x0A01 },
    { ACTOR_BG_SPDWEB,        { -141, 450, -906 }, { 0x471C, 0xCEEE, 0xB555 }, 0x0B01 },
