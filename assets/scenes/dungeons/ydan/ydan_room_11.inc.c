    ...
    SCENE_CMD_ROOM_SHAPE(&ydan_room_11_03000050_RoomShapeCullable),
    SCENE_CMD_OBJECT_LIST(ARRAY_COUNT(ydan_room_11_03000038_ObjectList), ydan_room_11_03000038_ObjectList),
    SCENE_CMD_END(),
