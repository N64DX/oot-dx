...
SceneCmd ydan_room_9Commands[] = {
    ...
    SCENE_CMD_OBJECT_LIST(10, ydan_room_9ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(9, ydan_room_9ActorEntry_000054),
    SCENE_CMD_END(),
};
...
ActorEntry ydan_room_9ActorEntry_000054[] = {
    { ACTOR_EN_KUSA,     {   -269,  -1880,   -643 }, {      0,      0,      0 }, 0xFF01 },
    { ACTOR_EN_KUSA,     {   -273,  -1880,   -577 }, {      0,      0,      0 }, 0xFF01 },
    { ACTOR_EN_KUSA,     {   -273,  -1880,   -515 }, {      0,      0,      0 }, 0xFF01 },
    { ACTOR_EN_HINTNUTS, {   -662,  -1880,   -957 }, {      0,      0,      0 }, 0x0001 },
    { ACTOR_EN_HINTNUTS, {   -311,  -1880,   -904 }, {      0,      0,      0 }, 0x0002 },
    { ACTOR_EN_HINTNUTS, {   -946,  -1880,   -767 }, {      0,      0,      0 }, 0x9C03 },
...
u8 ydan_room_9_possiblePadding_0000E4[] = {
...
SceneCmd ydan_mq_room_9Set[] = {
    SCENE_CMD_ECHO_SETTINGS(7),
    SCENE_CMD_ROOM_BEHAVIOR(0x01, 0x00, false, false),
    SCENE_CMD_SKYBOX_DISABLES(true, true),
    SCENE_CMD_TIME_SETTINGS(255, 255, 0),
    SCENE_CMD_ROOM_SHAPE(&ydan_room_9RoomShapeCullable_0000F0),
    SCENE_CMD_OBJECT_LIST(13, ydan_mq_room_9ObjectList),
    SCENE_CMD_ACTOR_LIST(9, ydan_mq_room_9ActorEntry),
    SCENE_CMD_END(),
};

s16 ydan_mq_room_9ObjectList[] = {
    OBJECT_YDAN_OBJECTS,
    OBJECT_GOL,
    OBJECT_ST,
    OBJECT_DEKUBABA,
...
ActorEntry ydan_mq_room_9ActorEntry[] = {
