...
SceneCmd ydan_room_11Commands[] = {
    SCENE_CMD_QUEST_HEADER_LIST(ydan_room_11QuestHeaders),
...
SceneCmd* ydan_room_11QuestHeaders[] = {
    ydan_mq_room_11Set,
};
...
SceneCmd ydan_mq_room_11Set[] = {
    SCENE_CMD_ECHO_SETTINGS(7),
    SCENE_CMD_ROOM_BEHAVIOR(0x01, 0x00, false, false),
    SCENE_CMD_SKYBOX_DISABLES(true, true),
    SCENE_CMD_TIME_SETTINGS(255, 255, 0),
    SCENE_CMD_ROOM_SHAPE(&ydan_room_11RoomShapeCullable_000050),
    SCENE_CMD_OBJECT_LIST(9, ydan_mq_room_11ObjectList),
    SCENE_CMD_END(),
};

s16 ydan_mq_room_11ObjectList[] = {
    OBJECT_YDAN_OBJECTS,
    OBJECT_GOL,
    OBJECT_ST,
    OBJECT_DEKUBABA,
