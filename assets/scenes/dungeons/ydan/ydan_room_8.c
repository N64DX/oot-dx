...
SceneCmd ydan_room_8Commands[] = {
    SCENE_CMD_QUEST_HEADER_LIST(ydan_room_8QuestHeaders),
    SCENE_CMD_ECHO_SETTINGS(7),
    SCENE_CMD_ROOM_BEHAVIOR(0x01, 0x00, false, false),
    SCENE_CMD_SKYBOX_DISABLES(true, true),
    SCENE_CMD_TIME_SETTINGS(255, 255, 0),
    SCENE_CMD_ROOM_SHAPE(&ydan_room_8RoomShapeCullable_000080),
    SCENE_CMD_OBJECT_LIST(11, ydan_room_8ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(2, ydan_room_8ActorEntry_000058),
    SCENE_CMD_END(),
};

SceneCmd* ydan_room_8QuestHeaders[] = {
    ydan_mq_room_8Set,
};
...
ActorEntry ydan_room_8ActorEntry_000058[] = {
    { ACTOR_EN_ST, {  -2684,   -735,   -712 }, {      0, 0X2000,      0 }, 0x0000 },
    { ACTOR_EN_SW, {  -2577,   -626,   -411 }, {      0, 0X8000,      0 }, 0x8101 },
};

u8 ydan_room_8_possiblePadding_000078[] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
};

RoomShapeCullable ydan_room_8RoomShapeCullable_000080 = { 
    2, 1,
    ydan_room_8RoomShapeCullableEntry_00008C,
    ydan_room_8RoomShapeCullableEntry_00008C + ARRAY_COUNTU(ydan_room_8RoomShapeCullableEntry_00008C)
};

RoomShapeCullableEntry ydan_room_8RoomShapeCullableEntry_00008C[1] = {
    { {  -2576,   -640,   -609 },    253, ydan_room_8DL_0006D0, NULL },
};

s32 ydan_room_8_terminatorMaybe_00009C = { 0x01000000 };

SceneCmd ydan_mq_room_8Set[] = {
    SCENE_CMD_ECHO_SETTINGS(7),
    SCENE_CMD_ROOM_BEHAVIOR(0x01, 0x00, false, false),
    SCENE_CMD_SKYBOX_DISABLES(true, true),
    SCENE_CMD_TIME_SETTINGS(255, 255, 0),
    SCENE_CMD_ROOM_SHAPE(&ydan_room_8RoomShapeCullable_000080),
    SCENE_CMD_OBJECT_LIST(10, ydan_mq_room_8ObjectList),
    SCENE_CMD_ACTOR_LIST(11, ydan_mq_room_8ActorEntry),
    SCENE_CMD_END(),
};

s16 ydan_mq_room_8ObjectList[] = {
    OBJECT_YDAN_OBJECTS,
    OBJECT_GOL,
    OBJECT_ST,
    OBJECT_DEKUBABA,
...
ActorEntry ydan_mq_room_8ActorEntry[] = {
...
Vtx ydan_room_8Vtx_0000A0[] = {
#include "assets/scenes/dungeons/ydan/ydan_room_8Vtx_0000A0.vtx.inc"
};

Gfx ydan_room_8DL_0006D0[] = {
    gsDPPipeSync(),
    gsSPClearGeometryMode(G_FOG | G_LIGHTING),
    gsSPVertex(&ydan_room_8Vtx_0000A0[91], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsDPPipeSync(),
    gsSPSetGeometryMode(G_FOG | G_LIGHTING),
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(ydan_room_8Tex_0008F8, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
    ...
    gsSPVertex(ydan_room_8Vtx_0000A0, 32, 0),
    ...
    gsSPVertex(&ydan_room_8Vtx_0000A0[32], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSPVertex(&ydan_room_8Vtx_0000A0[64], 27, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
...
u8 ydan_room_8_unaccounted_0008E8[] = {
    0xDE, 0x00, 0x00, 0x00, 0x03, 0x00, 0x06, 0xD0, 0xDF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
};

u64 ydan_room_8Tex_0008F8[] = {
#include "assets/scenes/dungeons/ydan/ydan_room_8Tex_0008F8.ci8.inc.c"
};
