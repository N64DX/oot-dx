...
extern SceneCmd* questHeaders_men_room8[];
...
#include "assets/scenes/dungeons/men/cmq/actors/room8_actor.inc.c"
};

static SceneCmd cmq_header[] = {
#include "assets/scenes/dungeons/men/cmq/headers/room8.inc.c"
};
