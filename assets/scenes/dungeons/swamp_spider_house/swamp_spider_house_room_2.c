...
SceneCmd swamp_spider_house_room_2Commands[] = {
    ...
    SCENE_CMD_OBJECT_LIST(14, swamp_spider_house_room_2ObjectList_000040),
...
ActorEntry swamp_spider_house_room_2ActorEntry_000068[] = {
 ...
 /* { ACTOR_OBJ_COMB,    { -73,  405, -1453 }, { 0,   0,      0    }, 0x7F0E, },
    { ACTOR_OBJ_COMB,    { -31,  430, -1332 }, { 0,   0,      0    }, 0x7F3F, },
    { ACTOR_OBJ_COMB,    {  28,  429, -1451 }, { 0,   0,      0    }, 0x7F3F, },
    { ACTOR_OBJ_COMB,    { -12,  432, -1574 }, { 0,   0,      0    }, 0x7F3F, }, */
};
