...
SceneCmd swamp_spider_house_room_5[] = {
...
ActorEntry swamp_spider_house_room_5ActorEntry_000068[] = {
    { ACTOR_EN_SPIDER, { 250, 120, -2700 }, {              0, 0xF060, 0 }, 0x1F02 }, // Switch: 1F
    { ACTOR_EN_BOX,    {   0, 120, -2640 }, { GI_BOMB_BAG_20, 0x8000, 0 }, 0x1000 }, // Chest flag: 00, checks clear, Hero's Sword
};
