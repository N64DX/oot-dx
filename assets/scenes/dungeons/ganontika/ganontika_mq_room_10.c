...
extern SceneCmd* questHeaders_ganontika_room10[QUEST_MAX];

static SceneCmd start[] = {
    SCENE_CMD_QUEST_HEADER_LIST(questHeaders_ganontika_room10),
};
...
SceneCmd* questHeaders_ganontika_room10[] = {
