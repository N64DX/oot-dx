...
SceneCmd bdan_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&bdan_room_0RoomShapeNormal_0000C0),
    SCENE_CMD_OBJECT_LIST(7, bdan_room_0ObjectList_000058),
    SCENE_CMD_ACTOR_LIST(5, bdan_room_0ActorEntry_000068),
    SCENE_CMD_END(),
};
...
ActorEntry bdan_room_0ActorEntry_000068[] = {
    { ACTOR_EN_OKUTA,       {   -133,   -330,   -257 }, {      0,      0,      0 }, 0xFF00 },
    { ACTOR_EN_OKUTA,       {    110,   -330,   -260 }, {      0,      0,      0 }, 0xFF00 },
    { ACTOR_BG_BDAN_SWITCH, {     -4,   -112,   -729 }, {      0,      0, 0X8000 }, 0x3B04 },
    { ACTOR_EN_BUBBLE,      {     17,   -241,   -993 }, {      0,      0,      0 }, 0xFFFF },
...
RoomShapeNormal bdan_room_0RoomShapeNormal_0000C0 = { 
    ...
    bdan_room_0RoomShapeDListsEntry_0000CC + ARRAY_COUNTU(bdan_room_0RoomShapeDListsEntry_0000CC)
};

RoomShapeDListsEntry bdan_room_0RoomShapeDListsEntry_0000CC[1] = {
    { bdan_room_0DL_002CD8, bdan_room_0DL_004060 },
};
...
SceneCmd bdan_mq_room_0Set[] = {
    ...
    SCENE_CMD_TIME_SETTINGS(255, 255, 0),
    SCENE_CMD_ROOM_SHAPE(&bdan_room_0RoomShapeNormal_0000C0),
    SCENE_CMD_OBJECT_LIST(11, bdan_mq_room_0ObjectList),
    SCENE_CMD_ACTOR_LIST(18, bdan_mq_room_0ActorEntry),
    SCENE_CMD_END(),
};

s16 bdan_mq_room_0ObjectList[] = {
    OBJECT_BDAN_OBJECTS,
    OBJECT_COW,
    OBJECT_KUSA,
    OBJECT_BOX,
...
ActorEntry bdan_mq_room_0ActorEntry[] = {
...
SceneCmd bdan_room_0Set_0000E0[] = {
    SCENE_CMD_ECHO_SETTINGS(0),
    SCENE_CMD_ROOM_BEHAVIOR(0x01, 0x00, false, false),
    SCENE_CMD_SKYBOX_DISABLES(false, false),
    SCENE_CMD_TIME_SETTINGS(255, 255, 255),
    SCENE_CMD_ROOM_SHAPE(&bdan_room_0RoomShapeNormal_0000C0),
    SCENE_CMD_OBJECT_LIST(4, bdan_room_0ObjectList_000120),
    SCENE_CMD_ACTOR_LIST(5, bdan_room_0ActorEntry_000128),
    SCENE_CMD_END(),
};

s16 bdan_room_0ObjectList_000120[] = {
    OBJECT_BDAN_OBJECTS,
    OBJECT_RU1,
    OBJECT_OKUTA,
    OBJECT_BUBBLE,
...
ActorEntry bdan_room_0ActorEntry_000128[] = {
...
#include "assets/scenes/dungeons/bdan/bdan_room_0Vtx_000180.vtx.inc"
};

Gfx bdan_room_0DL_002360[] = {
    gsDPPipeSync(),
    gsSPClearGeometryMode(G_FOG | G_LIGHTING),
    gsSPVertex(&bdan_room_0Vtx_000180[534], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsDPPipeSync(),
    gsSPSetGeometryMode(G_FOG | G_LIGHTING),
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(bdan_room_0Tex_002CE8, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
    ...
    gsSPVertex(bdan_room_0Vtx_000180, 5, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 1, 4, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(bdan_room_0Tex_0030E8, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_MIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_0Vtx_000180[5], 32, 0),
    ...
    gsSPVertex(&bdan_room_0Vtx_000180[37], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
    ...
    gsSPVertex(&bdan_room_0Vtx_000180[69], 32, 0),
    ...
    gsSPVertex(&bdan_room_0Vtx_000180[100], 32, 0),
    ...
    gsSPVertex(&bdan_room_0Vtx_000180[130], 32, 0),
    ...
    gsSPVertex(&bdan_room_0Vtx_000180[162], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
    ...
    gsSPVertex(&bdan_room_0Vtx_000180[194], 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(bdan_room_0Tex_002CE8, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_0Vtx_000180[197], 31, 0),
    gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
    ...
    gsDPPipeSync(),
    gsDPLoadTextureBlock(bdan_room_0Tex_0038E8, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_0Vtx_000180[228], 32, 0),
    ...
    gsSPVertex(&bdan_room_0Vtx_000180[260], 32, 0),
    ...
    gsSPVertex(&bdan_room_0Vtx_000180[291], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSPVertex(&bdan_room_0Vtx_000180[322], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 0, 2, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 7, 5, 0),
    ...
    gsSPVertex(&bdan_room_0Vtx_000180[353], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 0, 2, 0),
    gsSP2Triangles(4, 5, 6, 0, 7, 4, 6, 0),
    ...
    gsSPVertex(&bdan_room_0Vtx_000180[384], 32, 0),
    ...
    gsSPVertex(&bdan_room_0Vtx_000180[416], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 0, 2, 0),
    ...
    gsSPVertex(&bdan_room_0Vtx_000180[446], 18, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    ...
    gsDPLoadTextureBlock(bdan_room_0Tex_002CE8, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_0Vtx_000180[464], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSPVertex(&bdan_room_0Vtx_000180[496], 14, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    ...
    gsDPLoadTextureBlock(bdan_room_0Tex_0038E8, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_0Vtx_000180[510], 24, 0),
...
Gfx bdan_room_0DL_002CD8[] = {
    gsSPDisplayList(bdan_room_0DL_002360),
    gsSPEndDisplayList(),
};

u64 bdan_room_0Tex_002CE8[] = {
#include "assets/scenes/dungeons/bdan/bdan_room_0Tex_002CE8.ci8.inc.c"
};

u64 bdan_room_0Tex_0030E8[] = {
#include "assets/scenes/dungeons/bdan/bdan_room_0Tex_0030E8.ci8.inc.c"
};
...
#include "assets/scenes/dungeons/bdan/bdan_room_0Vtx_003CF0.vtx.inc"
};

Gfx bdan_room_0DL_003F10[] = {
    gsDPPipeSync(),
    gsSPClearGeometryMode(G_FOG | G_LIGHTING),
    gsSPVertex(&bdan_room_0Vtx_003CF0[26], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsDPPipeSync(),
    gsSPSetGeometryMode(G_FOG | G_LIGHTING),
    gsDPSetTextureLUT(G_TT_RGBA16),
    ...
    gsSPVertex(bdan_room_0Vtx_003CF0, 26, 0),
    gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
...
Gfx bdan_room_0DL_004060[] = {
    gsSPDisplayList(bdan_room_0DL_003F10),
    gsSPEndDisplayList(),
};
