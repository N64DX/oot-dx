...
SceneCmd bdan_room_4Commands[] = {
    SCENE_CMD_QUEST_HEADER_LIST(bdan_room_4QuestHeaders),
    SCENE_CMD_ALTERNATE_HEADER_LIST(bdan_room_4AlternateHeaders0x000048),
    SCENE_CMD_ECHO_SETTINGS(7),
    SCENE_CMD_ROOM_BEHAVIOR(0x01, 0x00, false, false),
    SCENE_CMD_SKYBOX_DISABLES(true, true),
    SCENE_CMD_TIME_SETTINGS(255, 255, 0),
    SCENE_CMD_ROOM_SHAPE(&bdan_room_4RoomShapeNormal_0000A0),
    SCENE_CMD_OBJECT_LIST(8, bdan_room_4ObjectList_000058),
    SCENE_CMD_ACTOR_LIST(3, bdan_room_4ActorEntry_000068),
    SCENE_CMD_END(),
};

SceneCmd* bdan_room_4QuestHeaders[] = {
    bdan_mq_room_4Set,
};
...
ActorEntry bdan_room_4ActorEntry_000068[] = {
    { ACTOR_EN_OKUTA, {  -1223,    -40,  -1479 }, {      0, 0X80B6,      0 }, 0xFF00 },
...
RoomShapeNormal bdan_room_4RoomShapeNormal_0000A0 = { 
    ...
    bdan_room_4RoomShapeDListsEntry_0000AC + ARRAY_COUNTU(bdan_room_4RoomShapeDListsEntry_0000AC)
};

RoomShapeDListsEntry bdan_room_4RoomShapeDListsEntry_0000AC[1] = {
    { bdan_room_4DL_002A70, bdan_room_4DL_004040 },
};
...
SceneCmd bdan_mq_room_4Set[] = {
    ...
    SCENE_CMD_TIME_SETTINGS(255, 255, 0),
    SCENE_CMD_ROOM_SHAPE(&bdan_room_4RoomShapeNormal_0000A0),
    SCENE_CMD_OBJECT_LIST(10, bdan_mq_room_4ObjectList),
    SCENE_CMD_ACTOR_LIST(14, bdan_mq_room_4ActorEntry),
    SCENE_CMD_END(),
};

s16 bdan_mq_room_4ObjectList[] = {
    OBJECT_BDAN_OBJECTS,
    OBJECT_KUSA,
    OBJECT_D_HSBLOCK,
    OBJECT_RR,
...
ActorEntry bdan_mq_room_4ActorEntry[] = {
...
SceneCmd bdan_room_4Set_0000C0[] = {
    SCENE_CMD_ECHO_SETTINGS(0),
    SCENE_CMD_ROOM_BEHAVIOR(0x01, 0x00, false, false),
    SCENE_CMD_SKYBOX_DISABLES(false, false),
    SCENE_CMD_TIME_SETTINGS(255, 255, 255),
    SCENE_CMD_ROOM_SHAPE(&bdan_room_4RoomShapeNormal_0000A0),
    SCENE_CMD_OBJECT_LIST(4, bdan_room_4ObjectList_000100),
    SCENE_CMD_ACTOR_LIST(3, bdan_room_4ActorEntry_000108),
    SCENE_CMD_END(),
};

s16 bdan_room_4ObjectList_000100[] = {
    OBJECT_BDAN_OBJECTS,
    OBJECT_RU1,
    OBJECT_OKUTA,
    OBJECT_BROB,
...
ActorEntry bdan_room_4ActorEntry_000108[] = {
...
#include "assets/scenes/dungeons/bdan/bdan_room_4Vtx_000140.vtx.inc"
};

Gfx bdan_room_4DL_001CF0[] = {
    gsDPPipeSync(),
    gsSPClearGeometryMode(G_FOG | G_LIGHTING),
    gsSPVertex(&bdan_room_4Vtx_000140[435], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsDPPipeSync(),
    gsSPSetGeometryMode(G_FOG | G_LIGHTING),
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(bdan_room_4Tex_002A80, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
    ...
    gsSPVertex(bdan_room_4Vtx_000140, 7, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
    gsSP2Triangles(0, 4, 3, 0, 4, 5, 3, 0),
    gsSP1Triangle(5, 6, 3, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(bdan_room_4Tex_002E80, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[7], 7, 0),
    ...
    gsDPLoadTextureBlock(bdan_room_4Tex_002A80, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[14], 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(bdan_room_4Tex_003680, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[17], 32, 0),
    ...
    gsSPVertex(&bdan_room_4Vtx_000140[49], 32, 0),
    ...
    gsSPVertex(&bdan_room_4Vtx_000140[81], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
    ...
    gsSPVertex(&bdan_room_4Vtx_000140[112], 32, 0),
    ...
    gsSPVertex(&bdan_room_4Vtx_000140[144], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSPVertex(&bdan_room_4Vtx_000140[176], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
    ...
    gsSPVertex(&bdan_room_4Vtx_000140[208], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    ...
    gsSPVertex(&bdan_room_4Vtx_000140[239], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSPVertex(&bdan_room_4Vtx_000140[270], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(bdan_room_4Tex_002E80, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[274], 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(bdan_room_4Tex_002A80, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[277], 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(bdan_room_4Tex_002E80, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[280], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(bdan_room_4Tex_003680, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[284], 11, 0),
    ...
    gsDPLoadTextureBlock(bdan_room_4Tex_002A80, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[295], 7, 0),
    gsSP2Triangles(0, 1, 2, 0, 1, 0, 3, 0),
    gsSP1Triangle(4, 5, 6, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(bdan_room_4Tex_003680, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[302], 10, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    ...
    gsDPLoadTextureBlock(bdan_room_4Tex_002A80, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[312], 11, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
    ...
    gsDPLoadTextureBlock(bdan_room_4Tex_003680, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[323], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(bdan_room_4Tex_002A80, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[327], 9, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsDPLoadTextureBlock(bdan_room_4Tex_003680, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[336], 6, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(bdan_room_4Tex_002E80, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[342], 5, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
    gsSP1Triangle(3, 4, 1, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(bdan_room_4Tex_002A80, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[347], 5, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 1, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(bdan_room_4Tex_003680, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[352], 6, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 0, 0, 4, 0, 3, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(bdan_room_4Tex_002A80, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[358], 5, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 4, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(bdan_room_4Tex_003680, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[363], 20, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsDPLoadTextureBlock(bdan_room_4Tex_002A80, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[383], 5, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP1Triangle(4, 0, 3, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(bdan_room_4Tex_003680, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[388], 18, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    ...
    gsDPLoadTextureBlock(bdan_room_4Tex_002A80, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[406], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(bdan_room_4Tex_003680, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[410], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(bdan_room_4Tex_002A80, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[414], 5, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
    gsSP1Triangle(3, 4, 1, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(bdan_room_4Tex_003680, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&bdan_room_4Vtx_000140[419], 16, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
...
Gfx bdan_room_4DL_002A70[] = {
    gsSPDisplayList(bdan_room_4DL_001CF0),
    gsSPEndDisplayList(),
};

u64 bdan_room_4Tex_002A80[] = {
#include "assets/scenes/dungeons/bdan/bdan_room_4Tex_002A80.ci8.inc.c"
};

u64 bdan_room_4Tex_002E80[] = {
#include "assets/scenes/dungeons/bdan/bdan_room_4Tex_002E80.ci8.inc.c"
};

u64 bdan_room_4Tex_003680[] = {
#include "assets/scenes/dungeons/bdan/bdan_room_4Tex_003680.ci8.inc.c"
};

Vtx bdan_room_4Vtx_003E80[] = {
#include "assets/scenes/dungeons/bdan/bdan_room_4Vtx_003E80.vtx.inc"
};

Gfx bdan_room_4DL_003F50[] = {
    gsDPPipeSync(),
    gsSPClearGeometryMode(G_FOG | G_LIGHTING),
    gsSPVertex(&bdan_room_4Vtx_003E80[5], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsDPPipeSync(),
    gsSPSetGeometryMode(G_FOG | G_LIGHTING),
    gsDPSetTextureLUT(G_TT_RGBA16),
    ...
    gsSPVertex(bdan_room_4Vtx_003E80, 5, 0),
    gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
    gsSP2Triangles(1, 4, 3, 0, 1, 0, 4, 0),
    gsSPEndDisplayList(),
};

Gfx bdan_room_4DL_004040[] = {
