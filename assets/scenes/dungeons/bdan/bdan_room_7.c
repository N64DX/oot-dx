...
SceneCmd bdan_room_7Commands[] = {
    SCENE_CMD_QUEST_HEADER_LIST(bdan_room_7QuestHeaders),
    SCENE_CMD_ALTERNATE_HEADER_LIST(bdan_room_7AlternateHeaders0x000048),
    SCENE_CMD_ECHO_SETTINGS(7),
    SCENE_CMD_ROOM_BEHAVIOR(0x01, 0x00, false, false),
    SCENE_CMD_SKYBOX_DISABLES(true, true),
    SCENE_CMD_TIME_SETTINGS(255, 255, 0),
    SCENE_CMD_ROOM_SHAPE(&bdan_room_7RoomShapeNormal_000180),
    SCENE_CMD_OBJECT_LIST(9, bdan_room_7ObjectList_000058),
    SCENE_CMD_ACTOR_LIST(17, bdan_room_7ActorEntry_00006C),
    SCENE_CMD_END(),
};

SceneCmd* bdan_room_7QuestHeaders[] = {
    bdan_mq_room_7Set,
};
...
ActorEntry bdan_room_7ActorEntry_00006C[] = {
    { ACTOR_EN_TP,          {    -79,   -340,  -4438 }, {      0, 0X2EEF,      0 }, 0xFFFF },
    { ACTOR_EN_TP,          {     69,   -340,  -4440 }, {      0, 0XD49F,      0 }, 0xFFFF },
    { ACTOR_EN_TP,          {     -4,   -340,  -4517 }, {      0,      0,      0 }, 0xFFFF },
    { ACTOR_EN_TP,          {   -414,   -340,  -4557 }, {      0, 0X2B61,      0 }, 0xFFFF },
    { ACTOR_EN_TP,          {    396,   -340,  -4557 }, {      0, 0XD60B,      0 }, 0xFFFF },
    { ACTOR_ELF_MSG,        {   -664,   -340,  -5022 }, {   0X1E,    0XC,      0 }, 0x1931 },
    { ACTOR_ELF_MSG,        {    665,   -340,  -5012 }, {   0X1E,    0XC,      0 }, 0x1A31 },
    { ACTOR_ELF_MSG,        {     -4,   -340,  -5132 }, {   0X1E,    0XD,      0 }, 0x1B32 },
    { ACTOR_ELF_MSG,        {    776,   -340,  -4686 }, {    0X6,   0X1D,      0 }, 0x3F33 },
    { ACTOR_ELF_MSG,        {   -664,   -340,  -5022 }, {   0X1E,   0X4C,      0 }, 0x1037 },
    { ACTOR_ELF_MSG,        {    665,   -340,  -5012 }, {   0X1E,   0X4C,      0 }, 0x1037 },
    { ACTOR_EN_BX,          {    659,   -340,  -5021 }, {      0,      0,      0 }, 0x0B80 },
    { ACTOR_EN_BX,          {   -659,   -340,  -5022 }, {      0,      0,      0 }, 0x0B80 },
    { ACTOR_EN_BX,          {     -1,   -340,  -5140 }, {      0,      0,      0 }, 0x0C82 },
    { ACTOR_EN_RU1,         {   -790,   -340,  -4686 }, {      0, 0XC000,      0 }, 0x0206 },
...
RoomShapeNormal bdan_room_7RoomShapeNormal_000180 = { 
    ...
    bdan_room_7RoomShapeDListsEntry_00018C + ARRAY_COUNTU(bdan_room_7RoomShapeDListsEntry_00018C)
};

RoomShapeDListsEntry bdan_room_7RoomShapeDListsEntry_00018C[1] = {
    { bdan_room_7DL_002D08, NULL },
};
...
SceneCmd bdan_mq_room_7Set[] = {
    ...
    SCENE_CMD_TIME_SETTINGS(255, 255, 0),
    SCENE_CMD_ROOM_SHAPE(&bdan_room_7RoomShapeNormal_000180),
    SCENE_CMD_OBJECT_LIST(9, bdan_mq_room_7ObjectList),
    SCENE_CMD_ACTOR_LIST(12, bdan_mq_room_7ActorEntry),
    SCENE_CMD_END(),
};

s16 bdan_mq_room_7ObjectList[] = {
    OBJECT_BDAN_OBJECTS,
    OBJECT_TP,
    OBJECT_BXA,
    OBJECT_BUBBLE,
...
ActorEntry bdan_mq_room_7ActorEntry[] = {
...
SceneCmd bdan_room_7Set_0001A0[] = {
    SCENE_CMD_ECHO_SETTINGS(0),
    SCENE_CMD_ROOM_BEHAVIOR(0x01, 0x00, false, false),
    SCENE_CMD_SKYBOX_DISABLES(false, false),
    SCENE_CMD_TIME_SETTINGS(255, 255, 255),
    SCENE_CMD_ROOM_SHAPE(&bdan_room_7RoomShapeNormal_000180),
    SCENE_CMD_OBJECT_LIST(4, bdan_room_7ObjectList_0001E0),
    SCENE_CMD_ACTOR_LIST(7, bdan_room_7ActorEntry_0001E8),
    SCENE_CMD_END(),
};

s16 bdan_room_7ObjectList_0001E0[] = {
    OBJECT_BDAN_OBJECTS,
    OBJECT_RU1,
    OBJECT_BXA,
    OBJECT_VALI,
...
ActorEntry bdan_room_7ActorEntry_0001E8[] = {
...
#include "assets/scenes/dungeons/bdan/bdan_room_7Vtx_000260.vtx.inc"
};

Gfx bdan_room_7DL_001080[] = {
    gsDPPipeSync(),
    gsSPClearGeometryMode(G_FOG | G_LIGHTING),
    gsSPVertex(&bdan_room_7Vtx_000260[218], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsDPPipeSync(),
    gsSPSetGeometryMode(G_FOG | G_LIGHTING),
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(bdan_room_7Tex_002D20, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
    ...
    gsSPVertex(bdan_room_7Vtx_000260, 32, 0),
    ...
    gsSPVertex(&bdan_room_7Vtx_000260[32], 32, 0),
    ...
    gsSPVertex(&bdan_room_7Vtx_000260[62], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSPVertex(&bdan_room_7Vtx_000260[94], 32, 0),
    ...
    gsSPVertex(&bdan_room_7Vtx_000260[126], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSPVertex(&bdan_room_7Vtx_000260[158], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(1, 4, 5, 0, 1, 5, 2, 0),
    ...
    gsSPVertex(&bdan_room_7Vtx_000260[190], 28, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
...
Vtx bdan_room_7Vtx_001468[] = {
#include "assets/scenes/dungeons/bdan/bdan_room_7Vtx_001468.vtx.inc"
};

Gfx bdan_room_7DL_0026E8[] = {
    gsDPPipeSync(),
    gsSPClearGeometryMode(G_FOG | G_LIGHTING),
    gsSPVertex(&bdan_room_7Vtx_001468[288], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsDPPipeSync(),
    gsSPSetGeometryMode(G_FOG | G_LIGHTING),
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(bdan_room_7Tex_003120, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    ...
    gsSPSetGeometryMode(G_CULL_BACK | G_FOG),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(bdan_room_7Vtx_001468, 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(1, 4, 5, 0, 1, 5, 2, 0),
    ...
    gsSPVertex(&bdan_room_7Vtx_001468[31], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSP2Triangles(27, 28, 29, 0, 27, 29, 30, 0),
    gsSPVertex(&bdan_room_7Vtx_001468[62], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSPVertex(&bdan_room_7Vtx_001468[94], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(1, 4, 5, 0, 1, 5, 2, 0),
    ...
    gsSPVertex(&bdan_room_7Vtx_001468[126], 23, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 3, 5, 0, 4, 5, 6, 0),
    gsSP2Triangles(3, 2, 7, 0, 3, 7, 5, 0),
    gsSP2Triangles(6, 5, 8, 0, 6, 8, 9, 0),
    ...
    gsDPLoadTLUT_pal256(bdan_sceneTLUT_013BD8),
    gsSPVertex(&bdan_room_7Vtx_001468[149], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    ...
    gsSPVertex(&bdan_room_7Vtx_001468[181], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    ...
    gsSPVertex(&bdan_room_7Vtx_001468[213], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    ...
    gsSPVertex(&bdan_room_7Vtx_001468[245], 25, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    ...
    gsDPLoadTextureBlock(bdan_room_7Tex_003120, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPLoadTLUT_pal256(bdan_sceneTLUT_0139D0),
    gsSPVertex(&bdan_room_7Vtx_001468[270], 18, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
...
Gfx bdan_room_7DL_002D08[] = {
    gsSPDisplayList(bdan_room_7DL_001080),
    gsSPDisplayList(bdan_room_7DL_0026E8),
    gsSPEndDisplayList(),
};

u64 bdan_room_7Tex_002D20[] = {
#include "assets/scenes/dungeons/bdan/bdan_room_7Tex_002D20.ci8.inc.c"
};
