    SCENE_CMD_ALTERNATE_HEADER_LIST(ganon_demo_room_0_03000048_AltHeaders),
    ...
    SCENE_CMD_TIME_SETTINGS(17, 0, 0 /* time doesn't move */),
    SCENE_CMD_ROOM_SHAPE(&ganon_demo_room_0_03000210_RoomShapeNormal),
