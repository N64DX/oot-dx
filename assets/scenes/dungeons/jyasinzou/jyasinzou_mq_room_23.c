...
extern SceneCmd* questHeaders_jyasinzou_room23[QUEST_MAX];

static SceneCmd start[] = {
    SCENE_CMD_QUEST_HEADER_LIST(questHeaders_jyasinzou_room23),
};
...
SceneCmd* questHeaders_jyasinzou_room23[] = {
