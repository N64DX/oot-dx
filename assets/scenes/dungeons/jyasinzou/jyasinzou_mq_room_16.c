...
extern SceneCmd* questHeaders_jyasinzou_room16[QUEST_MAX];

static SceneCmd start[] = {
    SCENE_CMD_QUEST_HEADER_LIST(questHeaders_jyasinzou_room16),
};
...
SceneCmd* questHeaders_jyasinzou_room16[] = {
