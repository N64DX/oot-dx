...
#include "assets/scenes/dungeons/HAKAdan/HAKAdan_room_20.inc.c"
};
...
u8 HAKAdan_room_20_unaccounted_000114[] = {
#include "assets/scenes/dungeons/HAKAdan/HAKAdan_room_20_unaccounted_000114.bin.inc.c"
};
