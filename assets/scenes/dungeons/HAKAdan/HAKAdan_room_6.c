...
u8 HAKAdan_room_6_zeros_0000F8[8] = { 0 };
...
u8 HAKAdan_room_6_unaccounted_000114[] = {
#include "assets/scenes/dungeons/HAKAdan/HAKAdan_room_6_unaccounted_000114.bin.inc.c"
};
