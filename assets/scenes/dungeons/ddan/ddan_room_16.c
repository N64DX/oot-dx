...
SceneCmd ddan_room_16Commands[] = {
    SCENE_CMD_QUEST_HEADER_LIST(ddan_room_16QuestHeaders),
    SCENE_CMD_ECHO_SETTINGS(7),
    SCENE_CMD_ROOM_BEHAVIOR(0x01, 0x00, false, false),
    SCENE_CMD_SKYBOX_DISABLES(true, true),
    SCENE_CMD_TIME_SETTINGS(255, 255, 0),
    SCENE_CMD_ROOM_SHAPE(&ddan_room_16RoomShapeCullable_000040),
    SCENE_CMD_OBJECT_LIST(2, ddan_room_16ObjectList_000038),
    SCENE_CMD_END(),
};

SceneCmd* ddan_room_16QuestHeaders[] = {
    ddan_mq_room_16Set,
};
...
u8 ddan_room_16_possiblePadding_00003C[] = {
    0x00, 0x00, 0x00, 0x00, 
};

RoomShapeCullable ddan_room_16RoomShapeCullable_000040 = { 
    2, 2,
    ddan_room_16RoomShapeCullableEntry_00004C,
    ddan_room_16RoomShapeCullableEntry_00004C + ARRAY_COUNTU(ddan_room_16RoomShapeCullableEntry_00004C)
};

RoomShapeCullableEntry ddan_room_16RoomShapeCullableEntry_00004C[2] = {
    { {   -775,    196,  -2784 },    503, ddan_room_16DL_0009C0, NULL },
    { {   -890,   -394,  -3304 },    867, ddan_room_16DL_0019A8, NULL },
};

s32 ddan_room_16_terminatorMaybe_00006C = { 0x01000000 };

SceneCmd ddan_mq_room_16Set[] = {
    SCENE_CMD_ECHO_SETTINGS(7),
    SCENE_CMD_ROOM_BEHAVIOR(0x01, 0x00, false, false),
    SCENE_CMD_SKYBOX_DISABLES(true, true),
    SCENE_CMD_TIME_SETTINGS(255, 255, 0),
    SCENE_CMD_ROOM_SHAPE(&ddan_room_16RoomShapeCullable_000040),
    SCENE_CMD_OBJECT_LIST(9, ddan_mq_room_16ObjectList),
    SCENE_CMD_END(),
};

s16 ddan_mq_room_16ObjectList[] = {
    OBJECT_DDAN_OBJECTS,
    OBJECT_DODOJR,
    OBJECT_ZF,
    OBJECT_MIZU_OBJECTS,
...
Vtx ddan_room_16Vtx_000070[] = {
#include "assets/scenes/dungeons/ddan/ddan_room_16Vtx_000070.vtx.inc"
};

Gfx ddan_room_16DL_0009C0[] = {
    gsDPPipeSync(),
    gsSPClearGeometryMode(G_FOG | G_LIGHTING),
    gsSPVertex(&ddan_room_16Vtx_000070[141], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsDPPipeSync(),
    gsSPSetGeometryMode(G_FOG | G_LIGHTING),
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(ddan_room_16Tex_005148, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
    ...
    gsSPVertex(ddan_room_16Vtx_000070, 32, 0),
    ...
    gsSPVertex(&ddan_room_16Vtx_000070[30], 17, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsDPPipeSync(),
    gsDPLoadTextureBlock(ddan_room_16Tex_004148, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&ddan_room_16Vtx_000070[47], 5, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
    gsSP2Triangles(3, 4, 1, 0, 4, 2, 1, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(ddan_room_16Tex_005148, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&ddan_room_16Vtx_000070[52], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(ddan_room_16Tex_004148, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&ddan_room_16Vtx_000070[56], 12, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(ddan_room_16Tex_004948, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&ddan_room_16Vtx_000070[68], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSPVertex(&ddan_room_16Vtx_000070[100], 9, 0),
    ...
    gsDPLoadTextureBlock(ddan_room_16Tex_004148, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&ddan_room_16Vtx_000070[109], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
...
Vtx ddan_room_16Vtx_000DC8[] = {
#include "assets/scenes/dungeons/ddan/ddan_room_16Vtx_000DC8.vtx.inc"
};

Gfx ddan_room_16DL_0019A8[] = {
    gsDPPipeSync(),
    gsSPClearGeometryMode(G_FOG | G_LIGHTING),
    gsSPVertex(&ddan_room_16Vtx_000DC8[182], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsDPPipeSync(),
    gsSPSetGeometryMode(G_FOG | G_LIGHTING),
    gsDPSetTextureLUT(G_TT_RGBA16),
    ...
    gsSPSetGeometryMode(G_CULL_BACK | G_FOG),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(ddan_room_16Vtx_000DC8, 16, 0),
    ...
    gsDPPipeSync(),
    gsDPLoadTextureBlock(ddan_room_16Tex_003148, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_MIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&ddan_room_16Vtx_000DC8[16], 26, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsDPLoadTextureBlock(ddan_room_16Tex_005148, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&ddan_room_16Vtx_000DC8[42], 30, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsDPLoadTextureBlock(ddan_room_16Tex_002148, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&ddan_room_16Vtx_000DC8[72], 20, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
    ...
    gsDPLoadTextureBlock(ddan_room_16Tex_005148, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPLoadTLUT_pal256(gDCSceneTLUT),
    gsSPVertex(&ddan_room_16Vtx_000DC8[92], 24, 0),
    gsSP2Triangles(0, 1, 2, 0, 1, 3, 4, 0),
    ...
    gsDPLoadTextureBlock(ddan_room_16Tex_003148, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_MIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&ddan_room_16Vtx_000DC8[116], 6, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    gsSP2Triangles(0, 2, 4, 0, 0, 4, 3, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(ddan_room_16Tex_005148, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&ddan_room_16Vtx_000DC8[122], 6, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 2, 1, 0, 3, 5, 0, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(ddan_room_16Tex_004148, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&ddan_room_16Vtx_000DC8[128], 15, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
    ...
    gsDPLoadTextureBlock(ddan_room_16Tex_003148, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_MIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&ddan_room_16Vtx_000DC8[143], 7, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    gsSP2Triangles(1, 0, 6, 0, 5, 6, 3, 0),
    gsSP1Triangle(1, 6, 5, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(ddan_room_16Tex_003948, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&ddan_room_16Vtx_000DC8[150], 13, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    ...
    gsDPLoadTextureBlock(ddan_room_16Tex_004148, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&ddan_room_16Vtx_000DC8[163], 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(ddan_room_16Tex_003948, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&ddan_room_16Vtx_000DC8[166], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(ddan_room_16Tex_004148, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&ddan_room_16Vtx_000DC8[170], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(ddan_room_16Tex_003948, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&ddan_room_16Vtx_000DC8[174], 5, 0),
    gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
    gsSP1Triangle(0, 4, 1, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(ddan_room_16Tex_004148, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&ddan_room_16Vtx_000DC8[179], 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};

u8 ddan_room_16_unaccounted_002130[] = {
    0xDE, 0x00, 0x00, 0x00, 0x03, 0x00, 0x09, 0xC0, 0xDE, 0x00, 0x00, 0x00, 0x03, 0x00, 0x19, 0xA8, 
    0xDF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
};

u64 ddan_room_16Tex_002148[] = {
#include "assets/scenes/dungeons/ddan/ddan_room_16Tex_002148.rgba16.inc.c"
};

u64 ddan_room_16Tex_003148[] = {
#include "assets/scenes/dungeons/ddan/ddan_room_16Tex_003148.ci8.inc.c"
};

u64 ddan_room_16Tex_003948[] = {
#include "assets/scenes/dungeons/ddan/ddan_room_16Tex_003948.ci8.inc.c"
};

u64 ddan_room_16Tex_004148[] = {
#include "assets/scenes/dungeons/ddan/ddan_room_16Tex_004148.ci8.inc.c"
};

u64 ddan_room_16Tex_004948[] = {
#include "assets/scenes/dungeons/ddan/ddan_room_16Tex_004948.ci8.inc.c"
};

u64 ddan_room_16Tex_005148[] = {
#include "assets/scenes/dungeons/ddan/ddan_room_16Tex_005148.ci8.inc.c"
};
