    ...
    SCENE_CMD_ROOM_SHAPE(&ddan_room_16_03000040_RoomShapeCullable),
    SCENE_CMD_OBJECT_LIST(ARRAY_COUNT(ddan_room_16_03000038_ObjectList), ddan_room_16_03000038_ObjectList),
    SCENE_CMD_END(),
