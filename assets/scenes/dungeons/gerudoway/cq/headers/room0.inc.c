    ...
    SCENE_CMD_ROOM_SHAPE(&gerudoway_room_0_030000F0_RoomShapeCullable),
    SCENE_CMD_OBJECT_LIST(ARRAY_COUNT(gerudoway_room_0_03000040_ObjectList), gerudoway_room_0_03000040_ObjectList),
