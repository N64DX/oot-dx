    ...
    SCENE_CMD_ROOM_SHAPE(&MIZUsin_room_22_03000050_RoomShapeCullable),
    SCENE_CMD_OBJECT_LIST(ARRAY_COUNT(MIZUsin_room_22_03000038_ObjectList), MIZUsin_room_22_03000038_ObjectList),
    SCENE_CMD_END(),
