...
SceneCmd ikana_graveyard_room_0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(36, ikana_graveyard_room_0ActorEntry_000064),
    SCENE_CMD_END(),
};
...
ActorEntry ikana_graveyard_room_0ActorEntry_000064[] = {
    { ACTOR_EN_BAT,         {   -459,    202,   -148 }, {    0,   0x25,    0 }, 0xFF9F },
    { ACTOR_EN_BAT,         {    413,    200,   -154 }, {    0,   0xDA,    0 }, 0xFF9F },
    { ACTOR_EN_BAT,         {   -458,    260,   -218 }, {    0,      0,    0 }, 0xFF02 },
    { ACTOR_EN_BAT,         {   -359,    247,   -119 }, {    0,      0,    0 }, 0xFF02 },
    { ACTOR_EN_BAT,         {   -158,    284,    304 }, {    0,  0x10E,    0 }, 0xFF02 },
    { ACTOR_EN_BAT,         {    343,    294,    -96 }, {    0,   0xB4,    0 }, 0xFF03 },
  ...
  //{ ACTOR_EN_RAIL_SKB,    {    207,      2,    624 }, {    0,   0xCB,    0 }, 0x0206 },
  //{ ACTOR_EN_RAIL_SKB,    {    364,     52,     62 }, {    0,   0xF7,    0 }, 0x0307 },
  //{ ACTOR_EN_RAIL_SKB,    {   -239,     39,    100 }, {    0,  0x10A,    0 }, 0x0408 },
  //{ ACTOR_EN_WEATHER_TAG, {   -122,     90,   -912 }, {    0,      0,    0 }, 0x3201 },
};
