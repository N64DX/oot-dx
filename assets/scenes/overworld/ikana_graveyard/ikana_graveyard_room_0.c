...
SceneCmd ikana_graveyard_room_0[] = {
    ...
    SCENE_CMD_OBJECT_LIST(7, ikana_graveyard_room_0ObjectList_00004C),
    SCENE_CMD_ACTOR_LIST(40, ikana_graveyard_room_0ActorEntry_000064),
    SCENE_CMD_END(),
};
...
ActorEntry ikana_graveyard_room_0ActorEntry_000064[] = {
    ...
    { ACTOR_DOOR_ANA,       {  235,  20,   426 }, {               0,      0, 0 }, 0x1000 },
...
SceneCmd ikana_graveyard_room_0Set_cleansed[] = {
    ...
    SCENE_CMD_ACTOR_LIST(29, ikana_graveyard_room_0ActorEntry_cleansed),
    SCENE_CMD_END(),
};
