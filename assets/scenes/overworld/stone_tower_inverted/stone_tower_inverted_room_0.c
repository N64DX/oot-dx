...
SceneCmd stone_tower_inverted_room_0[] = {
    SCENE_CMD_ALTERNATE_HEADER_LIST(stone_tower_inverted_room_0AlternateHeaders),
    ...
    SCENE_CMD_ACTOR_LIST(31, stone_tower_inverted_room_0ActorEntry_000058),
    SCENE_CMD_END(),
};

SceneCmd* stone_tower_inverted_room_0AlternateHeaders[] = {
    NULL,
    NULL,
    stone_tower_inverted_room_0Set_cleansed,
};
...
ActorEntry stone_tower_inverted_room_0ActorEntry_000058[] = {
    { ACTOR_EN_GOROIWA,      {  689, 1972,  1324 }, {              0,      2,      2 }, 0x4106 },
    { ACTOR_EN_GOROIWA,      {  511, 1981,  1354 }, {              0,      0,      2 }, 0x4107 },
    { ACTOR_EN_GOROIWA,      {  688, 1126, -1204 }, {              0,      0,      2 }, 0x4108 },
    { ACTOR_EN_GOROIWA,      { -305, 3325,  1196 }, {              0,      0,      2 }, 0x4109 },
    { ACTOR_EN_GOROIWA,      { -308,  460,  1277 }, {              0,      0,      2 }, 0x410A },
    { ACTOR_BG_LBFSHOT,      {  599, 2014,   970 }, {         0x8000,      0,      0 }, 0x0000 },
    { ACTOR_BG_LBFSHOT,      { -287, 2220,  1147 }, {         0x8000,      0,      0 }, 0x0000 },
    { ACTOR_BG_LBFSHOT,      {   11, 1235,  -257 }, {         0x8000,      0,      0 }, 0x0000 },
    { ACTOR_BG_F40_BLOCK,    {    4,  774,    71 }, {              0,      0, 0x8000 }, 0x7E00 }, // Switch: 3F
    { ACTOR_BG_F40_BLOCK,    {    4,  774,  1031 }, {              0,      0, 0x8000 }, 0x7E0C }, // Switch: 3F
    { ACTOR_BG_F40_BLOCK,    {    4,  774,   711 }, {              0,      0, 0x8000 }, 0x7E08 }, // Switch: 3F
    { ACTOR_BG_F40_BLOCK,    {    4,  774,   391 }, {              0,      0, 0x8000 }, 0x7E04 }, // Switch: 3F
    { ACTOR_OBJ_FIRESHIELD,  {  269,  560,  1375 }, {              1,      0,      0 }, 0x1F7F }, // Switch: 3F
    { ACTOR_OBJ_FIRESHIELD,  { -269,  560,  1375 }, {              1,      0,      0 }, 0x1F7F }, // Switch: 3F
    { ACTOR_OBJ_FIRESHIELD,  { 1147,  324,  1075 }, {              1,      0,      0 }, 0x1F7F }, // Switch: 3F
    ...
    { ACTOR_OBJ_BEAN,        {  591,  854,  -571 }, {              0,      0,      0 }, 0x0401 }, // Switch: 01
    { ACTOR_OBJ_BEAN,        {  268, 1454,  -289 }, {              0,      0,      0 }, 0x0504 }, // Switch: 04
    ...
    { ACTOR_EN_WEATHER_TAG,  {    0,  569,   629 }, {              0,      0,      0 }, 0x2809 },
    { ACTOR_OBJ_LIGHTSWITCH, {    5, 1333,   829 }, {              0, 0x8000, 0x8000 }, 0x1418 }, // Switch: 14
    { ACTOR_OBJ_WTURN,       {   38,  327,   796 }, {              0, 0x4000,      0 }, 0x0014 }, // Checks switch: 14
...
SceneCmd stone_tower_inverted_room_0Set_cleansed[] = {
    SCENE_CMD_ECHO_SETTINGS(4),
    SCENE_CMD_ROOM_BEHAVIOR(ROOM_TYPE_NORMAL, ROOM_ENV_DEFAULT, LENS_MODE_SHOW_ACTORS, false),
    SCENE_CMD_SKYBOX_DISABLES(false, false),
    SCENE_CMD_TIME_SETTINGS(255, 255, 10),
    SCENE_CMD_ROOM_SHAPE(&stone_tower_inverted_room_0RoomShapeCullable_0002A0),
    SCENE_CMD_OBJECT_LIST(ARRAY_COUNT(stone_tower_inverted_room_0ObjectList_000040), stone_tower_inverted_room_0ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(ARRAY_COUNT(stone_tower_inverted_room_0ActorEntry_000058) - 1, stone_tower_inverted_room_0ActorEntry_000058),
    SCENE_CMD_END(),
};
