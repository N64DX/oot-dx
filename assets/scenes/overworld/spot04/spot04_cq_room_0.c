...
extern SceneCmd* questHeaders_spot04_room0[QUEST_MAX];

static SceneCmd start[] = {
    SCENE_CMD_QUEST_HEADER_LIST(questHeaders_spot04_room0),
};
...
#include "assets/scenes/overworld/spot04/cq/actors/room0_actor_header2.inc.c"
};
...
#include "assets/scenes/overworld/spot04/cq/headers/room0_header3.inc.c"
};

static SceneCmd* cq_altHeaders[] = {
#include "assets/scenes/overworld/spot04/cq/headers/room0_altHeaders.inc.c"
};
