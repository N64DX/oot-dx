...
SceneCmd mountain_village_room_1Commands[] = {
    ...
    SCENE_CMD_OBJECT_LIST(1, mountain_village_room_1ObjectList_00004C),
...
/*ActorEntry mountain_village_room_1ActorEntry_000074[] = {
    { ACTOR_EN_MKK | 0x6000,   {   3472,    952,   -667 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA00 },
    { ACTOR_EN_MKK | 0x6000,   {   3535,    952,   -606 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA00 },
    { ACTOR_EN_MKK | 0x6000,   {   3565,    952,   -504 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA00 },
    { ACTOR_EN_MKK | 0x6000,   {   3460,    952,   -619 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA00 },
    { ACTOR_EN_MKK | 0x6000,   {   3514,    952,   -476 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA00 },
    { ACTOR_EN_MKK | 0x6000,   {   3624,    952,   -603 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA00 },
    { ACTOR_EN_MKK | 0x6000,   {   3460,    952,   -571 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA00 },
    { ACTOR_EN_MKK | 0x6000,   {   3627,    952,   -518 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA00 },
    { ACTOR_EN_MKK | 0x6000,   {   3516,    952,   -534 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA00 },
    { ACTOR_EN_MKK | 0x6000,   {   3620,    952,   -551 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA00 },
    { ACTOR_EN_MKK | 0x6000,   {   3564,    952,   -671 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA00 },
    { ACTOR_EN_MKK | 0x6000,   {   3667,    952,   -633 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA00 },
    { ACTOR_EN_MKK | 0x6000,   {   3367,    952,   -528 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA01 },
    { ACTOR_EN_MKK | 0x6000,   {   3400,    952,   -572 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA01 },
    { ACTOR_EN_MKK | 0x6000,   {   3474,    952,   -552 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA01 },
    { ACTOR_EN_MKK | 0x6000,   {   3433,    952,   -542 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA01 },
    { ACTOR_EN_MKK | 0x6000,   {   3597,    952,   -621 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA01 },
    { ACTOR_EN_MKK | 0x6000,   {   3722,    952,   -585 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA01 },
    { ACTOR_EN_MKK | 0x6000,   {   3638,    952,   -563 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA01 },
    { ACTOR_EN_MKK | 0x6000,   {   3528,    952,   -572 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA01 },
    { ACTOR_EN_MKK | 0x6000,   {   3733,    952,   -659 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA01 },
    { ACTOR_EN_MKK | 0x6000,   {   3671,    952,   -624 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFA01 },
    { ACTOR_EN_TEST4,          {   1501,      8,     79 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(    0, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0xFD40 },
    { ACTOR_DOOR_ANA | 0x2000, {   2406,   1168,  -1197 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(0X12F, 0x000B), SPAWN_ROT_FLAGS(  0X4, 0x007F) }, 0x003B },
    { ACTOR_EN_GS,             {   3685,    837,  -1101 }, { SPAWN_ROT_FLAGS(    0, 0x0007), SPAWN_ROT_FLAGS(0X119, 0x007F), SPAWN_ROT_FLAGS(    0, 0x007F) }, 0x3BC2 },
};*/
