...
SceneCmd grottos2_room_6[] = {
    SCENE_CMD_ECHO_SETTINGS(0),
    SCENE_CMD_ROOM_BEHAVIOR(ROOM_TYPE_DUNGEON, ROOM_ENV_DEFAULT, false, false),
    SCENE_CMD_SKYBOX_DISABLES(true, true),
    SCENE_CMD_TIME_SETTINGS(255, 255, 0),
    SCENE_CMD_ROOM_SHAPE(&grottos2_room_6RoomShapeCullable_0000E0),
    SCENE_CMD_OBJECT_LIST(1, grottos2_room_6ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(7, grottos2_room_6ActorEntry_000044),
    SCENE_CMD_END(),
};

s16 grottos2_room_6ObjectList_000040[] = {
    OBJECT_DEKUBABA,
};

ActorEntry grottos2_room_6ActorEntry_000044[] = {
...
RoomShapeCullable grottos2_room_6RoomShapeCullable_0000E0 = { 
    2, 6,
    grottos2_room_6RoomShapeCullableEntry_0000EC,
    grottos2_room_6RoomShapeCullableEntry_0000EC + ARRAY_COUNTU(grottos2_room_6RoomShapeCullableEntry_0000EC)
};

RoomShapeCullableEntry grottos2_room_6RoomShapeCullableEntry_0000EC[6] = {
    { {   -210,    320,   1149 },    558, NULL, grottos2_room_6DL_002220 },
    { {   -206,      0,   1142 },    516, grottos2_room_6DL_001548, NULL },
    { {   -205,      0,   1139 },    592, grottos2_room_6DL_000AE0, NULL },
    { {   -221,     10,   1136 },    260, grottos2_room_6DL_000F70, NULL },
    { {   -221,     20,   1136 },    260, grottos2_room_6DL_0012A0, NULL },
    { {   -205,    320,   1139 },    672, grottos2_room_6DL_0006C0, NULL },
};

s32 grottos2_room_6_terminatorMaybe_00014C = { 0x01000000 };

Vtx grottos2_room_6Vtx_000150[] = {
#include "assets/scenes/misc/grottos2/grottos2_room_6Vtx_000150.vtx.inc"
};

Vtx grottos2_room_6Vtx_0008A0[] = {
#include "assets/scenes/misc/grottos2/grottos2_room_6Vtx_0008A0.vtx.inc"
};

Vtx grottos2_room_6Vtx_000C30[] = {
#include "assets/scenes/misc/grottos2/grottos2_room_6Vtx_000C30.vtx.inc"
};

Vtx grottos2_room_6Vtx_0010A0[] = {
#include "assets/scenes/misc/grottos2/grottos2_room_6Vtx_0010A0.vtx.inc"
};

Vtx grottos2_room_6Vtx_001448[] = {
#include "assets/scenes/misc/grottos2/grottos2_room_6Vtx_001448.vtx.inc"
};

Vtx grottos2_room_6Vtx_002020[] = {
#include "assets/scenes/misc/grottos2/grottos2_room_6Vtx_002020.vtx.inc"
};

Gfx grottos2_room_6DL_0006C0[] = {
    gsSPVertex(&grottos2_room_6Vtx_000150[79], 8, 0),
    ...
    gsSPVertex(grottos2_room_6Vtx_000150, 32, 0),
    ...
    gsSPVertex(&grottos2_room_6Vtx_000150[31], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSPVertex(&grottos2_room_6Vtx_000150[63], 16, 0),
...
Gfx grottos2_room_6DL_000AE0[] = {
    gsSPVertex(&grottos2_room_6Vtx_0008A0[28], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetCombineLERP(TEXEL1, TEXEL0, PRIM_LOD_FRAC, TEXEL0, TEXEL1, TEXEL0, PRIM_LOD_FRAC, TEXEL0, COMBINED, 0, SHADE, 0, COMBINED, 0, PRIMITIVE, 0),
    ...
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_SHADING_SMOOTH),
    gsSPVertex(grottos2_room_6Vtx_0008A0, 28, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
...
Gfx grottos2_room_6DL_000F70[] = {
    gsSPVertex(&grottos2_room_6Vtx_000C30[44], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    ...
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_SHADING_SMOOTH),
    gsSPVertex(grottos2_room_6Vtx_000C30, 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSPVertex(&grottos2_room_6Vtx_000C30[32], 12, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
...
Gfx grottos2_room_6DL_0012A0[] = {
    gsSPVertex(&grottos2_room_6Vtx_0010A0[24], 8, 0),
    gsSPCullDisplayList(0, 7),
    ...
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_SHADING_SMOOTH),
    gsSPVertex(grottos2_room_6Vtx_0010A0, 24, 0),
...
Gfx grottos2_room_6DL_001548[] = {
    gsSPVertex(&grottos2_room_6Vtx_001448[8], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
    ...
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_SHADING_SMOOTH),
    gsSPVertex(grottos2_room_6Vtx_001448, 8, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsSPEndDisplayList(),
};

Gfx grottos2_room_6DL_002220[] = {
    gsSPVertex(&grottos2_room_6Vtx_002020[24], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetCombineLERP(TEXEL1, TEXEL0, PRIM_LOD_FRAC, TEXEL0, TEXEL1, TEXEL0, PRIM_LOD_FRAC, TEXEL0, COMBINED, 0, SHADE, 0, COMBINED, 0, PRIMITIVE, 0),
    ...
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_SHADING_SMOOTH),
    gsSPVertex(grottos2_room_6Vtx_002020, 24, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
    gsSP2Triangles(12, 13, 14, 0, 12, 14, 15, 0),
