...
SceneCmd grottos2_room_7[] = {
    SCENE_CMD_ECHO_SETTINGS(4),
    SCENE_CMD_ROOM_BEHAVIOR(ROOM_TYPE_DUNGEON, ROOM_ENV_DEFAULT, false, false),
    SCENE_CMD_SKYBOX_DISABLES(true, true),
    SCENE_CMD_TIME_SETTINGS(255, 255, 0),
    SCENE_CMD_ROOM_SHAPE(&grottos2_room_7RoomShapeCullable_000080),
    SCENE_CMD_OBJECT_LIST(2, grottos2_room_7ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(3, grottos2_room_7ActorEntry_000048),
    SCENE_CMD_END(),
};

s16 grottos2_room_7ObjectList_000040[] = {
    OBJECT_DINOFOS,
    OBJECT_BOX,
};
...
RoomShapeCullable grottos2_room_7RoomShapeCullable_000080 = { 
    2, 5,
    grottos2_room_7RoomShapeCullableEntry_00008C,
    grottos2_room_7RoomShapeCullableEntry_00008C + ARRAY_COUNTU(grottos2_room_7RoomShapeCullableEntry_00008C)
};

RoomShapeCullableEntry grottos2_room_7RoomShapeCullableEntry_00008C[5] = {
    { {    613,    240,   1539 },    246, NULL, grottos2_room_7DL_002980 },
    { {    624,      0,   1547 },    128, grottos2_room_7DL_000F78, NULL },
    { {    621,      0,   1134 },    558, grottos2_room_7DL_000940, NULL },
    { {    611,    365,   1151 },    600, grottos2_room_7DL_000D80, NULL },
    { {    621,    240,   1151 },    624, grottos2_room_7DL_0005B0, NULL },
};

s32 grottos2_room_7_terminatorMaybe_0000DC = { 0x01000000 };

Vtx grottos2_room_7Vtx_0000E0[] = {
#include "assets/scenes/misc/grottos2/grottos2_room_7Vtx_0000E0.vtx.inc"
};

Vtx grottos2_room_7Vtx_000710[] = {
#include "assets/scenes/misc/grottos2/grottos2_room_7Vtx_000710.vtx.inc"
};

Vtx grottos2_room_7Vtx_000A50[] = {
#include "assets/scenes/misc/grottos2/grottos2_room_7Vtx_000A50.vtx.inc"
};

Vtx grottos2_room_7Vtx_000EB8[] = {
#include "assets/scenes/misc/grottos2/grottos2_room_7Vtx_000EB8.vtx.inc"
};

Vtx grottos2_room_7Vtx_002840[] = {
#include "assets/scenes/misc/grottos2/grottos2_room_7Vtx_002840.vtx.inc"
};

u64 grottos2_room_7Tex_001040[] = {
...
Gfx grottos2_room_7DL_0005B0[] = {
    ...
    gsSPVertex(&grottos2_room_7Vtx_0000E0[31], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
    gsSP2Triangles(4, 5, 6, 0, 5, 7, 6, 0),
    ...
    gsSPVertex(&grottos2_room_7Vtx_0000E0[62], 7, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(1, 4, 5, 0, 4, 6, 5, 0),
    gsSPEndDisplayList(),
};

Gfx grottos2_room_7DL_000940[] = {
    gsSPVertex(&grottos2_room_7Vtx_000710[27], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    ...
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(grottos2_room_7Tex_001040, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_SHADING_SMOOTH),
    gsSPVertex(grottos2_room_7Vtx_000710, 27, 0),
    gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
...
Gfx grottos2_room_7DL_000D80[] = {
    gsSPVertex(&grottos2_room_7Vtx_000A50[43], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    ...
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_SHADING_SMOOTH),
    gsSPVertex(grottos2_room_7Vtx_000A50, 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSPVertex(&grottos2_room_7Vtx_000A50[31], 12, 0),
...
Gfx grottos2_room_7DL_000F78[] = {
    gsSPVertex(&grottos2_room_7Vtx_000EB8[4], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
    ...
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_SHADING_SMOOTH),
    gsSPVertex(grottos2_room_7Vtx_000EB8, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

Gfx grottos2_room_7DL_002980[] = {
    gsSPVertex(&grottos2_room_7Vtx_002840[12], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    ...
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_SHADING_SMOOTH),
    gsSPVertex(grottos2_room_7Vtx_002840, 12, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
