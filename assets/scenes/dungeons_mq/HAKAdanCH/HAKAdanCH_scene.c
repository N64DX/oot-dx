...
#include "assets/scenes/dungeons_mq/HAKAdanCH/HAKAdanCH_scene.inc.c"
};
...
#include "assets/scenes/dungeons_mq/HAKAdanCH/mq/scene/transitionActors.inc.c"
};

static CollisionPoly mq_polygons[] = {
#include "assets/scenes/dungeons_mq/HAKAdanCH/mq/scene/polygons.inc.c"
};

static SurfaceType mq_surface_types[] = {
#include "assets/scenes/dungeons_mq/HAKAdanCH/mq/scene/surfaceTypes.inc.c"
};

static CollisionHeader mq_collision = {
#include "assets/scenes/dungeons_mq/HAKAdanCH/mq/scene/collision.inc.c"
};

static Vec3s mq_path_list_02000200[] = {
#include "assets/scenes/dungeons_mq/HAKAdanCH/mq/scene/pathList_02000200.inc.c"
};

static Vec3s mq_path_list_02000224[] = {
#include "assets/scenes/dungeons_mq/HAKAdanCH/mq/scene/pathList_02000224.inc.c"
};

static Path mq_path_list[] = {
#include "assets/scenes/dungeons_mq/HAKAdanCH/mq/scene/pathList.inc.c"
};

static SceneCmd mq_header[] = {
#include "assets/scenes/dungeons_mq/HAKAdanCH/mq/scene/header.inc.c"
};
