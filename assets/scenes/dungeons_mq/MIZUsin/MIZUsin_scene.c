...
#include "assets/scenes/dungeons_mq/MIZUsin/MIZUsin_scene.inc.c"
};
...
#include "assets/scenes/dungeons_mq/MIZUsin/mq/scene/transitionActors.inc.c"
};

static CollisionPoly mq_polygons[] = {
#include "assets/scenes/dungeons_mq/MIZUsin/mq/scene/polygons.inc.c"
};

static SurfaceType mq_surface_types[] = {
#include "assets/scenes/dungeons_mq/MIZUsin/mq/scene/surfaceTypes.inc.c"
};

static CollisionHeader mq_collision = {
#include "assets/scenes/dungeons_mq/MIZUsin/mq/scene/collision.inc.c"
};

static Vec3s mq_path_list_02000358[] = {
#include "assets/scenes/dungeons_mq/MIZUsin/mq/scene/pathList_02000358.inc.c"
};

static Vec3s mq_path_list_02000370[] = {
#include "assets/scenes/dungeons_mq/MIZUsin/mq/scene/pathList_02000370.inc.c"
};

static Path mq_path_list[] = {
#include "assets/scenes/dungeons_mq/MIZUsin/mq/scene/pathList.inc.c"
};

static SceneCmd mq_header[] = {
#include "assets/scenes/dungeons_mq/MIZUsin/mq/scene/header.inc.c"
};
