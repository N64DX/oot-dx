...
#include "assets/scenes/dungeons_mq/ganontika/ganontika_scene.inc.c"
};
...
#include "assets/scenes/dungeons_mq/ganontika/mq/scene/transitionActors.inc.c"
};

static CollisionPoly mq_polygons[] = {
#include "assets/scenes/dungeons_mq/ganontika/mq/scene/polygons.inc.c"
};

static SurfaceType mq_surface_types[] = {
#include "assets/scenes/dungeons_mq/ganontika/mq/scene/surfaceTypes.inc.c"
};

static CollisionHeader mq_collision = {
#include "assets/scenes/dungeons_mq/ganontika/mq/scene/collision.inc.c"
};

static Vec3s mq_path_list_020005D4[] = {
#include "assets/scenes/dungeons_mq/ganontika/mq/scene/pathList_020005D4.inc.c"
};

static Vec3s mq_path_list_020005F4[] = {
#include "assets/scenes/dungeons_mq/ganontika/mq/scene/pathList_020005F4.inc.c"
};

static Vec3s mq_path_list_0200053C[] = {
#include "assets/scenes/dungeons_mq/ganontika/mq/scene/pathList_0200053C.inc.c"
};

static Vec3s mq_path_list_0200063C[] = {
#include "assets/scenes/dungeons_mq/ganontika/mq/scene/pathList_0200063C.inc.c"
};

static Vec3s mq_path_list_02000624[] = {
#include "assets/scenes/dungeons_mq/ganontika/mq/scene/pathList_02000624.inc.c"
};

static Vec3s mq_path_list_02000630[] = {
#include "assets/scenes/dungeons_mq/ganontika/mq/scene/pathList_02000630.inc.c"
};

static Path mq_path_list[] = {
#include "assets/scenes/dungeons_mq/ganontika/mq/scene/pathList.inc.c"
};

static SceneCmd mq_header[] = {
#include "assets/scenes/dungeons_mq/ganontika/mq/scene/header.inc.c"
};
