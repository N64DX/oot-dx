    ...
    SCENE_CMD_ROOM_SHAPE(&jyasinzou_room_28_03000050_RoomShapeCullable),
    SCENE_CMD_OBJECT_LIST(ARRAY_COUNT(jyasinzou_room_28_03000038_ObjectList), jyasinzou_room_28_03000038_ObjectList),
    SCENE_CMD_END(),
