    ...
    SCENE_CMD_ROOM_SHAPE(&HAKAdan_room_22_03000040_RoomShapeNormal),
    SCENE_CMD_OBJECT_LIST(ARRAY_COUNT(HAKAdan_room_22_03000038_ObjectList), HAKAdan_room_22_03000038_ObjectList),
    SCENE_CMD_END(),
