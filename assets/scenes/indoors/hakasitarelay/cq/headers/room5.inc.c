    ...
    SCENE_CMD_ROOM_SHAPE(&hakasitarelay_room_5_03000090_RoomShapeNormal),
    SCENE_CMD_OBJECT_LIST(ARRAY_COUNT(hakasitarelay_room_5_03000040_ObjectList), hakasitarelay_room_5_03000040_ObjectList),
