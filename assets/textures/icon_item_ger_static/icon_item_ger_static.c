...
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseDekuTitleGERTex.ia8.inc.c"
};

u64 gPauseDodongoTitleGERTex[TEX_LEN(u64, gPauseDodongoTitleGERTex_WIDTH, gPauseDodongoTitleGERTex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseDodongoTitleGERTex.ia8.inc.c"
};

u64 gPauseJabuTitleGERTex[TEX_LEN(u64, gPauseJabuTitleGERTex_WIDTH, gPauseJabuTitleGERTex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseJabuTitleGERTex.ia8.inc.c"
};

u64 gPauseForestTitleGERTex[TEX_LEN(u64, gPauseForestTitleGERTex_WIDTH, gPauseForestTitleGERTex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseForestTitleGERTex.ia8.inc.c"
};

u64 gPauseFireTitleGERTex[TEX_LEN(u64, gPauseFireTitleGERTex_WIDTH, gPauseFireTitleGERTex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseFireTitleGERTex.ia8.inc.c"
};

u64 gPauseWaterTitleGERTex[TEX_LEN(u64, gPauseWaterTitleGERTex_WIDTH, gPauseWaterTitleGERTex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseWaterTitleGERTex.ia8.inc.c"
};

u64 gPauseSpiritTitleGERTex[TEX_LEN(u64, gPauseSpiritTitleGERTex_WIDTH, gPauseSpiritTitleGERTex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseSpiritTitleGERTex.ia8.inc.c"
};

u64 gPauseShadowTitleGERTex[TEX_LEN(u64, gPauseShadowTitleGERTex_WIDTH, gPauseShadowTitleGERTex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseShadowTitleGERTex.ia8.inc.c"
};

u64 gPauseBotWTitleGERTex[TEX_LEN(u64, gPauseBotWTitleGERTex_WIDTH, gPauseBotWTitleGERTex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseBotWTitleGERTex.ia8.inc.c"
};
...
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseToDecideGERTex.ia8.inc.c"
};

u64 gPauseToPlayMelodyGERTex[TEX_LEN(u64, gPauseToPlayMelodyGERTex_WIDTH, gPauseToPlayMelodyGERTex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseToPlayMelodyGERTex.ia8.inc.c"
};

u64 gPauseToSelectItemGERTex[TEX_LEN(u64, gPauseToSelectItemGERTex_WIDTH, gPauseToSelectItemGERTex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseToSelectItemGERTex.ia8.inc.c"
};

u64 gPauseToMapGERTex[TEX_LEN(u64, gPauseToMapGERTex_WIDTH, gPauseToMapGERTex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseToMapGERTex.ia8.inc.c"
};

u64 gPauseToQuestStatusGERTex[TEX_LEN(u64, gPauseToQuestStatusGERTex_WIDTH, gPauseToQuestStatusGERTex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseToQuestStatusGERTex.ia8.inc.c"
};

u64 gPauseToEquipmentGERTex[TEX_LEN(u64, gPauseToEquipmentGERTex_WIDTH, gPauseToEquipmentGERTex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseToEquipmentGERTex.ia8.inc.c"
};

u64 gPauseSavePromptGERTex[TEX_LEN(u64, gPauseSavePromptGERTex_WIDTH, gPauseSavePromptGERTex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseSavePromptGERTex.ia8.inc.c"
};

u64 gPauseSaveConfirmationGERTex[TEX_LEN(u64, gPauseSaveConfirmationGERTex_WIDTH, gPauseSaveConfirmationGERTex_HEIGHT,
                                         8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseSaveConfirmationGERTex.ia8.inc.c"
};

u64 gPauseYesGERTex[TEX_LEN(u64, gPauseYesGERTex_WIDTH, gPauseYesGERTex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseYesGERTex.ia8.inc.c"
};

u64 gPauseNoGERTex[TEX_LEN(u64, gPauseNoGERTex_WIDTH, gPauseNoGERTex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseNoGERTex.ia8.inc.c"
};

u64 gPauseCurrentPositionGERTex[TEX_LEN(u64, gPauseCurrentPositionGERTex_WIDTH, gPauseCurrentPositionGERTex_HEIGHT,
                                        4)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseCurrentPositionGERTex.i4.inc.c"
};

u64 gPauseEquipment00GERTex[TEX_LEN(u64, PAGE_BG_QUAD_TEX_WIDTH, PAGE_BG_QUAD_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseEquipment00GERTex.ia8.inc.c"
};

u64 gPauseEquipment10GERTex[TEX_LEN(u64, PAGE_BG_QUAD_TEX_WIDTH, PAGE_BG_QUAD_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseEquipment10GERTex.ia8.inc.c"
};

u64 gPauseEquipment20GERTex[TEX_LEN(u64, PAGE_BG_QUAD_TEX_WIDTH, PAGE_BG_QUAD_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseEquipment20GERTex.ia8.inc.c"
};

u64 gPauseSelectItem00GERTex[TEX_LEN(u64, PAGE_BG_QUAD_TEX_WIDTH, PAGE_BG_QUAD_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseSelectItem00GERTex.ia8.inc.c"
};
...
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseMap10GERTex.ia8.inc.c"
};

u64 gPauseQuestStatus10GERTex[TEX_LEN(u64, PAGE_BG_QUAD_TEX_WIDTH, PAGE_BG_QUAD_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseQuestStatus10GERTex.ia8.inc.c"
};

u64 gPauseSave10GERTex[TEX_LEN(u64, PAGE_BG_QUAD_TEX_WIDTH, PAGE_BG_QUAD_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseSave10GERTex.ia8.inc.c"
};

u64 gPauseSave20GERTex[TEX_LEN(u64, PAGE_BG_QUAD_TEX_WIDTH, PAGE_BG_QUAD_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_ger_static/gPauseSave20GERTex.ia8.inc.c"
};
