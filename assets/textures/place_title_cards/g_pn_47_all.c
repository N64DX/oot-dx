...
#include "build/pal-1.0/assets/textures/place_title_cards/gBombchuBowlingAlleyCardGERTex.ia8.inc.c"
};

u64 gBombchuBowlingAlleyCardFRATex[TEX_LEN(u64, gBombchuBowlingAlleyCardFRATex_WIDTH, gBombchuBowlingAlleyCardFRATex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/place_title_cards/gBombchuBowlingAlleyCardFRATex.ia8.inc.c"
};
