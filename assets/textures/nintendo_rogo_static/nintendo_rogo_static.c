...
Gfx gNintendo64LogoDL[] = {
    ...
    gsDPLoadTextureBlock(nintendo_rogo_staticTex_002A50, G_IM_FMT_I, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
...
#if OOT_VERSION == NTSC_1_0
u64 nintendo_rogo_staticTex_002A50[] = {
#include "assets/textures/nintendo_rogo_static/nintendo_rogo_staticTex_002A50.i8.inc.c"
};
#else
