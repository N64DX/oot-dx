...
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseDekuTitleFRATex.ia8.inc.c"
};

u64 gPauseDodongoTitleFRATex[TEX_LEN(u64, gPauseDodongoTitleFRATex_WIDTH, gPauseDodongoTitleFRATex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseDodongoTitleFRATex.ia8.inc.c"
};

u64 gPauseJabuTitleFRATex[TEX_LEN(u64, gPauseJabuTitleFRATex_WIDTH, gPauseJabuTitleFRATex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseJabuTitleFRATex.ia8.inc.c"
};

u64 gPauseForestTitleFRATex[TEX_LEN(u64, gPauseForestTitleFRATex_WIDTH, gPauseForestTitleFRATex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseForestTitleFRATex.ia8.inc.c"
};

u64 gPauseFireTitleFRATex[TEX_LEN(u64, gPauseFireTitleFRATex_WIDTH, gPauseFireTitleFRATex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseFireTitleFRATex.ia8.inc.c"
};

u64 gPauseWaterTitleFRATex[TEX_LEN(u64, gPauseWaterTitleFRATex_WIDTH, gPauseWaterTitleFRATex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseWaterTitleFRATex.ia8.inc.c"
};

u64 gPauseSpiritTitleFRATex[TEX_LEN(u64, gPauseSpiritTitleFRATex_WIDTH, gPauseSpiritTitleFRATex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseSpiritTitleFRATex.ia8.inc.c"
};

u64 gPauseShadowTitleFRATex[TEX_LEN(u64, gPauseShadowTitleFRATex_WIDTH, gPauseShadowTitleFRATex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseShadowTitleFRATex.ia8.inc.c"
};

u64 gPauseBotWTitleFRATex[TEX_LEN(u64, gPauseBotWTitleFRATex_WIDTH, gPauseBotWTitleFRATex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseBotWTitleFRATex.ia8.inc.c"
};
...
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseToDecideFRATex.ia8.inc.c"
};

u64 gPauseToPlayMelodyFRATex[TEX_LEN(u64, gPauseToPlayMelodyFRATex_WIDTH, gPauseToPlayMelodyFRATex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseToPlayMelodyFRATex.ia8.inc.c"
};

u64 gPauseToSelectItemFRATex[TEX_LEN(u64, TO_PAGE_LABEL_TEX_WIDTH, TO_PAGE_LABEL_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseToSelectItemFRATex.ia8.inc.c"
};

u64 gPauseToMapFRATex[TEX_LEN(u64, TO_PAGE_LABEL_TEX_WIDTH, TO_PAGE_LABEL_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseToMapFRATex.ia8.inc.c"
};

u64 gPauseToQuestStatusFRATex[TEX_LEN(u64, TO_PAGE_LABEL_TEX_WIDTH, TO_PAGE_LABEL_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseToQuestStatusFRATex.ia8.inc.c"
};

u64 gPauseToEquipmentFRATex[TEX_LEN(u64, TO_PAGE_LABEL_TEX_WIDTH, TO_PAGE_LABEL_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseToEquipmentFRATex.ia8.inc.c"
};

u64 gPauseSavePromptFRATex[TEX_LEN(u64, gPauseSavePromptFRATex_WIDTH, gPauseSavePromptFRATex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseSavePromptFRATex.ia8.inc.c"
};

u64 gPauseSaveConfirmationFRATex[TEX_LEN(u64, gPauseSaveConfirmationFRATex_WIDTH, gPauseSaveConfirmationFRATex_HEIGHT,
                                         8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseSaveConfirmationFRATex.ia8.inc.c"
};

u64 gPauseYesFRATex[TEX_LEN(u64, gPauseYesFRATex_WIDTH, gPauseYesFRATex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseYesFRATex.ia8.inc.c"
};

u64 gPauseNoFRATex[TEX_LEN(u64, gPauseNoFRATex_WIDTH, gPauseNoFRATex_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseNoFRATex.ia8.inc.c"
};

u64 gPauseCurrentPositionFRATex[TEX_LEN(u64, gPauseCurrentPositionFRATex_WIDTH, gPauseCurrentPositionFRATex_HEIGHT,
                                        4)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseCurrentPositionFRATex.i4.inc.c"
};

u64 gPauseEquipment00FRATex[TEX_LEN(u64, PAGE_BG_QUAD_TEX_WIDTH, PAGE_BG_QUAD_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseEquipment00FRATex.ia8.inc.c"
};

u64 gPauseEquipment10FRATex[TEX_LEN(u64, PAGE_BG_QUAD_TEX_WIDTH, PAGE_BG_QUAD_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseEquipment10FRATex.ia8.inc.c"
};

u64 gPauseEquipment20FRATex[TEX_LEN(u64, PAGE_BG_QUAD_TEX_WIDTH, PAGE_BG_QUAD_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseEquipment20FRATex.ia8.inc.c"
};

u64 gPauseSelectItem00FRATex[TEX_LEN(u64, PAGE_BG_QUAD_TEX_WIDTH, PAGE_BG_QUAD_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseSelectItem00FRATex.ia8.inc.c"
};

u64 gPauseSelectItem10FRATex[TEX_LEN(u64, PAGE_BG_QUAD_TEX_WIDTH, PAGE_BG_QUAD_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseSelectItem10FRATex.ia8.inc.c"
};

u64 gPauseSelectItem10CQFRATex[TEX_LEN(u64, PAGE_BG_QUAD_TEX_WIDTH, PAGE_BG_QUAD_TEX_HEIGHT, 8)] = {
#include "assets/textures/icon_item_fra_static/gPauseSelectItem10CQFRATex.ia8.inc.c"
};

u64 gPauseSelectItem20FRATex[TEX_LEN(u64, PAGE_BG_QUAD_TEX_WIDTH, PAGE_BG_QUAD_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseSelectItem20FRATex.ia8.inc.c"
};

u64 gPauseSelectItem20CQFRATex[TEX_LEN(u64, PAGE_BG_QUAD_TEX_WIDTH, PAGE_BG_QUAD_TEX_HEIGHT, 8)] = {
#include "assets/textures/icon_item_fra_static/gPauseSelectItem20CQFRATex.ia8.inc.c"
};

u64 gPauseMap10FRATex[TEX_LEN(u64, PAGE_BG_QUAD_TEX_WIDTH, PAGE_BG_QUAD_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseMap10FRATex.ia8.inc.c"
};

u64 gPauseQuestStatus10FRATex[TEX_LEN(u64, PAGE_BG_QUAD_TEX_WIDTH, PAGE_BG_QUAD_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseQuestStatus10FRATex.ia8.inc.c"
};

u64 gPauseSave00FRATex[TEX_LEN(u64, PAGE_BG_QUAD_TEX_WIDTH, PAGE_BG_QUAD_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseSave00FRATex.ia8.inc.c"
};

u64 gPauseSave10FRATex[TEX_LEN(u64, PAGE_BG_QUAD_TEX_WIDTH, PAGE_BG_QUAD_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseSave10FRATex.ia8.inc.c"
};

u64 gPauseSave20FRATex[TEX_LEN(u64, PAGE_BG_QUAD_TEX_WIDTH, PAGE_BG_QUAD_TEX_HEIGHT, 8)] = {
#include "build/pal-1.0/assets/textures/icon_item_fra_static/gPauseSave20FRATex.ia8.inc.c"
};
